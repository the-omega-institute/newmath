...
|---|---:|---:|---:|---:|---:|
| `assignment_state_encoder` | -0.285748 | -0.40556 | -0.278748 | -0.172936 | 0.149973 |
...
Aggregate assignment-state encoding does not improve held-out hard exact-budget capture over the scalar mechanism learner.
