...
def exportWitnessRegistry : Array ExportRegistration := #[
  ...
  { witness := `BedcMathlibBridge.Export.NatPowZero.natPowZeroExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatPowZero.NatPowZeroExportWitness },
  ...
  { witness := `BedcMathlibBridge.Export.NatMulSucc.natMulSuccExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatMulSucc.NatMulSuccExportWitness },
  { witness :=
      `BedcMathlibBridge.Export.NatFactorialZero.natFactorialZeroExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatFactorialZero.NatFactorialZeroExportWitness },
  { witness := `BedcMathlibBridge.Export.NatFactorialSucc.natFactorialSuccExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatFactorialSucc.NatFactorialSuccExportWitness },
  ...
  { witness :=
      `BedcMathlibBridge.Export.NatSelfLeFactorial.natSelfLeFactorialExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatSelfLeFactorial.NatSelfLeFactorialExportWitness },
  { witness := `BedcMathlibBridge.Export.NatMulZero.natMulZeroExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatMulZero.NatMulZeroExportWitness },
  { witness := `BedcMathlibBridge.Export.NatMulOne.natMulOneExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatMulOne.NatMulOneExportWitness },
  { witness := `BedcMathlibBridge.Export.NatOneMul.natOneMulExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatOneMul.NatOneMulExportWitness },
  { witness :=
      `BedcMathlibBridge.Export.NatChooseEqZeroOfLt.natChooseEqZeroOfLtExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatChooseEqZeroOfLt.NatChooseEqZeroOfLtExportWitness },
  ...
  { witness := `BedcMathlibBridge.Export.NatChooseSuccSelf.natChooseSuccSelfExport,
    witnessType :=
      `BedcMathlibBridge.Export.NatChooseSuccSelf.NatChooseSuccSelfExportWitness },
  { witness :=
