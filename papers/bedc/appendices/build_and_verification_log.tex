...
An external rule110 substrate witness also checks the BEDC FKernel and GroundCompiler surface independently of the Lean kernel. The artifact is identified by tag \texttt{rule110-v2.0-fkernel-tier-a} at commit \texttt{d3ae91028}; its reported trust path is an ANSI C compiler, approximately $250$ lines of C, and manifest text. Its cross-check report records $257$ PASS lines, $0$ axioms, and green CI. This is an external witness for the verification state, not the canonical statement of BEDC theory.
