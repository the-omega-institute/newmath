...
$$
  \ExternalCorrespondenceClosure
  \;=\;
  \{\, \noExternalReference,\ \referencedExternal,\ \bridgedExternal,\ \calibratedReconstruction \,\}
$$
ordered by $\noExternalReference < \referencedExternal < \bridgedExternal < \calibratedReconstruction$.
\end{definition}
...
The grades are read as follows.
\begin{description}
  \item[\textbf{$\noExternalReference$:}] the package is stated internally, with no declared outside reference theory for comparison.
...
\begin{closurestatus}{\<X>Up}
  ...
  \externalcorrespondence{\noExternalReference | \referencedExternal
