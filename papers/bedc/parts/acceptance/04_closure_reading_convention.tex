...
$\DyadicRatCore$ & $\matureClosure$ & dyadic obligation faces and finite ledger                & $\axiomCleanV$\\
$\StreamNameUp$  & $\matureClosure$ & rational stream-name public certificate                  & $\bridgeCheckedV$\\
$\RegSeqRat$     & $\matureClosure$ & rational-stream certificate spine                        & $\axiomCleanV$\\
$\RealUp$        & $\matureClosure$ & public rational-stream export                            & $\bridgeCheckedV$\\
\bottomrule
\end{longtable}
