...
\label{ch:concrete-instances-14104_bioreality_q_six_leave_one_codon_boundary-namecert}
\origin{ai}

This BioReality NameCert packet records a finite, reality-bound seed
witness for the claim h1.leave.one.codon.out. It does not claim biological-code
...
This codon-boundary packet is read together with
\autoref{ch:concrete-instances-14110_bioreality_q_six_module_classification_ledger-namecert}
and
\autoref{ch:concrete-instances-14109_bioreality_q_six_family_leave_one_boundary_ledger-namecert}:
the module ledger supplies the quotient/classification row, while the family
boundary ledger supplies the leave-one family boundary row against which the
codon-level boundary is compared.

\paragraph{Carrier.} $\BioRealityQSixLeaveOneCodonBoundaryUp$ is the BEDC packet name we
reserve for the finite reality-bound seed of the finite reality-bound seed witness for h1.leave.one.codon.out.
...
\falsifiablePrediction{A $\BioRealityQSixLeaveOneCodonBoundaryUp$ packet cannot export a
...
\begin{closurestatus}{\BioRealityQSixLeaveOneCodonBoundaryUp}
  \constructivestory{Finite reality-bound seed witness for h1.leave.one.codon.out;
