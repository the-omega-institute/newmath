...
\begin{closurestatus}{\KernelInductiveAcceptanceUp}
  ...
  \upgradepath{Obligation closure requires the paper-side obligation surface to be read as a closed package with the TasteGate target cited on the verification axis.}
\end{closurestatus}
