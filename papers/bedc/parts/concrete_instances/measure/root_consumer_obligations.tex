...
\end{theorem}
\leanchecked{BEDC.Derived.MeasureUp.MeasureIntegralConsumer\_rows}
\begin{proof}
...
\end{theorem}
\leanchecked{BEDC.Derived.MeasureUp.MeasureProbabilityConsumer\_rows}
\begin{proof}
...
$\StdBridge$ row.
\end{proof}
\leanchecked{BEDC.Derived.MeasureUp.MeasureFunctionalAnalysisConsumer\_rows}
