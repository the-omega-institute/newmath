...
\end{proof}
\leanvariant{BEDC.Derived.MeasureUp.MeasureZeroBHist\_carrier\_classifier\_stability}
...
\end{proof}
\leanchecked{BEDC.Derived.MeasureUp.MeasureZeroBHist\_sigma\_additivity}
...
\end{theorem}
\leanchecked{BEDC.Derived.MeasureUp.MeasureZeroBHist\_semantic\_name\_certificate}
\begin{proof}
...
$$
\end{proof}
\leanchecked{BEDC.Derived.MeasureUp.MeasureZeroBHist\_relative\_difference\_zero\_row}
