...
\begin{closurestatus}{\ReductionFuelBoundaryUp}
  ...
  \scopeclosed{\autoref{thm:reduction-fuel-boundary-obligation-closure-package} enumerates carrier admission, host exposure, fuel exposure, bounded-trace exposure, endpoint readback, timeout exactness, audit separation, transport, replay, provenance, naming, nontriviality, and field faithfulness for the same packet.}
