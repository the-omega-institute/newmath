...
\begin{closurestatus}{\ComputableRealUp}
  ...
  \upgradepath{Scoped closure next requires binding the classifier, modulus-window, RealUp handoff, ledger-coverage, and bridge-boundary obligations to their exact BEDC dependencies.}
\end{closurestatus}
