...
\begin{closurestatus}{\ComputableRealUp}
  ...
  \scopeclosed{The chapter binds the classifier-transport, modulus-window, $\RealUp$ handoff, ledger-coverage, and bridge-boundary obligations to their $\mathsf{BHist}$, $\hsame$, $\Cont$, $\mathsf{Pkg}$, $\StreamNameUp$, $\CauchyModulusUp$, $\DyadicRatCoreUp$, $\RegSeqRatUp$, and $\RealUp$ dependencies.}
