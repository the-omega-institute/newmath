...
\end{theorem}
\leanchecked{BEDC.Derived.DiffFormUp.DiffFormZeroDegree\_empty\_probe\_exhaustion}
\begin{proof}
...
\end{theorem}
\leanchecked{BEDC.Derived.DiffFormUp.DiffFormZeroDegree\_scalar\_classifier\_readback}
\begin{proof}
...
orders.
\end{proof}
\leanchecked{BEDC.Derived.DiffFormUp.DiffFormZeroDegree\_wedge\_cont\_unit\_boundary}
