...
\end{definition}
\leanchecked{BEDC.Derived.ZnormalUp.ZnormalPacket\_root\_carrier\_boundary\_semantic\_namecert}
...
\end{enumerate}
\end{theorem}
\leanchecked{BEDC.Derived.ZnormalUp.ZnormalPacket\_namecert\_root\_obligations}
\begin{proof}
...
\end{theorem}
\leanchecked{BEDC.Derived.ZnormalUp.ZnormalPacket\_root\_consumer\_readiness}
\begin{proof}
