...
\begin{closurestatus}{\CompactModulusCoverUp}
  ...
  \upgradepath{Bridged closure requires a standard bridge for the same compact-net, pointwise-modulus, lower-bound-fold, and uniform-modulus consumer surface.}
\end{closurestatus}
