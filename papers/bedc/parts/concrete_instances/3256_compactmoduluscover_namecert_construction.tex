...
\begin{closurestatus}{\CompactModulusCoverUp}
  ...
  \upgradepath{Mature closure requires downstream examples or completeness for the same compact-net, pointwise-modulus, lower-bound-fold, and uniform-modulus consumer surface.}
\end{closurestatus}
