...
\begin{closurestatus}{\IdealUp}
  ...
  \scopeclosed{The public IdealUp predicate surface is closed through finite meet, sum, and preimage constructors, the principal generated ideal, the ring-map zero fiber, and the quotient-kernel export surface consumed by quotient-ring constructions.}
  ...
  \upgradepath{Bridged closure requires a standard bridge consumed by QuotientRingUp and IdealClassUp from this IdealUp public surface.}
\end{closurestatus}
