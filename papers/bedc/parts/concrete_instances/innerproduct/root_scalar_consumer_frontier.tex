...
\end{theorem}
\leanchecked{BEDC.Derived.InnerProductUp.InnerProductRoot\_scalar\_projection\_transport}
\begin{proof}
...
\end{theorem}
\leanchecked{BEDC.Derived.InnerProductUp.InnerProductSingletonDiagonal\_zero\_exactness}
\begin{proof}
