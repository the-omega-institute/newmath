\chapter{A Concrete Naming Certificate for $\BioRealityQSixFamilyLeaveOneBoundaryLedgerUp$}
...
witness for the claim h1.leave\_one\_code\_out.by\_family. It does not claim biological-code
...
\paragraph{Carrier.} $\BioRealityQSixFamilyLeaveOneBoundaryLedgerUp$ is the BEDC packet name we
reserve for the finite reality-bound seed of the finite reality-bound seed witness for h1.leave\_one\_code\_out.by\_family.
...
\falsifiablePrediction{A $\BioRealityQSixFamilyLeaveOneBoundaryLedgerUp$ packet cannot export a
...
\closureat{BioRealityQSixFamilyLeaveOneBoundaryLedgerUp}{seedStr}
\begin{closurestatus}{\BioRealityQSixFamilyLeaveOneBoundaryLedgerUp}
  \constructivestory{Finite reality-bound seed witness for h1.leave\_one\_code\_out.by\_family;
