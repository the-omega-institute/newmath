...
\begin{closurestatus}{\EquicontinuityUp}
  ...
  \scopeclosed{\autoref{def:equicontinuity-carrier}, \autoref{thm:equicontinuity-namecert-obligations}, \autoref{thm:equicontinuity-compact-metric-route}, and \autoref{thm:equicontinuity-nonescape} seed the finite family-modulus surface over compact-source, continuous-family, tolerance, shared-radius, modulus-handoff, transport, replay, provenance, and local naming rows.}
  \formalstatus{\unformalizedV}
  \bridgestatus{none}
  \origin{human}
  \notclaimed{This chapter does not close compactness, selected finite nets, selected subsequences, Arzela--Ascoli convergence, host-level continuity, pointwise-only radius choice, Lean verification, ambient completeness, or bridge checking.}
  \upgradepath{Obligation closure requires checked carrier admission, shared-radius exactness, compact-source compatibility, finite-net handoff preservation, transport, replay, provenance, and local naming for BEDC.Derived.EquicontinuityUp.}
  \constructivestory{An $\EquicontinuityUp$ packet is generated from a compact metric source row, a finite continuous-family row, a tolerance row, one shared radius row, a modulus handoff row, componentwise hsame transport, displayed Cont replay, Pkg provenance, and a local NameCert row.}
\end{closurestatus}
