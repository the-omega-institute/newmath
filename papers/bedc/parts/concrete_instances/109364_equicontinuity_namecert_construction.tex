...
\begin{closurestatus}{\EquicontinuityUp}
  ...
  \upgradepath{The remaining work is the standard bridge check for the same public finite-net and Arzela--Ascoli-facing handoff, not additional paper closure.}
\end{closurestatus}
