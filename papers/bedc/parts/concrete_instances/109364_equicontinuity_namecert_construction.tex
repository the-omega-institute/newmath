...
\begin{closurestatus}{\EquicontinuityUp}
  ...
  \upgradepath{A checked standard bridge for the same public finite-net and Arzela--Ascoli-facing handoff is the next verification step, without adding selected nets, selected subsequences, or ambient $\RealUp$ completeness.}
\end{closurestatus}
