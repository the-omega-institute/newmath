...
\begin{closurestatus}{\EquicontinuityUp}
  ...
  \scopeclosed{\autoref{def:equicontinuity-carrier}, \autoref{thm:equicontinuity-namecert-obligations}, \autoref{thm:equicontinuity-compact-metric-route}, and \autoref{thm:equicontinuity-nonescape} seed the finite family-modulus surface.}
  ...
  \upgradepath{Obligation closure requires checked carrier admission, shared-modulus exactness, compact-source compatibility, and nonescape for BEDC.Derived.EquicontinuityUp.}
  \constructivestory{An $\EquicontinuityUp$ packet is generated from a compact metric source row, continuous-family ledger, tolerance row, shared radius row, modulus handoff, componentwise transport, displayed replay, package provenance, and local NameCert row.}
\end{closurestatus}
