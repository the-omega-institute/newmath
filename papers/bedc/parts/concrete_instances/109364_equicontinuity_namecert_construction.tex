...
\begin{closurestatus}{\EquicontinuityUp}
  ...
  \upgradepath{Bridge closure requires a standard bridge for the same public finite-net and Arzela--Ascoli-facing handoff, without adding selected nets, selected subsequences, or ambient $\RealUp$ completeness.}
\end{closurestatus}
