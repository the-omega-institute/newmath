...
\closureat{DependentCodomainClosurePreservationUp}{obligationStr}
...
\begin{closurestatus}{\DependentCodomainClosurePreservationUp}
  ...
  \upgradepath{Scoped closure requires a bound identifying the complete dependent-codomain transport scope across checked carrier admission, row coverage, sibling-boundary consumption, finite transport exactness, ledger non-escape, provenance, and local naming for the same packet.}
\end{closurestatus}
