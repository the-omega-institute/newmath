...
\end{definition}
\leanchecked{BEDC.Derived.DyadicDivisionUp.DyadicDivisionTasteGate\_single\_carrier\_alignment}
...
\end{proof}
\leanchecked{BEDC.Derived.DyadicDivisionUp.DyadicDivisionCarrier\_namecert\_obligations}
