...
\closureat{UpcrossingUp}{obligationStr}
...
\begin{closurestatus}{\UpcrossingUp}
  ...
  \scopeclosed{The obligation scope names the finite carrier, NameCert obligations, martingale route, finite-ledger induction boundary, finite ledger handoff, scoped decision route, and no-escape boundary for crossing counts over finite martingale windows.}
  ...
  \upgradepath{Scoped closure requires kernel-scoped dependency rows for probability, random variable, conditional expectation, martingale, optional stopping, finite ledgers, transport, replay, provenance, and naming.}
\end{closurestatus}
