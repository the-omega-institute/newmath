...
\begin{closurestatus}{\UpcrossingUp}
  ...
  \scopeclosed{The obligation scope names the finite carrier, NameCert obligations, martingale route, finite-ledger induction boundary, finite ledger handoff, and no-escape boundary for crossing counts over finite martingale windows.}
