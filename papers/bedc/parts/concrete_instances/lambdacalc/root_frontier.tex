...
\begin{closurestatus}{\LambdaCalcUp}
  ...
  \scopeclosed{The seed scope is the visible $\TreeUp$ constructors, $\NatUp$ binder and free-variable rows, $\mathsf{BHist}$ packets, $\Cont$ continuations, $\hsame$ comparisons, and $\Pkg$ provenance displayed in this root frontier.}
  ...
  \upgradepath{Obligation closure requires the full carrier, classifier, substitution, alpha-beta, exactness, stability, and ledger inventory for the displayed LambdaCalc root packet.}
\end{closurestatus}
