...
\begin{closurestatus}{\MetaCICParallelDiamondFrontierUp}
  ...
  \scopeclosed{\autoref{def:metacic-parallel-diamond-frontier-carrier}, \autoref{thm:metacic-parallel-diamond-frontier-obligations}, \autoref{thm:metacic-parallel-diamond-frontier-handoff}, premise-retention rows, obstruction rows, candidate-mediated socket rows, and the Nontrivial and FieldFaithful awareness rows form the finite obligation surface for MetaCIC confluence consumers.}
