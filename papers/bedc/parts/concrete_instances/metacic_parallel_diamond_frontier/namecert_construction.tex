...
\begin{closurestatus}{\MetaCICParallelDiamondFrontierUp}
  ...
  \scopeclosed{\autoref{thm:metacic-parallel-diamond-frontier-seed-registration} registers \autoref{def:metacic-parallel-diamond-frontier-carrier}, \autoref{thm:metacic-parallel-diamond-frontier-obligations}, and \autoref{thm:metacic-parallel-diamond-frontier-handoff} as the seed conditional parallel-diamond frontier packet for MetaCIC confluence consumers.}
