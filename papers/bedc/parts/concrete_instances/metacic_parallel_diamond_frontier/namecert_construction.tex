...
\begin{closurestatus}{\MetaCICParallelDiamondFrontierUp}
  ...
  \upgradepath{Public closure requires checked carrier admission, residual-substitution premise retention, critical-pair exposure, candidate-join exactness, residual-frontier coverage, closed-checker handoff, closed-normal fragment routing, bounded-check exactness, obstruction retention, TasteGate nontriviality, FieldFaithful coverage, transport, replay, provenance, and local naming for BEDC.Derived.MetaCICParallelDiamondFrontierUp.}
\end{closurestatus}
