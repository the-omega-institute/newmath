...
\begin{closurestatus}{\RegularCauchyDifferenceUp}
  ...
  \upgradepath{Bridged closure requires a standard bridge for the same subtraction schedule, tolerance ledger, null-sequence consumer, and RealUp seal route.}
\end{closurestatus}
