...
\begin{closurestatus}{\RegularCauchyDifferenceUp}
  ...
  \upgradepath{Bridged closure requires connecting the public subtraction and tolerance-ledger surface to the abstract regular-Cauchy difference interface.}
\end{closurestatus}
