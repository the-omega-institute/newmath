...
\begin{closurestatus}{\RegularCauchyDifferenceUp}
  ...
  \upgradepath{Public closure requires a completed-real subtraction surface or a checked bridge connecting the displayed source rows, subtraction schedule, tolerance ledger, null-sequence consumer, RealUp seal route, and $\mathsf{BHist}$, $\hsame$, $\Cont$, $\Pkg$, and $\NameCert$ dependencies.}
\end{closurestatus}
