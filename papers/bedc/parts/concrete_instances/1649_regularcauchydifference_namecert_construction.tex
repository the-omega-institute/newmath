...
\begin{closurestatus}{\RegularCauchyDifferenceUp}
  ...
  \upgradepath{Mature closure requires a standard-bridge consumer example and completeness boundary for the same subtraction schedule and tolerance ledger.}
\end{closurestatus}
