...
\begin{closurestatus}{\RegularCauchyDifferenceUp}
  ...
  \scopeclosed{The obligation scope records carrier admission, classifier transport, regularity closure, tolerance-ledger exactness, null-sequence consumption, and $\RealUp$ seal routing for pointwise differences of regular Cauchy names.}
  ...
  \upgradepath{Scoped closure requires explicit scope binding for the source rows, subtraction schedule, tolerance ledger, null-sequence consumer, RealUp seal route, and $\mathsf{BHist}$, $\hsame$, $\Cont$, $\Pkg$, and $\NameCert$ dependencies.}
\end{closurestatus}
