...
\end{definition}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitnessTasteGate\_single\_carrier\_alignment}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_nonescape}
\begin{proof}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_consumer\_boundary}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_duplicate\_label\_priority}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitnessUnresolvedMarkerRefusal}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_resolution\_stability}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_marker\_kind\_separation}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_inventory\_verdict\_totality}
...
\begin{theorem}[Paper-Lean drift witness public verdict ledger]
\label{thm:paper-lean-drift-witness-public-verdict-ledger}
For every accepted $\PaperLeanDriftWitnessUp$ carrier
$$
W=(M,A,L,I,R,H,C,P,N),
$$
any public audit-map consumer must read the marker row $M$, normalized Lean name row $A$, paper-label ledger $L$, Lean inventory row $I$, verdict row $R$, transport row $H$, replay row $C$, provenance row $P$, and local $\NameCert$ row $N$ as one finite verdict ledger. The consumer cannot aggregate this ledger into theoryclosure evidence, bridge status, approximate name matching, or semantic equivalence between paper prose and Lean declarations.
\end{theorem}
\begin{proof}
First use resolution exactness and non-escape. Resolution exactness binds the accepted verdict to the same displayed rows $M,A,L,I,R$, while non-escape prevents checked theorem content, closure-status targets, and semantic-equivalence content from leaving the witness packet.

Next use the consumer-boundary theorem. Every public audit-map read is confined to $M,A,L,I,R,H,C,P,N$, so transport, replay, provenance, and local naming carry the same finite verdict ledger rather than adding an outside marker row or neighbouring Lean declaration.

Verdict determinism and inventory-totality fix the ledger outcome. For the displayed marker, normalized name, ledger, and inventory rows, the verdict row is uniquely read and exhausts the accepted exact or refusal outcomes.

Finally apply token-objectwise audit. The public consumer receives an objectwise audit row for marker resolution, not theoryclosure evidence, a bridge-status row, approximate name matching, or semantic equivalence between the paper text and a Lean declaration.
\end{proof}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_auditmap\_dependency\_source\_lock}
\begin{proof}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_objectwise\_drift\_handoff}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_auditmap\_weave\_consumer\_exactness}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_obligation\_closure\_package}
\begin{proof}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_closure\_target\_resolution}
\begin{proof}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_axis\_separation}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_audit\_map\_handoff}
\begin{proof}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_audit\_index\_readiness}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_verdict\_ledger\_totality}
\begin{proof}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_dependency\_weave\_handoff}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_dependency\_routing\_scope}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.ConsumerRowScope.PaperLeanDriftWitness\_consumer\_row\_scope}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_scoped\_closure\_package}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_resolution\_consumer\_readiness}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_duplicate\_ledger\_readiness}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_unresolved\_marker\_refusal}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_formalstatus\_sync\_readiness}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_marker\_family\_resolution\_readiness}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_audit\_map\_consumer\_totality}
\begin{proof}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_status\_token\_kernel\_boundary}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_marker\_inventory\_kind\_lock}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_duplicate\_obstruction\_route\_preservation}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_status\_consumer\_exactness}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_bridge\_ready\_dependency\_surface}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_public\_token\_consumer\_totality}
\begin{proof}
...
\end{proof}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_audit\_replay\_source\_lock}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_lean\_inventory\_hit\_exhaustion}
\begin{proof}
...
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_name\_normalization\_noescape}
\begin{proof}
...
\begin{theorem}[Paper-Lean drift witness public export route]
\label{thm:paper-lean-drift-witness-public-export-route}
Every public audit-map consumer of an accepted $\PaperLeanDriftWitnessUp$ packet receives exactly the marker row, normalized requested-name row, duplicate-label ledger, Lean inventory lookup, verdict row, transport, replay, provenance, and local NameCert row through $\AuditMapDependencyWeaveUp$. The route is the displayed packet $M,A,L,I,R,H,C,P,N$; it exports exact resolution, duplicate-label refusal, and unresolved-marker refusal as local verdict data, not as a private repair rule, aggregate bridge status, or closure-axis certificate.
\end{theorem}
\leanchecked{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_public\_export\_route}
\begin{proof}
Begin with public resolution export, \autoref{thm:paper-lean-drift-witness-public-resolution-export}. It identifies the exported material as the rows $M,A,L,I,R,H,C,P,N$ and excludes private repair rules, family-erased lookup, aggregate bridge verdicts, and closure-axis certificates.

Next use the bridge-ready dependency surface, \autoref{thm:paper-lean-drift-witness-bridge-ready-dependency-surface}. It routes downstream bridge and audit consumers through $\AuditMapDependencyWeaveUp$ before they may use the local marker-resolution verdict, so the public consumer receives the packet only as dependency data.

Finally apply the audit replay source lock and name-normalization no-escape theorems, \autoref{thm:paper-lean-drift-witness-audit-replay-source-lock} and \autoref{thm:paper-lean-drift-witness-name-normalization-noescape}. Replay remains sourced in the same packet, and normalization cannot become approximate lookup or marker-family coercion. Hence the public route is exactly the listed local rows through $\AuditMapDependencyWeaveUp$.
\end{proof}
...
\begin{closurestatus}{\PaperLeanDriftWitnessUp}
  ...
  \leantarget{BEDC.Derived.PaperLeanDriftWitnessUp.PaperLeanDriftWitness\_public\_export\_route}
  \bridgestatus{none}
  \origin{human}
  ...
  \upgradepath{The next bridge surface is the downstream audit-consumer interpretation of the public export route through $\AuditMapDependencyWeaveUp$.}
\end{closurestatus}
