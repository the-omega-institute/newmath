...
\end{theorem}
\begin{proof}
Duplicate-label priority from \autoref{thm:paperleandriftwitness-duplicate-label-priority} fixes the duplicate branch before unresolved-marker lookup or exact-resolution export can be used. Duplicate-ledger readiness, \autoref{thm:paper-lean-drift-witness-duplicate-ledger-readiness}, records that branch in the same finite ledger rows $M,A,L,I,R$.
