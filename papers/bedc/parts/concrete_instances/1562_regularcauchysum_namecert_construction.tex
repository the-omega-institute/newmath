...
\begin{closurestatus}{\RegularCauchySumUp}
  ...
  \upgradepath{Scoped closure requires binding the displayed obligations to checked carrier admission, classifier transport, window-budget exactness, regular readback handoff, and RealUp seal non-escape for the sum packet.}
\end{closurestatus}
