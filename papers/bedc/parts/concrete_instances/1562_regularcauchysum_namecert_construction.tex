...
Read the sibling tail-selector surface next. The diagonal admissibility and precision-window exactness rows of \autoref{ch:concrete-instances-reg-cauchy-tail-sel-namecert} supply one-source selected-tail witnesses attached to finite $\StreamNameUp$, $\RegSeqRatUp$, and $\DyadicRatCoreUp$ support rows.
