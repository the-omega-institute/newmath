...
\autoref{thm:field-rat-denominator-continuation-carrier-closure} and
...
$p_e:\mathsf{NonZero}_F(e)$, the composite $U(T(x))$ is certified by the
...
collected-coefficient inverse of the composite. Hence the identity affine map,
composition, inverse closure, and classifier iff clauses form the affine
automorphism package over $\mathsf{BHist}$.
\end{theorem}
\begin{proof}
...
certified affine maps. The theorem supplies the collected coefficients $A,B,D$,
the product witnesses for $A$ and $B$, and the classifier iff for $U\circ T$.
The certified-automorphism clauses are then read through
\autoref{thm:field-affine-two-sided-certified-automorphism}.
