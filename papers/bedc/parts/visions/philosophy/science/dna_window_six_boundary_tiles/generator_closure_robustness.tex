...
\concretizedIn{ch:concrete-instances-generator-closure-robustness-namecert}{Generator closure robustness is realized as finite active-generator, deletion-loss, Q2-completion, and trigger-closure NameCert data.}
