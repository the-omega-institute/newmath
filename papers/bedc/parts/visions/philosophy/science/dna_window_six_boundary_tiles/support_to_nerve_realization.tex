...
\concretizedIn{ch:concrete-instances-support-nerve-realization-namecert}{The support-family-to-boundary-subcomplex realization route is recorded as a finite NameCert packet between support rows, nerve rows, census rows, and lifted-Betti consumers.}
