...
\concretizedIn{ch:concrete-instances-endpoint-bisection-certificate-namecert}{Endpoint bisection certificates are realized as finite NameCert data over RHRoute endpoint intervals, branch choices, preservation rows, and local half-split handoff.}
