...
\concretizedIn{ch:concrete-instances-typed-gallery-context-probe-namecert}{Typed gallery context probes realize sort contexts, binder shapes, applications, beta redexes, and Church examples as finite NameCert rows.}
\concretizedIn{ch:concrete-instances-metacic-typed-equality-eliminator-namecert}{Typed equality eliminator packets realize the Leibniz equality gallery as finite checker, closedness, reduction, transport, replay, provenance, and NameCert rows.}
