...
\concretizedIn{ch:concrete-instances-internaltheoryboundary-namecert}{The five positive BEDC.MetaCIC commitments are packaged as a finite InternalTheoryBoundaryUp certificate.}
...
\concretizedIn{ch:concrete-instances-bedc-self-substrate-namecert}{The five positive commitments are packaged as a finite BEDC self-substrate certificate.}
\concretizedIn{ch:concrete-instances-metacicidentityboundary-namecert}{The positive identity of BEDC.MetaCIC is realized as a finite NameCert packet over closed generators, literal AST equality, structural recursors, strict purity, and visible external-boundary rows.}
\concretizedIn{ch:concrete-instances-theoryselfclassifier-namecert}{The self-theory vision is realized as a finite classifier packet for closed generators, literal equality, recursors, purity, and apophatic boundary rows.}
\concretizedIn{ch:concrete-instances-self-theory-reflection-loop-namecert}{Finite loop packet for self-theory identity, audit replay, and boundary non-escape.}
\concretizedIn{ch:concrete-instances-literal-ast-equality-boundary-namecert}{The literal AST equality commitment is packaged as a finite boundary certificate.}
