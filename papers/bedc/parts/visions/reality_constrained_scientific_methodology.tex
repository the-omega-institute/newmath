...
\concretizedIn{ch:concrete-instances-reality-constrained-scientific-methodology-namecert}{Reality-constrained scientific methodology is realized as a finite NameCert packet for explanation certificates, effective-domain regions, idealization residue, failure surfaces, audit routes, and local naming rows.}
...
\concretizedIn{ch:concrete-instances-reality-constrained-methodology-ledger-namecert}{The scientific-methodology vision is realized as a finite methodology-ledger NameCert packet for explanation scope, effective-region bounds, idealization residue, domain-leakage refusal, upgrade routes, provenance, and local naming rows.}
\concretizedIn{ch:concrete-instances-scientific-idealization-residue-seal-namecert}{ScientificIdealizationResidueSealUp realizes safe idealization as a finite residue, descent, failure-surface, scope, transport, route, provenance, and NameCert packet.}
\concretizedIn{ch:concrete-instances-theory-transition-certificate-namecert}{Theory transitions are realized as finite packets preserving old certified signatures while exposing classifier, stability, ledger, and failure-surface refinement rows.}
