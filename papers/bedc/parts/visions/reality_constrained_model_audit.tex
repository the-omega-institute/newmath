...
\concretizedIn{ch:concrete-instances-finite-observation-residue-boundary-namecert}{The model-audit hidden-residue branch is realized as a finite source-signature-classifier-tower-ledger-failure NameCert packet.}
\concretizedIn{ch:concrete-instances-physical-model-audit-namecert}{The physical audit protocol is realized as a finite source-signature-classifier-tower-ledger NameCert packet.}
\concretizedIn{ch:concrete-instances-physicalmodelaudit-namecert}{Physical model audits are realized as finite source, signature, classifier, tower, stability, descent, ledger, failure, and strength NameCert packets.}
\concretizedIn{ch:concrete-instances-reality-constrained-model-error-budget-namecert}{Model-audit error budgets are realized as finite source-trace, observation-window, mismatch-ledger, failure-surface, transport, route, provenance, and NameCert rows.}
