...
| `bedc-quality-lab:gap-head-pair-rule-bounded-capsule` | `reports/canonical/gap-head-pair-rule-bounded-capsule.{json,md}` | `reports/canonical/index.json:$.gap_head_pair_rule_bounded_capsule` | pointer-only |
| `bedc-quality-lab:irreducibility-report` | `reports/canonical/irreducibility_report.json`, `reports/canonical/order_residual_analysis.md`, `reports/canonical/conditional_information_table.json` | `reports/canonical/index.json:$.irreducibility_report` | pointer-only |
