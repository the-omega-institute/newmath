...
RESULT_PATH = Path("/tmp/cit-verify.json")
...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        "schema_id": "bedc-quality-lab:cit-verify",
        "result_path": str(args.result_path),
        "runner": "scripts/run_cit_verify.py",
        "arms": [run_arm(config), run_fresh_action(config)],
    }
