...
WITNESS_GAP_CONTRACTS: dict[str, WitnessGapContract] = {
    "classifier_surface_delta_zero": WitnessGapContract(
        ...
        regression_test_pointer="tests/test_certificate_guided_discovery.py::test_nonpositive_net_information_forces_non_positive_discovery_on_classifier_surface",
    ),
    "matched_control_positive": WitnessGapContract(
        ...
        demotion_rule="rejected/DN",
        regression_test_pointer="tests/test_gap_head_discovery.py::test_control_positive_forces_unresolved_main_claim",
    ),
    "hidden_debt_positive": WitnessGapContract(
        ...
        regression_test_pointer="tests/test_demote_thesis_invariant_audit.py::test_positive_tradeoff_fixture_is_caught",
    ),
    "cost_protocol_missing": WitnessGapContract(
        ...
        demotion_rule="rejected/DN",
        regression_test_pointer="tests/test_certificate_guided_discovery.py::test_loader_rejects_when_shared_cost_protocol_name_not_true",
    ),
    "scorecard_not_ready": WitnessGapContract(
        ...
        demotion_rule="ledger-only/D1",
        regression_test_pointer="tests/test_verdict.py::test_well_formed_not_ready_scorecard_goes_to_ledger_only",
    ),
    "forbidden_inference_column": WitnessGapContract(
        ...
        demotion_rule="rejected/DN",
        regression_test_pointer="tests/test_rejection.py::test_rejects_forbidden_positive_claim_term_from_shared_owner",
    ),
    "benefit_debt_tradeoff": WitnessGapContract(
        ...
        demotion_rule="demoted/DR",
        regression_test_pointer="tests/test_certificate_guided_discovery.py::test_tradeoff_training_payload_keeps_discovery_main_claim_non_positive",
    ),
...
def _ledger_row(witness: RuntimeWitness) -> dict[str, Any]:
    ...
    if contract.demotion_rule != _expected_demotion(decision, projection.discovery_level):
    ...
    return {
        ...
        "demotion_rule": contract.demotion_rule,
        "regression_test_pointer": contract.regression_test_pointer,
...
def write_witness_ledger(path: Path | None = None, *, generated_at: str | None = None) -> dict[str, Any]:
    ...
    if generated_at is None and target.exists():
        generated_at = json.loads(target.read_text(encoding="utf-8")).get("generated_at")
