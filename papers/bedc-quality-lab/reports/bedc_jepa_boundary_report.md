...
- boundary-protocol-sketch-scope
- one-boundary-family
- public-scale-planning-rollout-debt

## Debt items

- model-debt: this artifact defines the boundary-world protocol sketch; gradient-trained objective evidence is reported in the torch objective artifacts
