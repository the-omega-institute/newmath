...
| --- | --- | --- | --- | --- |
| `prop:d565f7982366` | `negative_discovery_followup` | `reports/canonical/negative_discovery_reports.json:$.rows[0]` | `reports/canonical/negative_discovery_reports.json:$.rows[0].failed_gate` | `39773726` |
| `prop:1152f57add5e` | `negative_discovery_followup` | `reports/canonical/negative_discovery_reports.json:$.rows[1]` | `reports/canonical/negative_discovery_reports.json:$.rows[1].failed_gate` | `1054647226` |
| `prop:312c066ec599` | `negative_discovery_followup` | `reports/canonical/negative_discovery_reports.json:$.rows[2]` | `reports/canonical/negative_discovery_reports.json:$.rows[2].failed_gate` | `147550489` |
| `prop:4bb5dfd93ab8` | `negative_discovery_followup` | `reports/canonical/negative_discovery_reports.json:$.rows[3]` | `reports/canonical/negative_discovery_reports.json:$.rows[3].failed_gate` | `2727667912` |
