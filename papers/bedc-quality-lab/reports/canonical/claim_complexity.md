...
| `claim:dimension-mismatch-debt-transfer` | `7` | `reports/canonical/claim_verdicts.jsonl:$.lines[34]` | `assumption_complexity=2, proof_burden=0, evidence_burden=2, backend_coupling=0, witness_exposure=1, revocation_fragility=2` |
| `claim:single-threshold-escape` | `7` | `reports/canonical/claim_verdicts.jsonl:$.lines[35]` | `assumption_complexity=2, proof_burden=0, evidence_burden=2, backend_coupling=0, witness_exposure=1, revocation_fragility=2` |
| `claim:training-choice-observability` | `7` | `reports/canonical/claim_verdicts.jsonl:$.lines[36]` | `assumption_complexity=2, proof_burden=0, evidence_burden=2, backend_coupling=0, witness_exposure=1, revocation_fragility=2` |
