...
| `claim:structural-generalization-splits` | `1` | `reports/canonical/claim_verdicts.jsonl:$.lines[20]` | `assumption_complexity=0, proof_burden=0, evidence_burden=1, backend_coupling=0, witness_exposure=0, revocation_fragility=0` |
