...
| `claim:discovery-gated-nas` | `6` | `reports/canonical/claim_verdicts.jsonl:$.lines[19]` | `assumption_complexity=2, proof_burden=0, evidence_burden=1, backend_coupling=0, witness_exposure=1, revocation_fragility=2` |
| `claim:discovery-gated-transformer` | `11` | `reports/canonical/claim_verdicts.jsonl:$.lines[20]` | `assumption_complexity=5, proof_burden=2, evidence_burden=3, backend_coupling=1, witness_exposure=0, revocation_fragility=0` |
