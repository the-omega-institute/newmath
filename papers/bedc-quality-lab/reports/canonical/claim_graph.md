...
| `projected:dgt-ablation-null-decomposition` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[23]` | `raw:dgt-ablation-null-decomposition` |
| `raw:dgt-component-redundancy-audit` | `raw_evidence` | `reports/canonical/dgt-component-redundancy-audit.json:$` |  |
| `projected:dgt-component-redundancy-audit` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[24]` | `raw:dgt-component-redundancy-audit` |
| `raw:order-k-benchmark` | `raw_evidence` | `reports/canonical/order-k-benchmark.json:$` |  |
| `projected:order-k-benchmark` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[25]` | `raw:order-k-benchmark` |
| `raw:lejepa-theorem-ledger` | `raw_evidence` | `reports/canonical/lejepa_theorem_ledger.json:$.theorem_rows` |  |
| `projected:lejepa-theorem-ledger` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[26]` | `raw:lejepa-theorem-ledger` |
| `raw:observed-debt-sweep` | `raw_evidence` | `reports/canonical/observed-debt-sweep.json:$` |  |
| `projected:observed-debt-sweep` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[27]` | `raw:observed-debt-sweep` |
| `raw:spectral-ablation-hinge` | `raw_evidence` | `reports/canonical/negative_discovery_reports.json:$.rows[3]` |  |
| `projected:spectral-ablation-hinge` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[28]` | `raw:spectral-ablation-hinge` |
| `raw:model-comparison` | `raw_evidence` | `reports/canonical/model-comparison.json:$` |  |
| `projected:model-comparison` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[29]` | `raw:model-comparison` |
| `raw:causal-patch-suite` | `raw_evidence` | `reports/canonical/causal_patch_suite.json:$` |  |
| `projected:causal-patch-suite` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[30]` | `raw:causal-patch-suite` |
| `raw:experiment-stack-cards` | `raw_evidence` | `reports/canonical/experiment_stack_cards.json:$` |  |
| `projected:experiment-stack-cards` | `projected_discovery` | `reports/canonical/discovery_map.json:$.rows[31]` | `raw:experiment-stack-cards` |
...
| `terminal:discovery-gated-transformer` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[21]` | `projected:discovery-gated-transformer` |
| `terminal:dgt-neural-ablation` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[22]` | `projected:dgt-neural-ablation` |
| `terminal:dgt-ablation-null-decomposition` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[23]` | `projected:dgt-ablation-null-decomposition` |
| `terminal:dgt-component-redundancy-audit` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[24]` | `projected:dgt-component-redundancy-audit` |
| `terminal:order-k-benchmark` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[25]` | `projected:order-k-benchmark` |
| `terminal:lejepa-theorem-ledger` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[26]` | `projected:lejepa-theorem-ledger` |
| `terminal:observed-debt-sweep` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[27]` | `projected:observed-debt-sweep` |
| `terminal:spectral-ablation-hinge` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[28]` | `projected:spectral-ablation-hinge` |
| `terminal:model-comparison` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[29]` | `projected:model-comparison` |
| `terminal:causal-patch-suite` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[30]` | `projected:causal-patch-suite` |
| `terminal:experiment-stack-cards` | `terminal_claim` | `reports/canonical/claim_verdicts.jsonl:$.lines[31]` | `projected:experiment-stack-cards` |
