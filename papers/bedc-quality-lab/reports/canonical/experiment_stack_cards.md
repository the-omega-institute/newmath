...
| `metric-provenance-card` | `blocked` | `1201` | `reports/canonical/index.json` | `reports/canonical/index.json:$.evidence_provenance.metric_rows[28]` | `reports/canonical/index.json:$.evidence_provenance.metric_rows[28].source_type` | `reports/canonical/index.json:$.evidence_provenance.metric_rows[28].not_claimed` | `STACK-HG1:pass, STACK-HG2:fail` |
| `training-authenticity-card` | `blocked` | `1201` | `reports/canonical/index.json` | `reports/canonical/index.json:$.evidence_provenance.producer_audits[28]` | `reports/canonical/index.json:$.evidence_provenance.producer_audits[28].training_evidence_status` | `reports/canonical/index.json:$.evidence_provenance.producer_audits[28].not_claimed` | `STACK-HG1:pass, STACK-HG2:fail` |
| `statistical-evidence-card` | `blocked` | `1201` | `reports/canonical/index.json` | `reports/canonical/index.json:$.evidence_provenance.metric_rows[28]` | `reports/canonical/index.json:$.evidence_provenance.metric_rows[28].allowed_for_empirical_claim, reports/canonical/index.json:$.evidence_provenance.metric_rows[28].source_type` | `reports/canonical/index.json:$.evidence_provenance.metric_rows[28].not_claimed` | `STACK-HG1:pass, STACK-HG2:fail` |
