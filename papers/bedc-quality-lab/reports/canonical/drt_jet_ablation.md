...
| --- | --- | --- |
| `full_drt_jet` | `` | `reports/canonical/discovery-regularized-training.json:$.jet_loss_surface.by_arm.drt_jet` |
| `without_jet` | `jet` | `reports/canonical/discovery-regularized-training.json:$.jet_loss_surface.by_arm.drt` |
| `matched_random_jet` | `certificate,witness` | `reports/canonical/discovery-regularized-training.json:$.jet_loss_surface.by_arm.matched_random` |
