...
| `reports/canonical/discovery-gated-transformer.json:$.artifact_id` | `reports/canonical/discovery-gated-transformer.json:$` | `reports/canonical/discovery-gated-transformer.json:$.d5_m_projection` | `reports/canonical/discovery-gated-transformer.json:$.hardgate.status` | `reports/canonical/discovery-gated-transformer.json:$.d5_m_projection.mechanism_certificate_pointer` | `reports/canonical/discovery-gated-transformer.json:$.d5_m_projection.negative_witness_audit` | `reports/canonical/discovery-gated-transformer.json:$.not_claimed` | `reports/canonical/negative_witness_mutation_ledger.json:$.entries` | `pass` |
