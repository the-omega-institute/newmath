...
| `reports/canonical/discovery-gated-nas.json:$.artifact_id` | `reports/canonical/discovery-gated-nas.json:$` | `reports/canonical/discovery-gated-nas.json:$.discovery_map_signal` | `reports/canonical/discovery-gated-nas.json:$.hardgate.status` | `reports/canonical/discovery-gated-nas.json:$.candidate_protocol` | `reports/canonical/discovery-gated-nas.json:$.hardgate.gates.DG-NAS-HG7` | `reports/canonical/discovery-gated-nas.json:$.not_claimed` | `reports/canonical/negative_witness_mutation_ledger.json:$.entries[2]` | `pass` |
| `reports/canonical/discovery_gated_transformer.json:$.artifact_id` | `reports/canonical/discovery_gated_transformer.json:$` | `reports/canonical/discovery_gated_transformer.json:$.public_index_pointers` | `reports/canonical/discovery_gated_transformer.json:$.status` | `reports/canonical/discovery_gated_transformer.json:$.mechanism_certificate` | `reports/canonical/discovery_gated_transformer.json:$.downstream_scope` | `reports/canonical/discovery_gated_transformer.json:$.not_claimed` | `reports/canonical/negative_witness_mutation_ledger.json:$.entries` | `pass` |
