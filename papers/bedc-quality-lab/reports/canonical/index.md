...
| `fair-l1-decision` | `pass` | `bounded-negative` | `fail` | `l1-bounded-negative` | `bounded-negative` | `bounded-negative` | `True` | `` | `reports/canonical/fair-l1-decision.json` | `reports/canonical/fair-l1-decision.md` | `reports/canonical/fair-l1-decision.fingerprint.json` | `$.not_claimed` | `$.source_artifacts` | `$.not_claimed` | `$.decision.status` | `$.fair_alignment.comparison_rows` |
