...
| `CONS-HG2` | `pass` | `reports/canonical/claim_verdicts.jsonl:$.lines[23]` | positive verdict uses the current scorecard hash | `dca94dae47b41cde467bcbf6c4ac8b58649f5ebd67f9fe2382d362eba1d760dc` | `dca94dae47b41cde467bcbf6c4ac8b58649f5ebd67f9fe2382d362eba1d760dc` |
...
| `CONS-HG4` | `pass` | `reports/canonical/claim_graph.json:$.nodes[111]` | terminal graph path uses Core claim verdict row | `consistent` | `consistent` |
