...
| `CONS-HG2` | `pass` | `reports/canonical/claim_verdicts.jsonl:$.lines[21]` | non-positive verdict has no scorecard hash promotion dependency | `not applicable` | `not applicable` |
