...
| `CONS-HG2` | `pass` | `reports/canonical/claim_verdicts.jsonl:$.lines[23]` | non-positive verdict has no scorecard hash promotion dependency | `not applicable` | `not applicable` |
...
| `STACK-HG1` | `pass` | `reports/canonical/claim_verdicts.jsonl:$.lines[23]` | non-positive verdict has no claim-first pointer requirement | `not applicable` | `not applicable` |
| `STACK-HG2` | `pass` | `reports/canonical/claim_verdicts.jsonl:$.lines[23]` | non-positive verdict has no claim-first owner-status requirement | `not applicable` | `not applicable` |
| `CLAIM-FIRST-HG1` | `pass` | `reports/canonical/claim_verdicts.jsonl:$.lines[23]` | no accepted positive row requires claim-first admission | `not applicable` | `not applicable` |
