...
`discovery-gated-nas` | `design-search-certificate-slot` | `reports/canonical/discovery-gated-nas.json:$.candidate_protocol` | `reports/canonical/discovery-gated-nas.json:$.search_objective_summary.selected_candidate` | `reports/canonical/discovery-gated-nas.json:$.candidate_protocol.design_search_certificate` | `reports/canonical/discovery-gated-nas.json:$.matched_baseline_control` | `reports/canonical/discovery-gated-nas.json:$.negative_witness_mutations` | `pass`
