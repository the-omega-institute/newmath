...
- Generated at: `2026-06-04T07:02:53.665397+00:00`
...
| `two-axis-module-analogue` | `hinge-ranked-treatment` | `(0, 1)` | `sinusoidal_shear` | -0.124069 | 0.000000 | 0.000000 | -0.031146 |
...
| `matched-random-module` | `matched-random-control` | `(1, 0)` | `sinusoidal_shear` | -0.031093 | -0.004481 | -0.000780 | 0.000000 |

## Rank correlation

- Spearman: `0.866025`
- Kendall: `1.000000`
- CI95: `[-0.133975, 1.000000]`
