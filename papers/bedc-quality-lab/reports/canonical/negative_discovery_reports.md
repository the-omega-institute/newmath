...
| `dn:discovery-gated-nas` | `discovery-gated-nas` | `claim:discovery-gated-nas` | `$.hardgate.gates.DG-NAS-HG7.status` | `reports/canonical/discovery-gated-nas.json:$.hardgate.gates.DG-NAS-HG7.status` | `pass` |
...
| `dn:gap-head-mechanism-blockage` | `gap-head-mechanism-blockage` | `claim:gap-head-mechanism-blockage` | `$.ledger_policy.mechanism_closure_debt.status` | `reports/gap_head_mechanism_namecert.json:$.ledger_policy.mechanism_closure_debt.status` | `pass` |
