...
def _write_suite_dependencies(root):
    l0_payload = dgt_l0_controls.build_payload(generated_at="fixture-time", requested_device="cpu")
    dgt_l0_controls.write_artifacts(l0_payload, root=root, generated_at="fixture-time")
    l1_payload = dgt_l1_controls.build_payload(generated_at="fixture-time", requested_device="cpu")
    dgt_l1_controls.write_artifacts(l1_payload, root=root, generated_at="fixture-time")
