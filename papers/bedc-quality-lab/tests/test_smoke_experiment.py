...
def assert_common_experiment_envelope(envelope):
    ...
    assert envelope.source_spec == {
        ...
        "transition_kernel": {
            ...
            "eigenvalue_interleaving": {
                ...
                "eigenvalues": [0.82, 0.82],
                "sorted_eigenvalues": [0.82, 0.82],
                "adjacent_gaps": [0.0],
    ...
    assert envelope.stability_spec == {
        ...
        "transition_eigenvalue_interleaving": {
            "operator": "diagonal-ou-transition",
            "eigenvalues": [0.82, 0.82],
            "sorted_eigenvalues": [0.82, 0.82],
            "adjacent_gaps": [0.0],
...
FALLBACK_DEBT_ITEMS = [
    ...
    "kind=source; residue=action-transition-identification; severity=none; status=closed; score=0.000000",
