...
TURNOVER_DATA_RELATIVE_PATH = "tools/fibonacci_reality/data/protein_turnover_homo_sapiens.json"
...
def main() -> None:
    ...
    required = [
        ...
        f"tools/fibonacci_reality/data/proteomics_abundance_{ORGANISM}.json",
        f"tools/fibonacci_reality/data/cds_codon_abundance_{ORGANISM}.json",
        f"tools/fibonacci_reality/data/gtrnadb_trna_all_copy_{TRNA_ORGANISM}.json",
            ...
            checks=[
                {
                    ...
                    "expected": "tools/fibonacci_reality/data/protein_turnover_homo_sapiens.json exists and contains protein_turnover with n >= 500",
                },
