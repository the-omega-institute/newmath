#!/usr/bin/env python3
"""Verify the pinned automath F-A1 certificate snapshot."""
...
EXPECTED_LEAN_PATH = "lean4/Omega/GroupUnification/EdgeFluxMod3Obstruction.lean"
EXPECTED_OBJECT = "paper_window6_edge_flux_mod3_obstruction"
SNAPSHOT_PATH = (
    "tools/fibonacci_reality/data/"
    "automath_cert_window6_edge_flux_mod3_obstruction.json"
)
