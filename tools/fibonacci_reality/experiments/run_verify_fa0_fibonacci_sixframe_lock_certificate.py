#!/usr/bin/env python3
"""Verify the pinned automath F-A0 certificate snapshot."""
...
EXPECTED_LEAN_PATH = "lean4/Omega/Conclusion/Window6FibonacciSixframeLock.lean"
EXPECTED_OBJECT = "paper_conclusion_window6_fibonacci_sixframe_lock"
SNAPSHOT_PATH = (
    "tools/fibonacci_reality/data/"
    "automath_cert_window6_fibonacci_sixframe_lock.json"
)
