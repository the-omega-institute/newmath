#!/usr/bin/env python3
"""Verify the pinned automath golden-mean subshift factor-map snapshot."""
...
EXPECTED_LEAN_PATH = "lean4/Omega/Folding/PhiSubshiftFactorPublication.lean"
EXPECTED_OBJECT = "paper_resolution_phi_m_factor_seeds"
SNAPSHOT_PATH = (
    "tools/fibonacci_reality/data/"
    "automath_cert_phi_m_factor_golden_mean_subshift.json"
)
