#!/usr/bin/env python3
"""Verify the pinned automath Binet golden-ratio characteristic snapshot."""
...
EXPECTED_LEAN_PATH = "lean4/Omega/POM/MultiplicityBinetTwoParameterNormalForm.lean"
EXPECTED_OBJECT = "paper_pom_multiplicity_binet_two_parameter_normal_form"
SNAPSHOT_PATH = (
    "tools/fibonacci_reality/data/"
    "automath_cert_binet_golden_ratio_characteristic.json"
)
