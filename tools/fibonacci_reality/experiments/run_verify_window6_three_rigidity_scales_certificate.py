#!/usr/bin/env python3
"""Verify the pinned automath Window6 three-rigidity-scales snapshot."""
...
EXPECTED_LEAN_PATH = "lean4/Omega/Folding/BinFold.lean"
EXPECTED_OBJECT = "three_rigidity_scales_six"
SNAPSHOT_PATH = (
    "tools/fibonacci_reality/data/"
    "automath_cert_window6_three_rigidity_scales.json"
)
