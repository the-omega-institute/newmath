#!/usr/bin/env python3
"""Verify the pinned automath Zeckendorf cyclic sector-character snapshot."""
...
EXPECTED_LEAN_PATH = "lean4/Omega/Conclusion/CyclicZeckendorfSectorCharacterClosedForm.lean"
EXPECTED_OBJECT = "paper_conclusion_cyclic_zeckendorf_sector_character_closed_form"
SNAPSHOT_PATH = (
    "tools/fibonacci_reality/data/"
    "automath_cert_cyclic_zeckendorf_sector_character.json"
)
