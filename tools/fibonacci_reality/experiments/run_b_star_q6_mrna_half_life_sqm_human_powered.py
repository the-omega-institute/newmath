...
MRNA_DATA_PATH = "tools/fibonacci_reality/data/mrna_half_life_homo_sapiens_agarwal_consensus.json"
CDS_DATA_PATH = "tools/fibonacci_reality/data/cds_codon_abundance_homo_sapiens.json"
PROTEOMICS_DATA_PATH = "tools/fibonacci_reality/data/proteomics_abundance_homo_sapiens.json"
