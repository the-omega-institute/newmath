...
TURNOVER_DATA_RELATIVE_PATH = "tools/fibonacci_reality/data/protein_turnover_saccharomyces_cerevisiae.json"
...
def fixed_fetched_at() -> str:
    return os.environ.get("FIBONACCI_REALITY_FETCHED_AT", "2026-06-07T00:00:00+00:00")
...
def fetch_turnover_payload() -> tuple[bytes, dict[str, object]]:
    request = urllib.request.Request(
        TURNOVER_URL,
        headers={
            "User-Agent": "FibonacciReality-Codex-ProteinTurnover/1.0",
    ...
    with urllib.request.urlopen(request, timeout=60) as response:
        ...
        metadata = {
            ...
            "fetched_by": "FibonacciReality-Codex-ProteinTurnover",
