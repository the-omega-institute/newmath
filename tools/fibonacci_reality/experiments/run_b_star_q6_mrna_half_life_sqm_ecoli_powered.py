...
MRNA_DATA_PATH = "tools/fibonacci_reality/data/mrna_half_life_escherichia_coli_esquerre.json"
CDS_DATA_PATH = "tools/fibonacci_reality/data/cds_codon_abundance_escherichia_coli_k12_mg1655.json"
