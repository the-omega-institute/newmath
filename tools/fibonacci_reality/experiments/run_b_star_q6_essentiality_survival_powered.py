...
def main() -> None:
    ...
    required = (
        [
            f"tools/fibonacci_reality/data/gene_essentiality_{organism}.json"
    ...
    try:
        ...
        for organism in ORGANISMS:
            essentiality_payload = load_json(repo / f"tools/fibonacci_reality/data/gene_essentiality_{organism}.json")
            abundance_payload = load_json(repo / f"tools/fibonacci_reality/data/cds_codon_abundance_{organism}.json")
