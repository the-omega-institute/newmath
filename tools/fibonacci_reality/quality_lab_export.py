#!/usr/bin/env python3
"""Compile FibonacciReality runtime packets into quality-lab durable exports."""
...
SCHEMA_ID = "fibonacci-reality:quality-lab-exports"
OWNER = "tools.fibonacci_reality.quality_lab_export"
...
def artifact_paths(claim_id: str, conjecture: dict[str, Any]) -> dict[str, str]:
    ...
    bio_paths = sorted((REPO_ROOT / "papers" / "fibonacci_reality" / "parts").glob("**/*.tex"))
    bedc_paths = sorted((REPO_ROOT / "papers" / "bedc" / "parts" / "concrete_instances").glob("*bioreality*.tex"))
    bio_fallback = "papers/fibonacci_reality/parts/forced_window_structure.tex"
...
def seeded_runtime() -> tuple[
    ...
    contacts = [
        ...
        },
        {
            ...
            "source_ref": "tools/fibonacci_reality/data/curated_orf_interval_contact_dataset.json",
        },
        {
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Compile FibonacciReality quality-lab export registry")
