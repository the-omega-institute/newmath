...
def base_contact(candidate: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "fibonacci_reality_curated_external_contact_v1",
...
def main() -> int:
    ...
    try:
        ...
        manifest = {
            "schema_version": "fibonacci_reality_multi_organism_campaign_manifest_v1",
            "fetched_by": "bio-data-fetcher",
            "fetched_at": now_iso(),
            "success_count": 0,
            "failure_count": 1,
        ...
        json.dumps(
            {
                ...
                "failure_count": len(failures),
                "sample_anticodon_copy_summaries": trna_samples,
                "manifest": "tools/fibonacci_reality/data/multi_organism_campaign_manifest.json",
            },
            indent=2,
            sort_keys=True,
        )
