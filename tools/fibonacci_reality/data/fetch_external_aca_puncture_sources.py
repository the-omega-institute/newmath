...
USER_AGENT = "FibonacciReality-data-fetcher/1.0"
...
def main() -> int:
    ...
    build_dataset()
    print(json.dumps({"written": written, "dataset": "tools/fibonacci_reality/data/external_aca_puncture_challenge_dataset.json"}, indent=2))
    return 0
