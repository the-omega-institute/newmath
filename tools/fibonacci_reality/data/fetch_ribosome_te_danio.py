...
def build_danio() -> dict[str, object]:
    ...
    return {
        ...
        "id_mapping_method": "RPFdb Ensembl gene IDs are stripped of version suffix and matched exactly to the gene:ENSDARG field in the existing FibonacciReality Danio rerio Ensembl CDS headers; when multiple CDS records share one Ensembl gene, the longest CDS representative protein_id is emitted; all unmapped or non-positive genes are skipped.",
