...
def _valid_spine() -> str:
    return "\n".join(
        [
            ...
            r"\origin{ai}",
            "",
            "This FibonacciReality NameCert packet records a bounded code-layer naming certificate. "
            ...
            "",
            r"\falsifiablePrediction{A $\FibonacciRealityTestUp$ packet cannot export translation without a separate contact.}",
            "",
    ...
    checks: list[tuple[str, bool, Any]] = [
        ...
        (
            ...
            check_namecert_generic_prose(
                "This FibonacciReality packet cites 64 codons and a row count of 13 while keeping the claim at code-read scope. "
