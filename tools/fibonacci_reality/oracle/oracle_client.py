...
def submit_query(
    ...
    *,
    ...
    """Submit a query to the FibonacciReality oracle. Returns task_id only (backward compat).
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Submit and poll FibonacciReality oracle queries")
