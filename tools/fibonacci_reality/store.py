#!/usr/bin/env python3
"""JSONL store helpers for the FibonacciReality deepening loop."""
...
class FibonacciRealityPaths:
    ...
    paper_main: Path = SCRIPT_DIR.parent.parent / "papers" / "fibonacci_reality" / "main.tex"
    paper_part: Path = SCRIPT_DIR.parent.parent / "papers" / "fibonacci_reality" / "parts" / "forced_window_structure.tex"
...
class FibonacciRealityStore:
    def __init__(self, paths: FibonacciRealityPaths | None = None) -> None:
        self.paths = paths or FibonacciRealityPaths()
