...
USER_AGENT = "bio-reality-condition-sqp/1.0"
RANK_TOL = 1e-10
RIDGE_EPS = 1e-12
...
CONDITIONS = {
    "YEPD": {
        ...
        "data_path": "tools/bio_reality/data/proteomics_abundance_saccharomyces_cerevisiae_yepd.json",
    },
    "SD": {
        "medium_label": "SD minimal medium",
        "url": "https://pax-db.org/downloads/latest/datasets/4932/4932-Newman_et_al_yeast_data_SD.txt",
        "data_path": "tools/bio_reality/data/proteomics_abundance_saccharomyces_cerevisiae_sd.json",
    },
}
