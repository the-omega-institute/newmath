...
def main() -> None:
    ...
    required = [
        ...
        f"tools/bio_reality/data/structural_order_{organism}.json"
        for organism in ORGANISMS
    ...
    try:
        ...
        for organism in ORGANISMS:
            codon_path = repo / f"tools/bio_reality/data/cds_codon_abundance_{organism}.json"
            structural_path = repo / f"tools/bio_reality/data/structural_order_{organism}.json"
