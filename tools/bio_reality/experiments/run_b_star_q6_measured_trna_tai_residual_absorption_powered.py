...
def write_trna_data_file(
    *,
    ...
    data = {
        "schema_version": "bio_reality_measured_trna_gene_copy_v1",
        "organism": organism,
        ...
        "fetched_by": "BioReality-Codex-Measured-tRNA-tAI",
...
def main() -> None:
    ...
    for item in ORGANISMS:
        ...
        required.append(f"tools/bio_reality/data/gtrnadb_trna_all_copy_{organism}.json")
