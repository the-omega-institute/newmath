...
def build_candidate_specs(
    *,
    ...
    ribosome_path = repo / f"tools/bio_reality/data/ribosome_te_{organism}.json"
    ...
    turnover_path = repo / f"tools/bio_reality/data/protein_turnover_{organism}.json"
    ...
    localization_path = repo / f"tools/bio_reality/data/subcellular_localization_{organism}.json"
    ...
    feature_path = repo / f"tools/bio_reality/data/uniprot_protein_features_{organism}.json"
