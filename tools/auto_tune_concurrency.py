...
PAPER_BUFFER = 4
PAPER_MIN = 4   # API-throughput floor (see LEAN_MAX): paper codex share the same account throttle. earlier note: lowered 2026-05-15 (later): with PAPER_MAX=10 due to push-
