...
SCHEMA_ID = "cellstate-reality:quality-lab-exports"
OWNER = "tools.cellstate_reality.quality_lab_export"
...
def artifact_paths(claim_id: str, conjecture: dict[str, Any]) -> dict[str, str]:
    ...
    bio_paths = sorted((REPO_ROOT / "papers" / "cellstate_reality" / "parts").glob("**/*.tex"))
    bedc_paths = sorted((REPO_ROOT / "papers" / "bedc" / "parts" / "concrete_instances").glob("*bioreality*.tex"))
    bio_fallback = "papers/cellstate_reality/parts/cellstate_context_refresh_boundary.tex"
...
def seeded_runtime() -> tuple[
    ...
    contacts = [
        ...
        },
        {
            ...
            "source_ref": "tools/cellstate_reality/data/curated_orf_interval_contact_dataset.json",
        },
        {
