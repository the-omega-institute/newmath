...
class BioRealityPaths:
    ...
    bedc_writeback_log: Path = SCRIPT_DIR / "state" / "bedc_writeback.log"
    ...
    paper_main: Path = SCRIPT_DIR.parent.parent / "papers" / "cellstate_reality" / "main.tex"
    paper_part: Path = SCRIPT_DIR.parent.parent / "papers" / "cellstate_reality" / "parts" / "cellstate_context_refresh_boundary.tex"
