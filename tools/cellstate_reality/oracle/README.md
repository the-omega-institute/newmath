...
- cellstate_reality_oracle_server.py: local HTTP server on :8769
- cellstate_reality_oracle_macos.user.js: Tampermonkey userscript for
...
3. Paste contents of cellstate_reality_oracle_macos.user.js
4. Save
...
```bash
python3 tools/cellstate_reality/oracle/oracle_client.py --health-check
```

## Send a query

```bash
python3 tools/cellstate_reality/oracle/oracle_client.py --query "..." --intended-claim h0.M.equals.WNR.CUN
```
