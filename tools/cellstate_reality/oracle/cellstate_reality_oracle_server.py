#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Forked from tools/bedc-deep/bedc_oracle_server.py v1.21; differences: port 8770,
# sessions under tools/cellstate_reality/state/oracle_sessions/, namespace bio_*.
...
Differences vs the paper oracle:
  - Port 8770 (bio-reality oracle is 8769, paper oracle is 8765). Run them side by side.
  ...
  - Sessions persist to disk at tools/cellstate_reality/state/oracle_sessions/
...
Usage:
    python3 tools/cellstate_reality/oracle/cellstate_reality_oracle_server.py

    # Open ChatGPT.com tab(s) with cellstate_reality_oracle_macos.user.js installed,
...
Hard rules:
  ...
  - Server never auto-publishes anything. Results land in sessions/ and are
    consumed by tools/cellstate_reality/oracle/oracle_client.py state JSON.
"""
