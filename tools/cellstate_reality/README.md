...
- `lanes.py` defines the `bio-V`, `bio-P`, `bio-G`, `bio-R`, `bio-W`, `bio-Q`, and
  `bio-A` local lanes.
- `cellstate_reality_loop.py` runs one deterministic deepening cycle and plans the
  next tasks.
...
- `papers/cellstate_reality/main.tex` and `papers/cellstate_reality/parts/` are the
...
- `tools/cellstate_reality/inbox/`
- `tools/cellstate_reality/out/`
- `tools/cellstate_reality/state/`
- `tools/cellstate_reality/cache/`
...
```text
tools/cellstate_reality/out/gate_results.jsonl
tools/cellstate_reality/out/deepening_tasks.jsonl
tools/cellstate_reality/out/review_queue.jsonl
tools/cellstate_reality/out/packet_targets.jsonl
tools/cellstate_reality/out/events.jsonl
tools/cellstate_reality/out/agent_tasks.jsonl
tools/cellstate_reality/out/agent_reviews.jsonl
tools/cellstate_reality/out/hardening_targets.jsonl
tools/cellstate_reality/out/lane_dashboard.md
```
...
- `bio-V` is the vision lane. It scans `tools/cellstate_reality/vision/*.md`, appends
...
- `bio-K` is the keep lane. It runs at the end of every cycle, filters
  ...
  pushes useful spec changes to `origin/feat/cellstate_reality-deepening`.
...
independent checkpoint in `tools/cellstate_reality/state/loop_state.json`, and
...
python3 tools/cellstate_reality/cellstate_reality_loop.py --self-test
python3 tools/cellstate_reality/vision_intake.py --self-test
python3 tools/cellstate_reality/agent_bus.py --self-test
python3 tools/cellstate_reality/lanes.py --self-test
python3 tools/cellstate_reality/supervisor.py --once
```
