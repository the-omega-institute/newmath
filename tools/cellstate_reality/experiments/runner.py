...
SCRIPT_ROOT = Path("tools/cellstate_reality/experiments")
...
def load_experiments_registry(repo_root: Path) -> list[dict[str, Any]]:
    data = _safe_load_json(repo_root / "tools/cellstate_reality/registries/experiments.json")
...
def load_claims_registry(repo_root: Path) -> dict[str, dict[str, Any]]:
    data = _safe_load_json(repo_root / "tools/cellstate_reality/registries/claims.json")
