...
| --- | --- | --- | --- | --- | --- |
| `Evidence-only S1 normalization shortcut from Automath integral lemma` | `board_continuation` | `aecb76a5a5eed83cc6bdbb981b51ebfb58dd695f` | `papers/publication/2026_cayley_chebyshev_poisson_entropy_strip_rkhs_jfa/sec_appendix.tex` | `tools\automath_newmath_bridge\review_packets\papers-publication-2026-cayley-chebyshev-poisson-entropy-strip-rkhs-jfa-sec-appendix-tex-98a1027e8c35.json` | evidence-only normalization shortcut note; no theorem work unless a finite BEDC carrier is already named |
| `S1 boundary-readback Cayley coordinate certificate` | `board_continuation` | `aecb76a5a5eed83cc6bdbb981b51ebfb58dd695f` | `papers/publication/2026_cayley_chebyshev_poisson_entropy_strip_rkhs_jfa/sec_cayley_gate.tex` | `tools\automath_newmath_bridge\review_packets\papers-publication-2026-cayley-chebyshev-poisson-entropy-strip-rkhs-jfa-sec-cayley-gate-tex-ce39cd0cc9a6.json` | one S1 boundary-readback Cayley coordinate certificate row or a rejected BEDC-fit note |
| `Gap-policy monotone functional evidence from Automath Doob flow` | `board_continuation` | `aecb76a5a5eed83cc6bdbb981b51ebfb58dd695f` | `papers/publication/2026_cayley_chebyshev_poisson_entropy_strip_rkhs_jfa/sec_doob_phi_entropy.tex` | `tools\automath_newmath_bridge\review_packets\papers-publication-2026-cayley-chebyshev-poisson-entropy-strip-rkhs-jfa-sec-doob-phi-entropy-tex-218a5391e43c.json` | one gap-policy proof-obligation shortcut naming a monotone functional carrier, or a rejected BEDC-fit note |
