---
title: "从 16 走到 64"
subtitle: 'Cook 编译前沿当前最大生产规则数到 16, 最大 tape 符号数到 32, $P \cdot T$ 峰值 64. 一个 halted 图灵机需要 $P \cdot T = 4096$. 差距是有限工程距离'
author: "The Omega Institute"
date: 2026-05-14
lang: zh-Hans
description: 'Rule 110 原则上普适. 元胞底层当前通过的 configuration 最大 P=16, 最大 T=32, $P \cdot T$ 峰值 64. 最小 halted TM 编译到 ~64 生产规则 $\times$ 64 tape 符号 ($P \cdot T = 4096$). 差距是工程距离, 不是理论 — 跨越它的工作把『原则上普适』转换为『被见证的普适』.'
---
...
- `tm_to_tag.c` — Cook §1.2: TM 转移编译成 tag 系统生产规则
