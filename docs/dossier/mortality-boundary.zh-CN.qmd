...
date: 2026-06-04
lang: zh-Hans
description: "一篇中文 dossier: 用 BEDC 区分纯 Hist 延续、有限具身承载与死亡的数学边界."
---
...
令 $\Hist$ 为闭合历史载体, $\Cont(h,d,h')$ 表示 $h'$ 是 $h$ 经 distinction 数据 $d$ 的形式延续. 定义形式可延续性:
$$
...
对具身意识历史 $i$, 令 $H_i(t)$ 为局部阶段 $t$ 的聚焦历史, 并令
$$
