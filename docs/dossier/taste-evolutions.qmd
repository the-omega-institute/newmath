...
> 最后刷新: 2026-05-20T09:51:49Z

**Daemon 状态**: research (monitor cycle 1, adjust_since_research 0, round_counter 1660, last_adjust rule_evolution_completed)

**待处理 queue** (21 条 finding):
...
- mislabeled_composite: 2 条; 代表样本 `tailcofinalitybudget`, `auditgatecomposition`
