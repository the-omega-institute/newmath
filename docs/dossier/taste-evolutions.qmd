...
> 最后刷新: 2026-05-27T11:01:12Z

**Daemon 状态**: monitor (monitor cycle 86, adjust_since_research 3, round_counter 21157, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (892 条 finding):
- isolated_theorem: 642 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 437 次
- TASTE ALERT category=low_entropy_template: 24 次
