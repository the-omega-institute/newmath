...
> 最后刷新: 2026-05-27T06:57:48Z

**Daemon 状态**: monitor (monitor cycle 82, adjust_since_research 3, round_counter 20806, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (867 条 finding):
- isolated_theorem: 618 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 463 次
- TASTE ALERT category=unauthorized_capstone: 224 次
- TASTE ALERT category=low_entropy_template: 25 次
