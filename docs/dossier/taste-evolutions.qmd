...
> 最后刷新: 2026-05-20T17:21:48Z

**Daemon 状态**: adjust (monitor cycle 2, adjust_since_research 2, round_counter 2422, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (29 条 finding):
- low_entropy_template: 16 条; 代表样本 `realityconstrainedmodelaudit`, `lipschitzmap`, `zetacontinuationwitness`
- isolated_theorem: 6 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
- mislabeled_composite: 4 条; 代表样本 `metacicnormalizationconfluencebridge`, `compilerclassifierroute`, `substitutionboundaryaudit`
- missing_origin: 3 条; 代表样本 `banach`, `int`, `continuousmap`

**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 73 次
- TASTE ALERT category=mislabeled_composite: 48 次
- TASTE ALERT category=low_entropy_template: 26 次
- TASTE ALERT category=taste_branch_gc_delete_failed: 5 次
- TASTE ALERT category=rule_evolution_failed: 4 次
- TASTE ALERT category=inventory_failed: 2 次
- TASTE ALERT category=research_non_negative_criterion: 2 次
