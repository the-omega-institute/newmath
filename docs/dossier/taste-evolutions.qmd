...
> 最后刷新: 2026-05-29T13:19:10Z

**Daemon 状态**: monitor (monitor cycle 113, adjust_since_research 3, round_counter 24757, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (995 条 finding):
- isolated_theorem: 739 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 125 次
- TASTE ALERT category=low_entropy_template: 12 次
- TASTE ALERT category=cycle_exception: 6 次
