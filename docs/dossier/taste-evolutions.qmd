...
> 最后刷新: 2026-05-26T21:33:04Z

**Daemon 状态**: monitor (monitor cycle 76, adjust_since_research 3, round_counter 19767, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (813 条 finding):
- isolated_theorem: 564 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=unauthorized_capstone: 612 次
- TASTE ALERT category=isolated_theorem: 527 次
- TASTE ALERT category=low_entropy_template: 33 次
