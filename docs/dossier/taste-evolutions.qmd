...
> 最后刷新: 2026-05-31T02:08:43Z

**Daemon 状态**: monitor (monitor cycle 6, adjust_since_research 0, round_counter 1444, last_adjust none)

**待处理 queue** (30 条 finding):
- isolated_theorem: 26 条; 代表样本 `derived`, `derived`, `derived`
- low_entropy_template: 3 条; 代表样本 `setlike`, `sobolev`, `markovchain`
- missing_origin: 1 条; 代表样本 `reality_bound_codon_topology_orf_interval_contact`

**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 20 次
- TASTE ALERT category=low_entropy_template: 4 次
- TASTE ALERT category=dossier_snapshot_push_failed: 1 次
- TASTE ALERT category=missing_origin: 1 次
