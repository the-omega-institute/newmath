...
> 最后刷新: 2026-05-20T23:29:37Z

**Daemon 状态**: monitor (monitor cycle 0, adjust_since_research 4, round_counter 2712, last_adjust rule_evolution_completed)

**待处理 queue** (111 条 finding):
- mislabeled_composite: 85 条; 代表样本 `finiteobservationrefutation`, `realityconstrainedscientificmethodology`, `emptyfablemachine`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 53 次
- TASTE ALERT category=mislabeled_composite: 38 次
