...
> 最后刷新: 2026-05-30T17:50:12Z

**Daemon 状态**: monitor (monitor cycle 3, adjust_since_research 0, round_counter 597, last_adjust none)

**待处理 queue** (12 条 finding):
- isolated_theorem: 12 条; 代表样本 `derived`, `derived`, `derived`

**最近 alert 概览** (24h 内):
- TASTE ALERT category=low_entropy_template: 2 次
