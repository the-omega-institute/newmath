...
> 最后刷新: 2026-05-31T14:59:19Z

**Daemon 状态**: monitor (monitor cycle 17, adjust_since_research 0, round_counter 2445, last_adjust none)

**待处理 queue** (37 条 finding):
- isolated_theorem: 30 条; 代表样本 `derived`, `derived`, `derived`
- low_entropy_template: 6 条; 代表样本 `setlike`, `sobolev`, `markovchain`
- missing_origin: 1 条; 代表样本 `reality_bound_codon_topology_orf_interval_contact`

**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 20 次
- TASTE ALERT category=low_entropy_template: 16 次
