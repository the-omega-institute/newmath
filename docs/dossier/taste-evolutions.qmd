...
> 最后刷新: 2026-05-31T09:54:33Z

**Daemon 状态**: monitor (monitor cycle 12, adjust_since_research 0, round_counter 2047, last_adjust none)

**待处理 queue** (34 条 finding):
- isolated_theorem: 28 条; 代表样本 `derived`, `derived`, `derived`
- low_entropy_template: 5 条; 代表样本 `setlike`, `sobolev`, `markovchain`
- missing_origin: 1 条; 代表样本 `reality_bound_codon_topology_orf_interval_contact`

**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 20 次
- TASTE ALERT category=low_entropy_template: 11 次
- TASTE ALERT category=cycle_exception: 2 次
- TASTE ALERT category=missing_origin: 2 次
- TASTE ALERT category=dossier_snapshot_push_failed: 1 次
- TASTE ALERT category=resolution_json_parse_failed: 1 次
- TASTE ALERT category=resolution_merge_failed: 1 次
