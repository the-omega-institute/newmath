...
> 最后刷新: 2026-05-23T15:44:34Z

**Daemon 状态**: monitor (monitor cycle 42, adjust_since_research 3, round_counter 11883, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (323 条 finding):
- isolated_theorem: 293 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 314 次
- TASTE ALERT category=low_entropy_template: 6 次
