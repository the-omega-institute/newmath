...
> 最后刷新: 2026-05-22T14:49:20Z

**Daemon 状态**: monitor (monitor cycle 22, adjust_since_research 3, round_counter 8250, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (156 条 finding):
- isolated_theorem: 131 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 47 次
