...
> 最后刷新: 2026-05-22T09:27:12Z

**Daemon 状态**: monitor (monitor cycle 17, adjust_since_research 3, round_counter 7412, last_adjust rule_evolution_skipped_or_failed)

**待处理 queue** (142 条 finding):
- isolated_theorem: 117 条; 代表样本 `derived`, `realityconstrainedtruthcert`, `towerequivalence`
...
**最近 alert 概览** (24h 内):
- TASTE ALERT category=isolated_theorem: 112 次
- TASTE ALERT category=low_entropy_template: 5 次
- TASTE ALERT category=missing_origin: 3 次
...
- TASTE ALERT category=sync_failed: 1 次
