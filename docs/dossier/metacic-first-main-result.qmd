...
# 1837/1837 BEDC theorems pure under #print axioms
...
This is, structurally, what an honest unconditional consistency result for a foundational system looks like. The named scope. The named hypotheses for the boundary. The explicit audit. The 17 + 14 = 31 obligations tracked. The 1837 theorems pure. The dependence on `inductive` and nothing else.
