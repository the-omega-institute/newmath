...
> **Closed-normal consistency.** Let *t* be a closed term of the calculus of inductive constructions, typed at `False` under the empty context, and let *t* be $\beta$-strong (every reduction sequence terminates). Then a contradiction follows.
