...
date: 2026-05-14
description: "Rule 110 is universal in principle. The cellular substrate currently passes configurations with max P=16, max T=32, and $P \\cdot T$ peak of 64 across cases. The minimum halted TM compiles to ~64 productions × 64 tape symbols, i.e. $P \\cdot T = 4096$. The gap is engineering, not theory — and the work to close it converts 'universal in principle' to 'witnessed universal'."
---
