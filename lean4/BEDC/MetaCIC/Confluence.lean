                      ...
                      | intro f2 hf2 =>
                          ...
                          | intro a2 ha2 =>
                              ...
                              | intro ht2 hstars =>
                                  cases hstars with
                                  | intro hf1f2 ha_a2 =>
                                      exact ⟨f2, a2, ht2, BetaStarStep.step hff1 hf1f2,
                                        ha_a2⟩
          | inr hasteps =>
              cases hasteps with
              | intro a1 hapack =>
...
theorem betaStep_pi_iff {d c t : Term} :
  ...
  · intro h
    ...
    | inl hc =>
        ...
        | intro c' hc' =>
            cases hc'.right
            exact BetaStep.congPiCod d c c' hc'.left
    | inr hd =>
        cases hd with
        | intro d' hd' =>
            cases hd'.right
            exact BetaStep.congPiDom d d' c hd'.left
...
theorem betaStep_lam_iff {d b t : Term} :
  ...
  · intro h
    ...
    | inl hb =>
        ...
        | intro b' hb' =>
            cases hb'.right
            exact BetaStep.congLam d b b' hb'.left
    | inr hd =>
        cases hd with
        | intro d' hd' =>
            cases hd'.right
            exact BetaStep.congLamDom d d' b hd'.left
