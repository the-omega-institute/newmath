...
theorem RatHistoryLedgerPolicy_visible_target_e0_endpoint_absurd {rho v w z z' : BHist} :
  ...
  have rawClassified : RatHistoryClassifier rho w :=
    RatHistoryLedgerPolicy_classifier_extension ledger classified
  constructor
  · intro sameRawZero
    have displayed : RatHistoryClassifier (BHist.e0 z) w :=
      RatHistoryClassifier_hsame_transport sameRawZero (hsame_refl w) rawClassified
  ...
  · intro sameTargetZero
    have displayed : RatHistoryClassifier rho (BHist.e0 z') :=
      RatHistoryClassifier_hsame_transport (hsame_refl rho) sameTargetZero rawClassified
