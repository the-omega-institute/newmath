...
theorem RegularCauchyApartnessBudgetCarrier_located_reciprocal_handoff [AskSetup]
    [PackageSetup]
                  ...
                  PkgSig bundle locatedRead pkg ->
                    SemanticNameCert
                      ...
                      UnaryHistory fieldRead ∧ UnaryHistory reciprocalRead ∧
                        UnaryHistory sharedRead ∧ UnaryHistory locatedRead := by
  ...
  intro carrier lowerRoute sealRoute fieldRoute reciprocalRoute sharedRoute locatedRoute
    locatedPkg
  ...
  have locatedUnary : UnaryHistory locatedRead :=
    unary_cont_closed sharedUnary nUnary locatedRoute
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row locatedRead ∧ UnaryHistory row)
          (fun row : BHist =>
            hsame row A ∨ hsame row M ∨ hsame row W ∨ hsame row D ∨ hsame row R ∨
              hsame row E ∨ hsame row H ∨ hsame row C ∨ hsame row P ∨ hsame row N ∨
                hsame row fieldRead ∨ hsame row reciprocalRead ∨
                  hsame row sharedRead ∨ hsame row locatedRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont D R lowerRead ∧ Cont lowerRead E sealRead ∧
              Cont sealRead C fieldRead ∧ Cont W D reciprocalRead ∧
                Cont fieldRead reciprocalRead sharedRead ∧
                  Cont sharedRead N locatedRead ∧ PkgSig bundle locatedRead pkg)
          hsame := {
    core := {
      carrier_inhabited :=
  ...
  exact ⟨cert, fieldUnary, reciprocalUnary, sharedUnary, locatedUnary⟩
