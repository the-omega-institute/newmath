...
theorem RegularCauchyApartnessBudgetCarrier_mature_consumer [AskSetup] [PackageSetup]
                        ...
                        (fun row : BHist =>
                          hsame row A ∨ hsame row D ∨ hsame row R ∨ hsame row E ∨
                            hsame row H ∨ hsame row C ∨ hsame row P ∨ hsame row N ∨
                              hsame row sharedRead ∨ hsame row matureRead)
                        (fun row : BHist =>
  ...
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row matureRead ∧ UnaryHistory row)
          (fun row : BHist =>
            hsame row A ∨ hsame row D ∨ hsame row R ∨ hsame row E ∨ hsame row H ∨
              hsame row C ∨ hsame row P ∨ hsame row N ∨ hsame row sharedRead ∨
  ...
  exact ⟨cert, sharedUnary, matureUnary⟩
