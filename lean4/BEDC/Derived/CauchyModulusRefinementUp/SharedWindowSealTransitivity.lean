...
theorem CauchyModulusRefinementCarrier_shared_window_seal_transitivity
    [AskSetup] [PackageSetup]
    {m0 m1 u v0 v1 v2 t w q e0 e1 e2 h0 h1 h2 c0 c1 c2 p0 p1 p2 n0 n1 n2
      public01 public12 public02 : BHist}
          ...
          hsame e0 e1 ->
            hsame e1 e2 ->
              Cont e0 e1 public01 ->
                Cont e1 e2 public12 ->
                  Cont e0 e2 public02 ->
                    hsame e0 e2 ∧ UnaryHistory public01 ∧ UnaryHistory public12 ∧
                      UnaryHistory public02 ∧ Cont e0 e1 public01 ∧
                        Cont e1 e2 public12 ∧ Cont e0 e2 public02 := by
  ...
  rcases carrier2 with
    ⟨_m0Unary2, _m1Unary2, _uUnary2, _v2Unary, _tUnary2, _wUnary2, _qUnary2, e2Unary,
      _h2Unary, _c2Unary, _p2Unary, _n2Unary, _m0m1u2, _uv2t, _twq2, _qe2h2,
      _p2Pkg, _h2n2⟩
  ...
  exact
    ⟨same02, public01Unary, public12Unary, public02Unary, publicRoute01, publicRoute12,
      publicRoute02⟩
