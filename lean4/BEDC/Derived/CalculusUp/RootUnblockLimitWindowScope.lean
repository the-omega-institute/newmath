...
theorem CalculusRootUnblockLimitWindowScope [AskSetup] [PackageSetup]
    {limitRow graphRow readbackRow toleranceRow realSeal transport replay provenance localName
      graphRead readbackRead toleranceRead sealRead structuralRead : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    UnaryHistory limitRow ->
          ...
          UnaryHistory toleranceRow ->
            UnaryHistory realSeal ->
              UnaryHistory transport ->
                UnaryHistory replay ->
                  Cont limitRow graphRow graphRead ->
                    Cont graphRead readbackRow readbackRead ->
                            ...
                            PkgSig bundle provenance pkg ->
                              PkgSig bundle localName pkg ->
                                SemanticNameCert
                                    ...
                                    (fun row : BHist =>
                                      hsame row limitRow ∨ hsame row graphRow ∨
                                        hsame row readbackRow ∨ hsame row toleranceRow ∨
                                          hsame row realSeal ∨ hsame row sealRead)
                                    (fun row : BHist =>
                                      UnaryHistory row ∧ Cont limitRow graphRow graphRead ∧
                                        Cont graphRead readbackRow readbackRead ∧
                                          Cont readbackRead toleranceRow toleranceRead ∧
                                            Cont toleranceRead realSeal sealRead ∧
                                              PkgSig bundle provenance pkg ∧
                                                PkgSig bundle localName pkg)
                                    hsame ∧
                                  UnaryHistory graphRead ∧
                                    UnaryHistory readbackRead ∧
                                      UnaryHistory toleranceRead ∧
                                        UnaryHistory sealRead ∧
                                          UnaryHistory structuralRead := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg Cont PkgSig hsame SemanticNameCert
  intro limitUnary graphUnary readbackUnary toleranceUnary realUnary transportUnary replayUnary
    graphRoute readbackRoute toleranceRoute sealRoute structuralRoute provenancePkg localNamePkg
  have graphReadUnary : UnaryHistory graphRead :=
    unary_cont_closed limitUnary graphUnary graphRoute
  ...
  · exact {
      ...
      ledger_sound := by
        intro _row source
        exact
          ⟨source.right, graphRoute, readbackRoute, toleranceRoute, sealRoute,
            provenancePkg, localNamePkg⟩
    }
  · exact
      ⟨graphReadUnary, readbackReadUnary, toleranceReadUnary, sealReadUnary,
        structuralReadUnary⟩
