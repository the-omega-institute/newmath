...
theorem CalculusContinuousMapLimitRoute [AskSetup] [PackageSetup]
    {E R D L _J _H C P N graphRead limitRead dyadicRead realRead namedRead : BHist}
                          ...
                          PkgSig bundle P pkg ->
                            PkgSig bundle N pkg ->
                              SemanticNameCert
                                  ...
                                  (fun row : BHist =>
                                    hsame row C ∨ hsame row L ∨ hsame row R ∨
  ...
  intro unaryC unaryL unaryR unaryD unaryE unaryN graphRoute limitRoute dyadicRoute
  ...
  have dyadicUnary : UnaryHistory dyadicRead :=
    unary_cont_closed limitUnary unaryD dyadicRoute
  have realUnary : UnaryHistory realRead :=
    unary_cont_closed dyadicUnary unaryE realRoute
  ...
  · exact {
      ...
      ledger_sound := by
        intro _row source
        exact
          ⟨source.right, graphRoute, limitRoute, dyadicRoute, realRoute, namedRoute,
