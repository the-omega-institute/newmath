...
theorem CalculusRootIntegralRegSeqRatHandoff [AskSetup] [PackageSetup]
    {C I Q Y R N P integralRead dyadicRead realRead namedRead : BHist}
                        ...
                        PkgSig bundle P pkg ->
                          PkgSig bundle namedRead pkg ->
                            SemanticNameCert
                                ...
                                (fun row : BHist =>
                                  hsame row C ∨ hsame row I ∨ hsame row Q ∨
