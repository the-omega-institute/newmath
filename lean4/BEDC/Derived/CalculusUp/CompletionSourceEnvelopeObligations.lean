...
theorem CalculusCompletionSourceEnvelopeObligations [AskSetup] [PackageSetup]
  ...
  intro rUnary lUnary cUnary dUnary iUnary qUnary yUnary nUnary derivativeRoute
      ...
      ledger_sound := by
        ...
        exact
          ⟨source.right, derivativeRoute, integralRoute, limitRoute, dyadicRoute,
            realRoute, publicRoute, provenancePkg, publicPkg⟩
    }
  · exact
