...
theorem HyperspaceHausdorffObligationSurface [AskSetup] [PackageSetup]
                        ...
                        hsame row X ∨ hsame row K0 ∨ hsame row K1 ∨ hsame row N0 ∨
                          hsame row N1 ∨ hsame row D0 ∨ hsame row D1 ∨
                            hsame row R ∨ hsame row Hs ∨ hsame row C ∨
                              hsame row P ∨ hsame row M ∨ hsame row subsetRead ∨
                                hsame row netRead ∨ hsame row distanceRead ∨
                                  hsame row publicRead ∨ hsame row replayRead)
                      (fun row : BHist =>
  ...
  intro carrier subsetRoute netRoute distanceRoute publicRoute replayRoute publicPkg
  ...
  have sourcePublic :
      (fun row : BHist => (hsame row publicRead ∨ hsame row replayRead) ∧
        UnaryHistory row) publicRead := by
    exact ⟨Or.inl (hsame_refl publicRead), publicUnary⟩
  have cert :
      SemanticNameCert
          (fun row : BHist =>
            (hsame row publicRead ∨ hsame row replayRead) ∧ UnaryHistory row)
          (fun row : BHist =>
            hsame row X ∨ hsame row K0 ∨ hsame row K1 ∨ hsame row N0 ∨
  ...
  exact ⟨cert, subsetUnary, netUnary, distanceUnary, publicUnary, replayUnary⟩
