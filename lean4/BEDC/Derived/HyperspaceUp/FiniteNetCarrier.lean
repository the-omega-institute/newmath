  ...
  UnaryHistory X ∧ UnaryHistory K0 ∧ UnaryHistory K1 ∧ UnaryHistory N0 ∧
    UnaryHistory N1 ∧ UnaryHistory D0 ∧ UnaryHistory D1 ∧ UnaryHistory R ∧
      UnaryHistory Hs ∧ UnaryHistory C ∧ UnaryHistory P ∧ UnaryHistory M ∧
        Cont X K0 N0 ∧ Cont X K1 N1 ∧ Cont N0 N1 D0 ∧ Cont D0 D1 R ∧
          PkgSig bundle P pkg
...
theorem HyperspaceFiniteNetCarrier_closed_rows [AskSetup] [PackageSetup]
  ...
  obtain ⟨_xUnary, _k0Unary, _k1Unary, n0Unary, n1Unary, d0Unary, _d1Unary,
    rUnary, _hsUnary, _cUnary, _pUnary, _mUnary, sourceLeftRoute,
    sourceRightRoute, directedRoute, toleranceRoute, provenancePkg⟩ := carrier
  exact
    ⟨n0Unary, n1Unary, d0Unary, rUnary, sourceLeftRoute, sourceRightRoute,
      directedRoute, toleranceRoute, provenancePkg⟩
