...
theorem HyperspaceFiniteVietorisCarrier [AskSetup] [PackageSetup]
    {X K0 K1 N0 N1 D0 D1 R Hs C P M subsetRead netRead distanceRead publicRead :
      BHist}
              ...
              PkgSig bundle publicRead pkg ->
                SemanticNameCert
                  ...
                  UnaryHistory subsetRead ∧ UnaryHistory netRead ∧
                    UnaryHistory distanceRead ∧ UnaryHistory publicRead := by
  ...
  exact ⟨cert, subsetUnary, netUnary, distanceUnary, publicUnary⟩
