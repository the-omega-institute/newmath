...
theorem FiniteCauchyGluingBudgetCarrier_consumer_route_scope [AskSetup] [PackageSetup]
                            ...
                            Cont R N publicRead ->
                              PkgSig bundle publicRead pkg ->
                                SemanticNameCert
                                    ...
                                    (fun row : BHist =>
                                      hsame row G ∨ hsame row L ∨ hsame row T ∨
                                        hsame row S ∨ hsame row K ∨ hsame row U ∨
