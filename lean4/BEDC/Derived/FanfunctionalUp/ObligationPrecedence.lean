...
theorem FanFunctionalBarDepthWitnessWindowPrecedence [AskSetup] [PackageSetup]
          ...
          Cont witnessRead modulus modulusRead →
            PkgSig bundle modulusRead pkg →
              SemanticNameCert
                  ...
                  (fun row : BHist =>
                    hsame row fan ∨ hsame row depth ∨ hsame row witness ∨
                      hsame row depthRead ∨ hsame row witnessRead ∨ hsame row modulus ∨
                        hsame row modulusRead)
                  (fun row : BHist =>
                    UnaryHistory row ∧ Cont fan depth depthRead ∧
                      Cont depthRead witness witnessRead ∧
                        Cont witnessRead modulus modulusRead ∧
  ...
  intro carrier fanDepthRead depthWitnessRead witnessModulusRead modulusPkg
  ...
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row modulusRead ∧ UnaryHistory row)
          (fun row : BHist =>
            hsame row fan ∨ hsame row depth ∨ hsame row witness ∨ hsame row depthRead ∨
              hsame row witnessRead ∨ hsame row modulus ∨ hsame row modulusRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont fan depth depthRead ∧
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, fanDepthRead, depthWitnessRead, witnessModulusRead,
          provenancePkg, modulusPkg⟩
  }
