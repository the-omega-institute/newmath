...
theorem FanFunctionalScopedConsumerRoute [AskSetup] [PackageSetup]
                  ...
                  SemanticNameCert
                    ...
                    (fun row : BHist =>
                      hsame row C ∨ hsame row F ∨ hsame row eps ∨ hsame row B ∨
                        hsame row D ∨ hsame row W ∨ hsame row M ∨ hsame row H ∨
                    ...
                    (fun row : BHist =>
                      UnaryHistory row ∧ Cont C F prefixRead ∧
                        Cont prefixRead B barRead ∧ Cont barRead W compactRead ∧
                          Cont compactRead M modulusRead ∧ PkgSig bundle P pkg ∧
                            PkgSig bundle N pkg)
                    hsame ∧ UnaryHistory modulusRead := by
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, prefixRoute, barRoute, compactRoute, modulusRoute, provenancePkg,
          namePkg⟩
  }
