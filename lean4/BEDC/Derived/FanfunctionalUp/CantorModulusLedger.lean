...
theorem FanFunctionalCantorModulusLedger [AskSetup] [PackageSetup]
                    ...
                    SemanticNameCert
                        ...
                        (fun row : BHist =>
                          hsame row C ∨ hsame row F ∨ hsame row B ∨ hsame row D ∨
                            hsame row W ∨ hsame row M ∨ hsame row N ∨ hsame row named)
                        (fun row : BHist =>
                          UnaryHistory row ∧ Cont C B prefixRead ∧ Cont F D depthRead ∧
                            Cont prefixRead W witnessRead ∧ Cont witnessRead M modulusRead ∧
  ...
  intro carrier prefixRoute depthRoute witnessRoute modulusRoute namedRoute provenancePkg
    namedPkg
  ...
  have _depthUnary : UnaryHistory depthRead :=
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, prefixRoute, depthRoute, witnessRoute, modulusRoute, namedRoute,
