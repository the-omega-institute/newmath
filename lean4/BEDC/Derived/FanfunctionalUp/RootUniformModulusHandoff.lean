...
theorem FanFunctionalRootUniformModulusHandoff [AskSetup] [PackageSetup]
    {cantor fan tolerance branch depth witness modulus transport replay provenance
      localName compactRead uniformRead modulusRead : BHist}
            ...
            PkgSig bundle modulusRead pkg ->
              SemanticNameCert
                ...
                UnaryHistory compactRead ∧ UnaryHistory uniformRead ∧
                  UnaryHistory modulusRead ∧ PkgSig bundle provenance pkg := by
  -- BEDC touchpoint anchor: BHist Cont ProbeBundle PkgSig SemanticNameCert hsame UnaryHistory
  intro carrier cantorFanCompact compactToleranceUniform witnessModulusRead modulusPkg
  ...
  exact ⟨cert, compactUnary, uniformUnary, modulusReadUnary, provenancePkg⟩
