...
theorem FinitePrefixStreamCarrier_regular_cauchy_reindex_handoff [AskSetup] [PackageSetup]
    {k W D R H C P N j m sourceCut cutDyadic cutRegular replay completionRead : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    FinitePrefixStreamCarrier k W D R H C P N ->
      UnaryHistory j ->
        UnaryHistory m ->
                      ...
                      PkgSig bundle N pkg ->
                        PkgSig bundle completionRead pkg ->
                          SemanticNameCert
                              ...
                              (fun row : BHist =>
                                hsame row k ∨ hsame row W ∨ hsame row D ∨
                                  hsame row R ∨ hsame row H ∨ hsame row C ∨
                                    hsame row P ∨ hsame row N ∨ hsame row j ∨
                                      hsame row m ∨ hsame row sourceCut ∨
                                        hsame row cutDyadic ∨ hsame row cutRegular ∨
                                          hsame row replay ∨ hsame row completionRead)
                              (fun row : BHist =>
                                UnaryHistory row ∧ Cont j W sourceCut ∧
                                  Cont sourceCut D cutDyadic ∧
                                    Cont cutDyadic R cutRegular ∧
  ...
  -- BEDC touchpoint anchor: BHist Cont ProbeBundle Pkg PkgSig hsame SemanticNameCert
  intro carrier jUnary _mUnary sourceRoute dyadicRoute regularRoute replayRoute
    completionRoute _pPkg _nPkg completionPkg
  obtain
    ⟨_kUnary, wUnary, dUnary, rUnary, cUnary, _nUnary, _sameH, _routeH, _routeP,
      _packetRegularRoute⟩ := carrier
  have sourceUnary : UnaryHistory sourceCut :=
  ...
  have completionUnary : UnaryHistory completionRead :=
    unary_cont_closed replayUnary rUnary completionRoute
  ...
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont j W sourceCut ∧ Cont sourceCut D cutDyadic ∧
              Cont cutDyadic R cutRegular ∧ Cont cutRegular C replay ∧
                Cont replay R completionRead ∧ PkgSig bundle completionRead pkg)
          hsame := {
    core := {
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, sourceRoute, dyadicRoute, regularRoute, replayRoute,
