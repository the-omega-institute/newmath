...
theorem ParsevalInnerProductNameCertObligations [AskSetup] [PackageSetup]
              ...
              SemanticNameCert
                  ...
                  (fun row : BHist =>
                    hsame row fourier ∨ hsame row source ∨ hsame row pairing ∨
                      hsame row integral ∨ hsame row comparisonRead ∨ hsame row namedRead)
  ...
  intro carrier comparisonRoute namedRoute _comparisonPkg namedPkg
  obtain ⟨_fourierUnary, _sourceUnary, pairingUnary, integralUnary, _readbackUnary,
    _toleranceUnary, _sealUnary, _transportUnary, _replayUnary, _provenanceUnary, nameUnary,
  ...
  have comparisonUnary : UnaryHistory comparisonRead :=
    unary_cont_closed pairingUnary integralUnary comparisonRoute
  have namedUnary : UnaryHistory namedRead :=
    unary_cont_closed comparisonUnary nameUnary namedRoute
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row namedRead ∧ UnaryHistory row)
          (fun row : BHist =>
  ...
  exact ⟨cert, comparisonUnary, namedUnary⟩
