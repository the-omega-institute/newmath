...
theorem DiagonalLimitBudgetSealHandoff (x : DiagonalLimitBudgetUp) :
        ...
        Cont D M (append D M) ∧
          Cont M W (append M W) ∧
            Cont W Q (append W Q) ∧
              Cont Q E (append Q E) ∧
                SemanticNameCert
                  (fun row : BHist => hsame row (append Q E))
                  (fun row : BHist =>
                    hsame row D ∨ hsame row M ∨ hsame row W ∨ hsame row Q ∨
                      hsame row E ∨ hsame row C ∨ hsame row P ∨ hsame row N ∨
                        hsame row (append Q E))
                  (fun row : BHist =>
                    hsame row (append Q E) ∧ Cont D M (append D M) ∧
                      Cont M W (append M W) ∧ Cont W Q (append W Q) ∧
                        Cont Q E (append Q E))
                  hsame := by
  -- BEDC touchpoint anchor: BHist Cont append hsame SemanticNameCert NameCert
  cases x with
