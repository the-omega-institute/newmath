...
theorem FiniteSelectionSequenceCarrier_namecert_obligations
  ...
  intro wUnary dUnary rUnary _tUnary cUnary thresholdRoute readbackRoute sealRoute
  ...
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont W D thresholdRead ∧ Cont thresholdRead R readbackRead ∧
              Cont readbackRead C sealRead)
          hsame := {
    core := {
