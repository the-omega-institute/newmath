...
theorem HypercoverCarrier_sheaf_descent_handoff [AskSetup] [PackageSetup]
    {J U M C S D T R P N coverRead matchingRead descentRead sheafRead
      namedRead : BHist}
                                  ...
                                  SemanticNameCert
                                      ...
                                      (fun row : BHist =>
                                        UnaryHistory row ∧ Cont J U coverRead ∧
                                          Cont coverRead M matchingRead ∧ Cont C S D ∧
                                            Cont matchingRead S sheafRead ∧
                                              Cont sheafRead D descentRead ∧
                                                Cont descentRead T R ∧
                                                  Cont R P namedRead ∧
                                                    PkgSig bundle N pkg)
                                      hsame ∧ UnaryHistory coverRead ∧
                                    UnaryHistory matchingRead ∧ UnaryHistory sheafRead ∧
                                      UnaryHistory descentRead ∧ UnaryHistory R ∧
                                        UnaryHistory namedRead := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg Cont PkgSig hsame SemanticNameCert UnaryHistory
  intro jUnary uUnary mUnary sUnary dUnary tUnary pUnary _nUnary coverRoute matchingRoute
    descentGate sheafRoute descentRoute replayRoute namedRoute namePkg
  ...
  have sheafUnary : UnaryHistory sheafRead :=
    unary_cont_closed matchingUnary sUnary sheafRoute
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, coverRoute, matchingRoute, descentGate, sheafRoute,
          descentRoute, replayRoute, namedRoute, namePkg⟩
  }
  exact
    ⟨cert, coverUnary, matchingUnary, sheafUnary, descentUnary, replayUnary,
      namedUnary⟩
