...
theorem KernelInductiveAcceptanceFieldFaithfulBoundary [AskSetup] [PackageSetup]
    {declaration signatures eliminators positivity recursion transport routes provenance
      nameCert signatureRead eliminatorRead envRead : BHist}
              ...
              UnaryHistory signatures →
                UnaryHistory eliminators →
                  UnaryHistory recursion →
                    hsame declaration declaration ∧ hsame signatures signatures ∧
                      hsame eliminators eliminators ∧ UnaryHistory signatureRead ∧
                        UnaryHistory eliminatorRead ∧ UnaryHistory envRead ∧
  ...
  intro declarationSignaturesRead signaturesEliminatorsRead eliminatorsRecursionRead
    _envPkg declarationUnary signaturesUnary eliminatorsUnary recursionUnary
        ...
        (List.mem_cons_of_mem _
          (List.mem_cons_of_mem _
            (List.mem_cons_of_mem _
              (List.mem_cons_of_mem _ List.mem_cons_self))))
  exact
    ⟨hsame_refl declaration, hsame_refl signatures, hsame_refl eliminators,
      signatureUnary, eliminatorUnary, envUnary, signaturesListed, eliminatorsListed⟩
