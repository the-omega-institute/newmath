...
theorem SetlikeLedgerScopeClosure [AskSetup] [PackageSetup] (S : SetlikeUp)
  ...
  intro fields mUnary qUnary iUnary rUnary eUnary hUnary cUnary nUnary membershipRoute
    subsetRoute comprehensionRoute extensionalRoute transportRoute replayRoute namedRoute
    packageRead
  ...
  have comprehensionUnary : UnaryHistory comprehensionRead :=
    unary_cont_closed subsetUnary rUnary comprehensionRoute
  have extensionalUnary : UnaryHistory extensionalRead :=
    unary_cont_closed comprehensionUnary eUnary extensionalRoute
  ...
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont M Q membershipRead ∧ Cont membershipRead I subsetRead ∧
              Cont subsetRead R comprehensionRead ∧ Cont comprehensionRead E extensionalRead ∧
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, membershipRoute, subsetRoute, comprehensionRoute,
