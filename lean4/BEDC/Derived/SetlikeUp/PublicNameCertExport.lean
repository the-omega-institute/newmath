...
theorem SetlikePublicNameCertExport [AskSetup] [PackageSetup] (S : SetlikeUp)
    {M Q I R E H C P N membershipRead subsetRead comprehensionRead extensionalRead routeRead
      transportRead replayRead provenanceRead publicRead : BHist}
                                  ...
                                  Cont routeRead H transportRead ->
                                    Cont transportRead C replayRead ->
                                      Cont replayRead P provenanceRead ->
                                        Cont provenanceRead N publicRead ->
                                          PkgSig bundle P pkg ->
                                            SemanticNameCert
                                                (fun row : BHist =>
                                                      ...
                                                      Cont Q I subsetRead ∧
                                                        Cont R E comprehensionRead ∧
                                                          Cont membershipRead subsetRead
                                                            extensionalRead ∧
                                                            Cont extensionalRead
                                                              comprehensionRead routeRead ∧
                                                              Cont routeRead H
                                                                transportRead ∧
  ...
  intro fields rowsM rowsQ rowsI rowsR rowsE rowsH rowsC rowsP rowsN membershipRoute
    subsetRoute comprehensionRoute extensionalRoute routeRoute transportRoute replayRoute
    provenanceRoute publicRoute packageRead
  ...
  have transportUnary : UnaryHistory transportRead :=
    unary_cont_closed routeUnary rowsH transportRoute
  ...
  have publicUnary : UnaryHistory publicRead :=
    unary_cont_closed provenanceUnary rowsN publicRoute
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont M Q membershipRead ∧ Cont Q I subsetRead ∧
              Cont R E comprehensionRead ∧ Cont membershipRead subsetRead extensionalRead ∧
                Cont extensionalRead comprehensionRead routeRead ∧
                  Cont routeRead H transportRead ∧ Cont transportRead C replayRead ∧
                    Cont replayRead P provenanceRead ∧ Cont provenanceRead N publicRead ∧
                      PkgSig bundle P pkg)
          hsame := {
    core := {
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, membershipRoute, subsetRoute, comprehensionRoute, extensionalRoute,
          routeRoute, transportRoute, replayRoute, provenanceRoute, publicRoute, packageRead⟩
  }
  exact
    ⟨cert, membershipUnary, subsetUnary, comprehensionUnary, extensionalUnary, routeUnary,
      transportUnary, replayUnary, provenanceUnary, publicUnary⟩
