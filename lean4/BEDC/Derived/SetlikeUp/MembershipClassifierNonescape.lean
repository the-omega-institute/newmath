...
theorem SetlikeMembershipClassifierNonescape [AskSetup] [PackageSetup] (S : SetlikeUp)
  ...
  intro fields rowsM rowsQ rowsI rowsR rowsE rowsH rowsC rowsP rowsN membershipRoute
    subsetRoute comprehensionRoute transportRoute replayRoute provenanceRoute namedRoute packageRead
  ...
  exact
    ⟨cert, membershipUnary, subsetUnary, comprehensionUnary, transportUnary, replayUnary,
