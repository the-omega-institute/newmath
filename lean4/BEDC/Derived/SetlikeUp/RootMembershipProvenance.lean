...
theorem SetlikeRootMembershipProvenanceExhaustion [AskSetup] [PackageSetup] (S : SetlikeUp)
  ...
  intro fields rowsM rowsQ rowsI rowsR rowsE rowsP rowsN membershipRoute subsetRoute
    comprehensionRoute extensionalRoute provenanceRoute namedRoute packageRead
  ...
  exact
    ⟨cert, membershipUnary, subsetUnary, comprehensionUnary, extensionalUnary, provenanceUnary,
      namedUnary⟩
