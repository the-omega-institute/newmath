...
theorem SetlikeSubsetLedgerObligation [AskSetup] [PackageSetup] (S : SetlikeUp)
    {M Q I R E H C P N subsetRead comprehensionRead ledgerRead namedRead : BHist}
                  ...
                  UnaryHistory N ->
                    Cont M Q subsetRead ->
                      Cont subsetRead I comprehensionRead ->
                        Cont comprehensionRead R ledgerRead ->
                          Cont ledgerRead N namedRead ->
                            PkgSig bundle P pkg ->
                              SemanticNameCert
                                  ...
                                  hsame ∧
                                UnaryHistory subsetRead ∧ UnaryHistory comprehensionRead ∧
  ...
  intro fields mUnary qUnary iUnary rUnary _hUnary _cUnary nUnary subsetRoute
    comprehensionRoute ledgerRoute namedRoute provenancePkg
  ...
  have comprehensionUnary : UnaryHistory comprehensionRead :=
    unary_cont_closed subsetUnary iUnary comprehensionRoute
  have ledgerUnary : UnaryHistory ledgerRead :=
    unary_cont_closed comprehensionUnary rUnary ledgerRoute
  ...
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont M Q subsetRead ∧
              Cont subsetRead I comprehensionRead ∧ Cont comprehensionRead R ledgerRead ∧
                Cont ledgerRead N namedRead ∧ PkgSig bundle P pkg)
          hsame := {
    core := {
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, subsetRoute, comprehensionRoute, ledgerRoute, namedRoute,
          provenancePkg⟩
  }
  exact ⟨cert, subsetUnary, comprehensionUnary, ledgerUnary, namedUnary⟩
