...
theorem SetlikeKernelMembershipSourceTotality [AskSetup] [PackageSetup] (S : SetlikeUp)
  ...
  intro fields rowsM rowsQ rowsH rowsC rowsN membershipRoute transportedRoute replayRoute
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, membershipRoute, transportedRoute, replayRoute, namedRoute,
          packageRead⟩
  }
