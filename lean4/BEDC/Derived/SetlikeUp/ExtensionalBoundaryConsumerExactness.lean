...
theorem SetlikeExtensionalBoundaryConsumerExactness [AskSetup] [PackageSetup] (S : SetlikeUp)
    {M Q I R E H C P N membershipRead subsetRead comprehensionRead boundaryRead
      firstOrderRead modelRead namedRead : BHist}
                      ...
                      Cont M Q membershipRead ->
                        Cont Q I subsetRead ->
                          Cont R E comprehensionRead ->
                            Cont membershipRead subsetRead boundaryRead ->
                              Cont boundaryRead H firstOrderRead ->
  ...
  intro fields rowsM rowsQ rowsI rowsR rowsE rowsH rowsC rowsN membershipRoute
    subsetRoute comprehensionRoute boundaryRoute firstOrderRoute modelRoute namedRoute
    packageRead
  ...
  have boundaryUnary : UnaryHistory boundaryRead :=
    unary_cont_closed membershipUnary subsetUnary boundaryRoute
  have firstOrderUnary : UnaryHistory firstOrderRead :=
    unary_cont_closed boundaryUnary rowsH firstOrderRoute
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont M Q membershipRead ∧ Cont Q I subsetRead ∧
              Cont R E comprehensionRead ∧ Cont membershipRead subsetRead boundaryRead ∧
                Cont boundaryRead H firstOrderRead ∧ Cont firstOrderRead C modelRead ∧
                  Cont modelRead N namedRead ∧ PkgSig bundle P pkg)
          hsame := {
    core := {
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, membershipRoute, subsetRoute, comprehensionRoute, boundaryRoute,
          firstOrderRoute, modelRoute, namedRoute, packageRead⟩
  }
