...
theorem SetlikeRootUnblockFirstOrderSignature [AskSetup] [PackageSetup] (S : SetlikeUp)
    {M Q I R E H C P N membershipRead subsetRead comprehensionRead extensionalRead
      signatureRead namedRead : BHist}
                      ...
                      Cont Q I subsetRead ->
                        Cont R E comprehensionRead ->
                          Cont membershipRead subsetRead extensionalRead ->
                            Cont extensionalRead H signatureRead ->
                              Cont signatureRead N namedRead ->
                                PkgSig bundle P pkg ->
                                  SemanticNameCert
                                      (fun row : BHist =>
  ...
  intro fields rowsM rowsQ rowsI rowsR rowsE rowsH rowsN membershipRoute subsetRoute
    comprehensionRoute extensionalRoute signatureRoute namedRoute packageRead
  ...
  have signatureUnary : UnaryHistory signatureRead :=
    unary_cont_closed extensionalUnary rowsH signatureRoute
  have namedUnary : UnaryHistory namedRead :=
    unary_cont_closed signatureUnary rowsN namedRoute
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row namedRead ∧ UnaryHistory row)
          (fun row : BHist =>
            hsame row M ∨ hsame row Q ∨ hsame row I ∨ hsame row R ∨ hsame row E ∨
              hsame row H ∨ hsame row signatureRead ∨ hsame row namedRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont M Q membershipRead ∧ Cont Q I subsetRead ∧
              Cont R E comprehensionRead ∧ Cont membershipRead subsetRead extensionalRead ∧
                Cont extensionalRead H signatureRead ∧ Cont signatureRead N namedRead ∧
                  PkgSig bundle P pkg)
          hsame := {
    core := {
