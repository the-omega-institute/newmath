...
theorem LargeModelCorpusSupplyAuditNonescape [AskSetup] [PackageSetup]
                          ...
                          PkgSig bundle P pkg →
                            PkgSig bundle N pkg →
                              SemanticNameCert
                                  ...
                                  hsame ∧ UnaryHistory auditRead ∧
                                UnaryHistory namedRead := by
  -- BEDC touchpoint anchor: BHist Cont ProbeBundle PkgSig SemanticNameCert hsame UnaryHistory
  intro rUnary fUnary wUnary iUnary aUnary kUnary sourceRoute weightRoute inferenceRoute
    auditRoute namedRoute provenancePkg namePkg
  ...
  exact ⟨cert, auditUnary, namedUnary⟩
