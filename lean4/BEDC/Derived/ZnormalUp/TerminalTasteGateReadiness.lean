...
theorem ZnormalPacket_terminal_tastegate_readiness [AskSetup] [PackageSetup]
  ...
  exact
    ⟨zNormalChapterTasteGate, rfl, terminalUnary, normalUnary, fieldReadUnary,
      terminalNormalFieldRead, provenancePkg, fieldReadPkg⟩
