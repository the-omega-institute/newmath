...
theorem ZnormalNamecertLedgerExhaustion [AskSetup] [PackageSetup]
        ...
        PkgSig bundle ledgerRead pkg →
          SemanticNameCert
            ...
            UnaryHistory provenance ∧ UnaryHistory name ∧ UnaryHistory ledgerRead ∧
              Cont provenance name ledgerRead ∧ PkgSig bundle provenance pkg ∧
                PkgSig bundle name pkg ∧ PkgSig bundle ledgerRead pkg := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg Cont hsame SemanticNameCert UnaryHistory
  intro packet provenanceNameLedger ledgerPkg
  ...
  exact
    ⟨cert, provenanceUnary, nameUnary, ledgerUnary, provenanceNameLedger, provenancePkg,
      namePkg, ledgerPkg⟩
