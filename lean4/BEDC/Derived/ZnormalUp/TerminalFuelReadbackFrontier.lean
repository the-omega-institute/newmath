...
theorem ZnormalPacket_terminal_fuel_readback_frontier [AskSetup] [PackageSetup]
            ...
            SemanticNameCert
                ...
                (fun row : BHist =>
                  hsame row typed ∨ hsame row fuel ∨ hsame row terminalRead ∨
                    hsame row normal ∨ hsame row continuationRead)
                (fun row : BHist =>
  ...
  exact ⟨cert, terminalReadSame, terminalReadUnary, continuationReadUnary⟩
