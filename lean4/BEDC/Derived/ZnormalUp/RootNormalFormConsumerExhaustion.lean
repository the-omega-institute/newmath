...
theorem ZnormalPacket_root_normal_form_consumer_exhaustion [AskSetup] [PackageSetup]
              ...
              SemanticNameCert
                ...
                UnaryHistory normalRead ∧ UnaryHistory downstream ∧ UnaryHistory consumer ∧
                  Cont normal continuation normalRead ∧ Cont normalRead transports downstream ∧
                    Cont downstream routes consumer ∧ PkgSig bundle consumer pkg := by
  ...
  exact
    ⟨cert, normalReadUnary, downstreamUnary, consumerUnary, normalContinuationRead,
