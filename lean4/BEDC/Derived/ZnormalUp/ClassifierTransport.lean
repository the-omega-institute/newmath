...
theorem ZnormalPacket_classifier_transport [AskSetup] [PackageSetup]
    {typed fuel terminal normal continuation transports routes provenance name typed' fuel'
      terminal' normal' continuation' transports' routes' provenance' name' normalRead
      normalRead' : BHist}
  ...
  intro packet sameTyped sameFuel sameTerminal sameNormal sameContinuation sameTransports
    ...
    continuationTransportsRoutes' namePkg' provenancePkg' normalReadRoute
    normalReadRoute'
  have normalReadStable : hsame normalRead normalRead' :=
    cont_respects_hsame sameNormal sameContinuation normalReadRoute normalReadRoute'
  ...
  exact ⟨normalReadStable, transportedPacket⟩
