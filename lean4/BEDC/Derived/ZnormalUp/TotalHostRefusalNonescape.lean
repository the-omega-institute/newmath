...
theorem ZnormalTotalHostRefusalNonescape [AskSetup] [PackageSetup]
            ...
            PkgSig bundle downstream pkg →
              SemanticNameCert
                ...
                hsame terminalRead terminal ∧ hsame rootRead continuation ∧
                  UnaryHistory terminalRead ∧ UnaryHistory rootRead ∧ UnaryHistory downstream ∧
  ...
  have cert :
      SemanticNameCert
          ...
          hsame := {
    core := {
      carrier_inhabited := Exists.intro downstream
  ...
  exact
    ⟨cert, terminalReadSame, rootReadSame, terminalReadUnary, rootReadUnary, downstreamUnary,
