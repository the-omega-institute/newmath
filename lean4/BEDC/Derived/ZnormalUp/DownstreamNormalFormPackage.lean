...
theorem ZnormalDownstreamNormalFormPackage [AskSetup] [PackageSetup]
              ...
              PkgSig bundle consumer pkg →
                SemanticNameCert
                  ...
                  UnaryHistory terminalRead ∧ UnaryHistory normalRead ∧
                    UnaryHistory downstream ∧ UnaryHistory consumer := by
  ...
  exact ⟨cert, terminalReadUnary, normalReadUnary, downstreamUnary, consumerUnary⟩
