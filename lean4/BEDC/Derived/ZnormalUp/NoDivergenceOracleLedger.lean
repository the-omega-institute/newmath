...
theorem ZnormalPacket_no_divergence_oracle_ledger [AskSetup] [PackageSetup]
            ...
            SemanticNameCert
                ...
                (fun row : BHist =>
                  hsame row typed ∨ hsame row fuel ∨ hsame row terminal ∨
                    hsame row normal ∨ hsame row refusal ∨ hsame row readback)
  ...
  exact ⟨cert, refusalUnary, readbackUnary⟩
