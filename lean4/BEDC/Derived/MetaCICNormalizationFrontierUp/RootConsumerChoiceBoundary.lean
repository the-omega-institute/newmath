...
theorem MetaCICNormalizationFrontierCarrier_root_consumer_choice_boundary
    [AskSetup] [PackageSetup]
    {candidate closedCandidate finished endpoint obstruction transport replay provenance
      localRow candidateRead endpointRead obstructionRoute publicRead : BHist}
              ...
              PkgSig bundle publicRead pkg ->
                SemanticNameCert
                  ...
                  UnaryHistory candidateRead ∧ UnaryHistory endpointRead ∧
                    UnaryHistory obstructionRoute ∧ UnaryHistory publicRead := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg SemanticNameCert hsame Cont
  intro carrier candidateClosedRead endpointReplayRead obstructionReplayRoute
    candidateEndpointPublic publicPkg
  ...
  exact
    ⟨cert, candidateReadUnary, endpointReadUnary, obstructionRouteUnary,
      publicReadUnary⟩
