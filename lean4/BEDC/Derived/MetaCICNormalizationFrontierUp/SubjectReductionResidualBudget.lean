...
theorem MetaCICNormalizationFrontierSubjectReductionResidualBudget [AskSetup] [PackageSetup]
        ...
        PkgSig bundle residualRead pkg →
          UnaryHistory residualRead ∧ hsame obstruction obstruction ∧
            SemanticNameCert
              ...
              (fun row : BHist =>
                hsame row obstruction ∨ hsame row normalRead ∨ hsame row candidateRead ∨
