...
theorem MetaCICNormalizationFrontierCarrier_root_obstruction_route_separation
  ...
  exact
    ⟨candidateReadUnary, endpointReadUnary, obstructionReadUnary, publicReadUnary,
