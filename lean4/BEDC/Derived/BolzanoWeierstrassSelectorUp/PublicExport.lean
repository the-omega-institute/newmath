...
theorem BolzanoWeierstrassSelectorRegularCauchyExtractionRoute
    {B M Q W D R E H C P N selectedRead dyadicRead regularRead realSeal
      extractionRead : BHist} :
    Cont B M selectedRead ->
      Cont selectedRead Q W ->
        Cont W D dyadicRead ->
          Cont dyadicRead R regularRead ->
            Cont regularRead E realSeal ->
              Cont realSeal P extractionRead ->
                UnaryHistory B ->
                  UnaryHistory M ->
                    UnaryHistory Q ->
                      UnaryHistory D ->
                              ...
                              bolzanoWeierstrassSelectorFields
                                ...
                                UnaryHistory W ∧ UnaryHistory dyadicRead ∧
                                  UnaryHistory regularRead ∧ UnaryHistory realSeal ∧
                                    UnaryHistory extractionRead ∧ Cont selectedRead Q W ∧
                                      Cont W D dyadicRead ∧ Cont dyadicRead R regularRead ∧
                                        Cont regularRead E realSeal ∧
                                          Cont realSeal P extractionRead := by
  -- BEDC touchpoint anchor: BHist Cont UnaryHistory
  intro selectedRoute windowRoute dyadicRoute regularRoute sealRoute extractionRoute bUnary
    mUnary qUnary dUnary rUnary eUnary pUnary
  ...
  have extractionUnary : UnaryHistory extractionRead :=
    unary_cont_closed sealUnary pUnary extractionRoute
  exact
    ⟨rfl, windowUnary, dyadicUnary, regularUnary, sealUnary, extractionUnary, windowRoute,
      dyadicRoute, regularRoute, sealRoute, extractionRoute⟩
