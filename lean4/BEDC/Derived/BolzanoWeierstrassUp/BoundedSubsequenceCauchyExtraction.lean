...
theorem BolzanoWeierstrassCarrier_bounded_subsequence_cauchy_extraction
            ...
            Cont readbackWindow E clusterSeal →
              PkgSig bundle clusterSeal pkg →
                UnaryHistory S ∧ UnaryHistory K ∧ UnaryHistory R ∧ UnaryHistory Q ∧
                  UnaryHistory E ∧ UnaryHistory retainedCell ∧
                    UnaryHistory selectedWindow ∧ UnaryHistory readbackWindow ∧
                      UnaryHistory clusterSeal ∧ Cont K R retainedCell ∧
                        Cont retainedCell R selectedWindow ∧
                          Cont selectedWindow Q readbackWindow ∧
  ...
  exact
    ⟨SUnary, KUnary, RUnary, QUnary, EUnary, retainedUnary, selectedUnary,
      readbackUnary, clusterUnary, retainedRoute, selectedRoute, readbackRoute,
