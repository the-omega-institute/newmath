...
theorem ContinuationMonadCarrier_root_public_consumer_totality
  ...
  exact
    ⟨unaryA, unaryB, unaryC, unaryF, unaryG, unaryU, unaryK, unaryL, unaryN,
      ...
      unitRoute, bindRoute, publicRoute, consumerRoute, sameEndpoint, consumerPkg⟩

theorem ContinuationMonadCarrier_root_kleisli_formal_target_package
    [AskSetup] [PackageSetup]
