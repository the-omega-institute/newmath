...
theorem ContinuationMonadCarrier_root_source_triad_exactness [AskSetup] [PackageSetup]
                        ...
                        Cont category N generator ∧ Cont L generator publicRead ∧
                          hsame N L ∧ PkgSig bundle publicRead pkg ∧
                            SemanticNameCert
                              ...
                              (fun row : BHist =>
                                Cont L generator row ∧ Cont L N category ∧
                                  Cont category N generator)
                              (fun row : BHist =>
  ...
  have cert :
      SemanticNameCert
        (fun row : BHist => hsame row publicRead ∧ UnaryHistory row)
        (fun row : BHist =>
          Cont L generator row ∧ Cont L N category ∧ Cont category N generator)
