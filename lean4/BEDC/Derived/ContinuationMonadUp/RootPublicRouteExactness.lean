...
theorem ContinuationMonadCarrier_root_public_route_exactness [AskSetup] [PackageSetup]
  ...
  have cert :
      SemanticNameCert
        ...
        (fun row : BHist =>
          Cont generator unitRead row ∧ Cont L N category ∧ Cont category K generator)
