...
theorem ContinuationMonadCarrier_bridge_package [AskSetup] [PackageSetup]
  ...
  exact
    ⟨unaryA, unaryB, unaryC, unaryF, unaryG, unaryU, unaryK, unaryL, unaryUnitRead,
      unaryBindRead, routeB, routeC, routeK, routeL, unitRoute, bindRoute,
      sameEndpoint, bindPkg, cert⟩
