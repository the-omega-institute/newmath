...
theorem ContinuationMonadCarrier_root_unblock_source_triad [AskSetup] [PackageSetup]
  ...
  exact
    ⟨unaryA, unaryB, unaryC, unaryF, unaryG, unaryU, unaryK, unaryL, routeB, routeC,
      routeK, routeL, sameEndpoint, cert⟩
