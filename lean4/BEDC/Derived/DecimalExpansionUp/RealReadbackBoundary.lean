...
theorem DecimalExpansionRealReadbackBoundary [AskSetup] [PackageSetup]
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact ⟨source.right, dyadicRoute, regseqRoute, realRoute, provenancePkg, namePkg⟩
  }
  exact ⟨cert, prefixUnary, placeUnary, dyadicUnary, regseqUnary, realUnary⟩
