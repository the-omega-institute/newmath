...
theorem DecimalExpansionDyadicRationalReadback [AskSetup] [PackageSetup]
                              ...
                              SemanticNameCert
                                ...
                                UnaryHistory prefixRead ∧ UnaryHistory placeRead ∧
                                  UnaryHistory dyadicRead ∧ UnaryHistory regseqRead ∧
                                    UnaryHistory realSeal ∧ Cont placeRead Q dyadicRead ∧
                                      Cont dyadicRead R regseqRead ∧
                                        Cont regseqRead E realSeal ∧
  ...
  intro dUnary wUnary vUnary qUnary rUnary eUnary prefixRoute placeRoute dyadicRoute
    regseqRoute realRoute provenancePkg namePkg
  ...
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row prefixRead ∨ hsame row placeRead ∨ hsame row dyadicRead ∨
              hsame row regseqRead ∨ hsame row realSeal)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont placeRead Q dyadicRead ∧
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, dyadicRoute, regseqRoute, realRoute, provenancePkg, namePkg⟩
  }
  exact
    ⟨cert, prefixUnary, placeUnary, dyadicUnary, regseqUnary, realUnary, dyadicRoute,
      regseqRoute, realRoute, provenancePkg, namePkg⟩
