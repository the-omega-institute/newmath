...
theorem BaireCategoryCarrier_countable_choice_refusal [AskSetup] [PackageSetup]
  ...
  intro carrier threadMetricTerminal terminalPkg
  obtain ⟨_prefixUnary, metricUnary, _denseUnary, _openUnary, _refinementUnary,
    threadUnary, _transportUnary, _replayUnary, _provenanceUnary, _nameUnary,
      packageP⟩ := carrier
