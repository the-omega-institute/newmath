...
theorem DyadicCauchyTailEnvelopeNonescape [AskSetup] [PackageSetup]
    {reindex stream regseq dyadic tail sealRead replay provenance localName consumerRead :
      BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    UnaryHistory reindex →
      UnaryHistory stream →
        UnaryHistory regseq →
          UnaryHistory dyadic →
            UnaryHistory localName →
              Cont reindex stream replay →
                Cont replay regseq tail →
                  Cont tail dyadic sealRead →
                      ...
                      PkgSig bundle provenance pkg →
                        PkgSig bundle consumerRead pkg →
                          SemanticNameCert
                              ...
                              (fun row : BHist =>
                                hsame row reindex ∨ hsame row stream ∨ hsame row regseq ∨
                                  hsame row dyadic ∨ hsame row tail ∨ hsame row sealRead ∨
                                    hsame row consumerRead)
                              (fun row : BHist => UnaryHistory row ∧ PkgSig bundle consumerRead pkg)
                              hsame ∧
                            UnaryHistory replay ∧ UnaryHistory tail ∧ UnaryHistory sealRead ∧
  ...
  intro reindexUnary streamUnary regseqUnary dyadicUnary localNameUnary reindexStreamRoute
    replayRegseqRoute tailDyadicRoute consumerRoute provenancePkg consumerPkg
  have replayUnary : UnaryHistory replay :=
    unary_cont_closed reindexUnary streamUnary reindexStreamRoute
  have tailUnary : UnaryHistory tail :=
    unary_cont_closed replayUnary regseqUnary replayRegseqRoute
  have sealUnary : UnaryHistory sealRead :=
    unary_cont_closed tailUnary dyadicUnary tailDyadicRoute
  have consumerUnary : UnaryHistory consumerRead :=
    unary_cont_closed sealUnary localNameUnary consumerRoute
