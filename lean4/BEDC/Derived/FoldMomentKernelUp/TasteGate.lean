...
private theorem FoldMomentKernel_zero_window_packet_decode_encode_bhist :
...
private theorem FoldMomentKernel_zero_window_packet_round_trip :
  ...
  | mk window foldSource fiberLedger momentIndex collisionCount transport route provenance
      ...
      rw [FoldMomentKernel_zero_window_packet_decode_encode_bhist window,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist foldSource,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist fiberLedger,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist momentIndex,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist collisionCount,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist transport,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist route,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist provenance,
        FoldMomentKernel_zero_window_packet_decode_encode_bhist namecert]

private theorem FoldMomentKernel_zero_window_packet_toEventFlow_injective
  ...
  exact Option.some.inj
    (Eq.trans (FoldMomentKernel_zero_window_packet_round_trip x).symm
      (Eq.trans hread (FoldMomentKernel_zero_window_packet_round_trip y)))
...
instance foldMomentKernelChapterTasteGate : ChapterTasteGate FoldMomentKernelUp where
  ...
  round_trip := by
    ...
    exact FoldMomentKernel_zero_window_packet_round_trip x
  layer_separation := by
    intro x y hxy heq
    exact hxy (FoldMomentKernel_zero_window_packet_toEventFlow_injective heq)
