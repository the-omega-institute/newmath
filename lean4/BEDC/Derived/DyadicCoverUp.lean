...
theorem DyadicCoverPacket_total_bounded_handoff_export [AskSetup] [PackageSetup]
    {centers radii intervals mesh window transport routes provenance nameCert endpoint incidence
      radiusRead envelopeRead : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    DyadicCoverPacket centers radii intervals mesh window transport routes provenance nameCert
  ...
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg Cont SemanticNameCert hsame
  intro packet windowRoutesIncidence radiiIncidenceRadiusRead incidenceRoutesEnvelopeRead
    incidencePkg radiusReadPkg envelopeReadPkg
  have certSurface :=
    DyadicCoverPacket_namecert_obligations packet
...
theorem DyadicCoverPacket_finite_window_mesh_incidence_package [AskSetup] [PackageSetup]
    {centers radii intervals mesh window transport routes provenance nameCert endpoint incidence
      streamRead regularRead realRead : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    DyadicCoverPacket centers radii intervals mesh window transport routes provenance nameCert
                        ...
                        UnaryHistory centers ∧ UnaryHistory radii ∧ UnaryHistory intervals ∧
                          UnaryHistory mesh ∧ UnaryHistory window ∧ UnaryHistory incidence ∧
                            UnaryHistory streamRead ∧ UnaryHistory regularRead ∧
                              UnaryHistory realRead ∧ Cont centers radii intervals ∧
  ...
  exact
    ⟨certSurface.left, centersUnary, radiiUnary, intervalsUnary, meshUnary, windowUnary,
      incidenceUnary, streamUnary, regularUnary, realUnary, centersRadiiIntervals,
      intervalsMeshWindow, windowRoutesIncidence, incidenceRoutesStream, streamRoutesRegular,
      regularRoutesReal, endpointPkg, realPkg⟩
