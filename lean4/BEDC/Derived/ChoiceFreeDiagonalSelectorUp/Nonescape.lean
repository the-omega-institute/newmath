...
namespace BEDC.Derived.ChoiceFreeDiagonalSelectorUp.Nonescape
...
theorem ChoiceFreeDiagonalSelectorNonescape [AskSetup] [PackageSetup]
                ...
                SemanticNameCert
                    ...
                    (fun row : BHist =>
                      hsame row epsilon ∨ hsame row window ∨ hsame row stream ∨
                        hsame row readback ∨ hsame row windowRead ∨
  ...
  intro carrier epsilonWindow windowStream witnessReadback sealLocal localNamePkg
  ...
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row epsilon ∨ hsame row window ∨ hsame row stream ∨
              hsame row readback ∨ hsame row windowRead ∨ hsame row witnessRead ∨
    ...
    ledger_sound := by
      intro _row sourceRow
      exact
        ⟨sourceRow.right, epsilonWindow, windowStream, witnessReadback, sealLocal,
          provenancePkg, localNamePkg⟩
  }
  exact ⟨cert, windowReadUnary, witnessReadUnary, sealReadUnary, namedReadUnary⟩

end BEDC.Derived.ChoiceFreeDiagonalSelectorUp.Nonescape
