...
theorem PolishSpaceCompleteSeparableObligationScope [AskSetup] [PackageSetup]
    {M K D S R W H C G N completionRead denseRead streamWindow readbackRead frontierRead
      closureRead : BHist}
          ...
          Cont denseRead S streamWindow ->
            Cont streamWindow R readbackRead ->
              Cont readbackRead W frontierRead ->
                Cont frontierRead N closureRead ->
                  PkgSig bundle G pkg ->
                    PkgSig bundle N pkg ->
                      SemanticNameCert
                          ...
                          (fun row : BHist =>
                            hsame row M ∨ hsame row K ∨ hsame row D ∨ hsame row S ∨
                              hsame row R ∨ hsame row W ∨ hsame row H ∨ hsame row C ∨
                                hsame row G ∨ hsame row N ∨ hsame row closureRead)
                          (fun row : BHist =>
                            UnaryHistory row ∧ Cont M K completionRead ∧
                              Cont M D denseRead ∧ Cont denseRead S streamWindow ∧
                                Cont streamWindow R readbackRead ∧
                                  Cont readbackRead W frontierRead ∧
                                    Cont frontierRead N closureRead ∧
                        ...
                        UnaryHistory completionRead ∧ UnaryHistory denseRead ∧
                          UnaryHistory streamWindow ∧ UnaryHistory readbackRead ∧
                            UnaryHistory frontierRead ∧ UnaryHistory closureRead := by
  -- BEDC touchpoint anchor: PolishSpaceCarrier BHist Cont ProbeBundle PkgSig SemanticNameCert hsame UnaryHistory
  intro carrier completionRoute denseRoute streamRoute readbackRoute frontierRoute closureRoute
  ...
  have closureUnary : UnaryHistory closureRead :=
    unary_cont_closed frontierUnary NUnary closureRoute
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row closureRead ∧ UnaryHistory row)
          (fun row : BHist =>
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont M K completionRead ∧ Cont M D denseRead ∧
              Cont denseRead S streamWindow ∧ Cont streamWindow R readbackRead ∧
                Cont readbackRead W frontierRead ∧ Cont frontierRead N closureRead ∧
                  PkgSig bundle G pkg ∧ PkgSig bundle N pkg)
          hsame := {
    core := {
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, completionRoute, denseRoute, streamRoute, readbackRoute,
          frontierRoute, closureRoute, provenancePkg, localNamePkg⟩
  }
  exact
    ⟨cert, completionUnary, denseUnary, streamUnary, readbackUnary, frontierUnary,
      closureUnary⟩
...
theorem PolishspaceCompleteSeparableObligationScope [AskSetup] [PackageSetup]
                  ...
                  PkgSig bundle N pkg ->
                    SemanticNameCert
                        ...
                        (fun row : BHist =>
                          hsame row M ∨ hsame row K ∨ hsame row D ∨ hsame row S ∨
                            hsame row R ∨ hsame row W ∨ hsame row H ∨ hsame row C ∨
                              hsame row G ∨ hsame row N ∨ hsame row scopeRead)
                        (fun row : BHist =>
                          UnaryHistory row ∧ Cont denseRead S streamWindow ∧
                            Cont streamWindow R readbackRead ∧
                              Cont readbackRead W scopeRead ∧ PkgSig bundle G pkg ∧
                                PkgSig bundle N pkg)
                        hsame ∧
                      UnaryHistory completionRead ∧ UnaryHistory denseRead ∧
                        UnaryHistory streamWindow ∧ UnaryHistory readbackRead ∧
  ...
  -- BEDC touchpoint anchor: PolishSpaceCarrier BHist Cont ProbeBundle PkgSig SemanticNameCert hsame UnaryHistory
  intro carrier completionRoute denseRoute streamRoute readbackRoute scopeRoute
    provenancePkg localNamePkg
  obtain ⟨MUnary, KUnary, DUnary, SUnary, RUnary, WUnary, _HUnary, _CUnary,
  ...
  have scopeUnary : UnaryHistory scopeRead :=
    unary_cont_closed readbackUnary WUnary scopeRoute
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row scopeRead ∧ UnaryHistory row)
          (fun row : BHist =>
          ...
          (fun row : BHist =>
            UnaryHistory row ∧ Cont denseRead S streamWindow ∧
              Cont streamWindow R readbackRead ∧ Cont readbackRead W scopeRead ∧
                PkgSig bundle G pkg ∧ PkgSig bundle N pkg)
          hsame := {
    core := {
    ...
    ledger_sound := by
      intro _row source
      exact ⟨source.right, streamRoute, readbackRoute, scopeRoute, provenancePkg, localNamePkg⟩
  }
  exact ⟨cert, completionUnary, denseUnary, streamUnary, readbackUnary, scopeUnary⟩
