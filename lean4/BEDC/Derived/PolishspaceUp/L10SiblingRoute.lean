...
theorem PolishSpaceL10SiblingRoute [AskSetup] [PackageSetup]
    {metric complete separable stream readback ledger transport replay provenance localName
      completionRead denseRead siblingRead finalRead : BHist}
                ...
                UnaryHistory transport →
                  Cont complete stream completionRead →
                    Cont separable stream denseRead →
                      Cont completionRead denseRead siblingRead →
                                ...
                                SemanticNameCert
                                  ...
                                  UnaryHistory completionRead ∧
                                    UnaryHistory denseRead ∧
                                      UnaryHistory siblingRead ∧ UnaryHistory finalRead := by
  -- BEDC touchpoint anchor: BHist Cont ProbeBundle PkgSig SemanticNameCert hsame UnaryHistory
  intro _metricUnary completeUnary separableUnary streamUnary readbackUnary ledgerUnary
    transportUnary completeStreamCompletion separableStreamDense completionDenseSibling
  ...
  have siblingUnary : UnaryHistory siblingRead :=
    unary_cont_closed completionUnary denseUnary completionDenseSibling
  ...
  exact ⟨cert, completionUnary, denseUnary, siblingUnary, finalUnary⟩
