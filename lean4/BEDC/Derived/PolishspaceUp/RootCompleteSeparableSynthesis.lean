...
theorem PolishSpaceRootCompleteSeparableSynthesis [AskSetup] [PackageSetup]
    {metric complete separable stream readback ledger transport replay provenance localName
      completionRead denseRead rootRead observationRead finalRead : BHist}
                      ...
                      Cont completionRead denseRead rootRead →
                        Cont ledger transport replay →
                          Cont replay readback observationRead →
                            Cont observationRead rootRead finalRead →
                                        ...
                                        hsame row metric ∨ hsame row complete ∨
                                          hsame row separable ∨ hsame row stream ∨
                                            hsame row readback ∨ hsame row ledger ∨
                                              hsame row rootRead ∨ hsame row finalRead)
                                      (fun row : BHist =>
  ...
  intro metricUnary completeUnary separableUnary _streamUnary readbackUnary ledgerUnary
    transportUnary metricCompleteRead metricSeparableRead completionDenseRoot
    ledgerTransportReplay replayReadbackObservation observationRootFinal provenancePkg
    localNamePkg
  ...
  have rootUnary : UnaryHistory rootRead :=
    unary_cont_closed completionUnary denseUnary completionDenseRoot
  ...
  have finalUnary : UnaryHistory finalRead :=
    unary_cont_closed observationUnary rootUnary observationRootFinal
  have sourceFinal :
  ...
  exact ⟨cert, completionUnary, denseUnary, rootUnary, observationUnary, finalUnary⟩
