...
namespace BEDC.Derived.BHistDecaSequenceNameCertUp
...
def BHistDecaSequenceNameCertCarrier [AskSetup] [PackageSetup]
    (r0 r1 r2 r3 r4 r5 r6 r7 r8 r9 route provenance localName : BHist)
  ...
  UnaryHistory r0 ∧ UnaryHistory r1 ∧ UnaryHistory r2 ∧ UnaryHistory r3 ∧
    UnaryHistory r4 ∧ UnaryHistory r5 ∧ UnaryHistory r6 ∧ UnaryHistory r7 ∧
      UnaryHistory r8 ∧ UnaryHistory r9 ∧ UnaryHistory route ∧ UnaryHistory provenance ∧
        UnaryHistory localName ∧ Cont route provenance localName ∧
          PkgSig bundle localName pkg

theorem BHistDecaSequenceNameCertCarrier_namecert_obligations [AskSetup] [PackageSetup]
    {r0 r1 r2 r3 r4 r5 r6 r7 r8 r9 route provenance localName : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    BHistDecaSequenceNameCertCarrier r0 r1 r2 r3 r4 r5 r6 r7 r8 r9 route provenance
      localName bundle pkg ->
      PkgSig bundle localName pkg ->
        SemanticNameCert
            (fun row : BHist =>
              BHistDecaSequenceNameCertCarrier r0 r1 r2 r3 r4 r5 r6 r7 r8 r9 route
...
end BEDC.Derived.BHistDecaSequenceNameCertUp
