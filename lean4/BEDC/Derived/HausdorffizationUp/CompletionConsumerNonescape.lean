...
theorem HausdorffizationCarrier_completion_consumer_nonescape
    {P S M C W R E T K G N completionRead replayRead nameRead : BHist} :
  ...
  intro carrierData completionRoute replayRoute nameRoute
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row sourceRow
      exact ⟨sourceRow.right, carrierOriginal, completionRoute, replayRoute, nameRoute⟩
  }
  exact ⟨cert, completionUnary, replayUnary, nameUnary⟩
