...
theorem RegularCauchyWindowFusionObligationInventory [AskSetup] [PackageSetup]
                          ...
                          SemanticNameCert
                              ...
                              (fun row : BHist =>
                                hsame row R ∨ hsame row W ∨ hsame row S ∨
                                  hsame row D ∨ hsame row E ∨ hsame row seedWindow ∨
                                    hsame row regularDyadic ∨ hsame row sealMeet ∨
                                      hsame row named)
                              (fun row : BHist =>
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row R ∨ hsame row W ∨ hsame row S ∨ hsame row D ∨ hsame row E ∨
              hsame row seedWindow ∨ hsame row regularDyadic ∨ hsame row sealMeet ∨
                hsame row named)
          (fun row : BHist =>
