...
theorem PseudometricCarrier_scoped_kernel_dependency_surface [AskSetup] [PackageSetup]
              ...
              PkgSig bundle completionRead pkg ->
                UnaryHistory point ∧ UnaryHistory distanceRead ∧
                  UnaryHistory sealedDistance ∧ UnaryHistory zeroBoundaryRead ∧
                    UnaryHistory completionRead ∧ Cont distance stream distanceRead ∧
                      Cont distanceRead sealRow sealedDistance ∧
                        Cont zeroRow transport zeroBoundaryRead ∧
                          Cont sealedDistance replay completionRead ∧
  ...
  exact
    ⟨pointUnary, distanceReadUnary, sealedDistanceUnary, zeroBoundaryUnary,
      completionUnary, distanceRoute, sealedRoute, zeroBoundaryRoute, completionRoute,
