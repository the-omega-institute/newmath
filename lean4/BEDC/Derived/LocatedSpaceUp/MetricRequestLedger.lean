...
theorem LocatedSpaceCarrier_metric_request_ledger [AskSetup] [PackageSetup]
                    ...
                    SemanticNameCert
                      ...
                      UnaryHistory requestRead ∧ UnaryHistory gapRead ∧
                        UnaryHistory windowRead ∧ UnaryHistory readbackRead ∧
                          UnaryHistory sealRead ∧ UnaryHistory ledgerRead := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg Cont PkgSig hsame SemanticNameCert
  intro rows requestRoute gapRoute windowRoute readbackRoute sealRoute ledgerRoute namePkg
  obtain ⟨xUnary, rUnary, aUnary, gUnary, wUnary, qUnary, eUnary, _hUnary, _cUnary,
