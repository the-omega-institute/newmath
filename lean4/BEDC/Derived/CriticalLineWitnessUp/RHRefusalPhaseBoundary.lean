...
theorem CriticalLineWitnessCarrier_rh_refusal_phase_boundary
    {Z S M R Q H C P N phaseRead refusalRead rhRead : BHist} :
          ...
          Cont refusalRead C rhRead ->
            SemanticNameCert
              ...
              UnaryHistory Z ∧ UnaryHistory S ∧ UnaryHistory M ∧ UnaryHistory R ∧
                UnaryHistory Q ∧ UnaryHistory phaseRead ∧ UnaryHistory refusalRead ∧
                  UnaryHistory rhRead ∧ hsame H (append Z S) ∧ Cont M R Q ∧
                    Cont Q H C ∧ Cont C P N ∧ Cont M R phaseRead ∧
                      Cont N Q refusalRead ∧ Cont refusalRead C rhRead := by
  -- BEDC touchpoint anchor: BHist Cont hsame SemanticNameCert UnaryHistory
  intro packet phaseRoute refusalRoute rhRoute
  ...
  have phaseUnary : UnaryHistory phaseRead :=
    unary_cont_closed unaryM unaryR phaseRoute
  ...
  exact
    ⟨cert, unaryZ, unaryS, unaryM, unaryR, unaryQ, phaseUnary, refusalUnary, rhUnary,
      sameH, routeQ, routeC, routeN, phaseRoute, refusalRoute, rhRoute⟩
