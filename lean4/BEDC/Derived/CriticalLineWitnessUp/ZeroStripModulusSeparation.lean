...
theorem CriticalLineWitnessCarrier_zero_strip_modulus_separation
    {Z S M R Q H C P N zeroStrip refusalRead analyticPayload : BHist} :
            ...
            SemanticNameCert
                ...
                (fun row : BHist =>
                  hsame row Z ∨ hsame row S ∨ hsame row M ∨ hsame row R ∨
                    hsame row Q ∨ hsame row refusalRead)
                (fun row : BHist => hsame row refusalRead ∧ Cont N Q refusalRead)
                hsame ∧
              UnaryHistory Z ∧ UnaryHistory S ∧ UnaryHistory M ∧ UnaryHistory R ∧
                UnaryHistory Q ∧ UnaryHistory C ∧ UnaryHistory N ∧
                  UnaryHistory zeroStrip ∧ UnaryHistory refusalRead ∧
                    UnaryHistory analyticPayload ∧ hsame H (append Z S) ∧
                      Cont Z S zeroStrip ∧ Cont N Q refusalRead ∧
                        Cont refusalRead C analyticPayload ∧ Cont M R Q ∧
                          Cont Q H C ∧ Cont C P N := by
  -- BEDC touchpoint anchor: BHist Cont hsame SemanticNameCert UnaryHistory
  intro packet zeroStripRoute refusalRoute analyticRoute
  ...
  have analyticUnary : UnaryHistory analyticPayload :=
  ...
  exact
    ⟨cert, unaryZ, unaryS, unaryM, unaryR, unaryQ, unaryC, unaryN, zeroStripUnary,
      refusalUnary, analyticUnary, sameH, zeroStripRoute, refusalRoute, analyticRoute,
