...
theorem CriticalLineWitnessRhConsumerUnblock
        ...
        Cont N Q refusalRead ->
          Cont refusalRead C consumerRead ->
            SemanticNameCert
                  ...
                  (fun row : BHist =>
                    hsame row sourceRead ∨ hsame row refusalRead ∨ hsame row consumerRead)
                  (fun row : BHist =>
  ...
  exact
    ⟨cert, sourceUnary, refusalUnary, consumerUnary, sameH, sourceRoute, refusalRoute,
      consumerRoute⟩
