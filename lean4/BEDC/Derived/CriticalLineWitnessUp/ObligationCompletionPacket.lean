...
theorem CriticalLineWitnessCarrier_obligation_carrier_admission_row
    {Z S M R Q H C P N : BHist} :
    CriticalLineWitnessCarrier Z S M R Q H C P N ->
      UnaryHistory Z ∧ UnaryHistory S ∧ UnaryHistory M ∧ UnaryHistory R ∧
        UnaryHistory P ∧ UnaryHistory Q ∧ UnaryHistory H ∧ UnaryHistory C ∧
  ...
  exact
    ⟨unaryZ, unaryS, unaryM, unaryR, unaryP, routeClosure.left, unaryH,
      routeClosure.right.left, routeClosure.right.right.left, sameH, routeQ, routeC, routeN⟩
