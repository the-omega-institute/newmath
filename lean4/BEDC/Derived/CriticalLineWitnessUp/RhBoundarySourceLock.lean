...
theorem CriticalLineWitnessRhBoundarySourceLock
    {Z S M R Q H C P N sourceRead refusalRead boundaryRead : BHist} :
        ...
        Cont N Q refusalRead ->
          Cont refusalRead C boundaryRead ->
            SemanticNameCert
                ...
                hsame ∧
              UnaryHistory sourceRead ∧ UnaryHistory refusalRead ∧ UnaryHistory boundaryRead ∧
                hsame H (append Z S) ∧ Cont (append Z S) Q sourceRead ∧
                  Cont N Q refusalRead ∧ Cont refusalRead C boundaryRead := by
  -- BEDC touchpoint anchor: BHist Cont hsame SemanticNameCert UnaryHistory
  intro packet sourceRoute refusalRoute boundaryRoute
  ...
  have sourceReadUnary : UnaryHistory sourceRead :=
    unary_cont_closed sourceUnary unaryQ sourceRoute
  ...
  exact
    ⟨cert, sourceReadUnary, refusalUnary, boundaryUnary, sameH, sourceRoute, refusalRoute,
      boundaryRoute⟩
