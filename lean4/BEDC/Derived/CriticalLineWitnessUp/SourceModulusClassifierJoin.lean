...
theorem CriticalLineWitnessCarrier_source_modulus_classifier_join
          ...
          Cont comparison H classifier ->
            Cont sourceRead classifier boundary ->
              SemanticNameCert
                  ...
                  (fun row : BHist => hsame row boundary ∧ Cont Z S sourceRead)
                  (fun row : BHist => hsame row boundary ∧ Cont sourceRead classifier boundary)
                  hsame ∧
                UnaryHistory sourceRead ∧ UnaryHistory comparison ∧ UnaryHistory classifier ∧
                  UnaryHistory boundary ∧ hsame comparison Q ∧ hsame H (append Z S) ∧
  ...
  exact
    ⟨cert, sourceUnary, comparisonUnary, classifierUnary, boundaryUnary, sameComparison,
