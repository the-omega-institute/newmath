...
theorem CriticalLineWitnessCarrier_root_source_modulus_formal_boundary
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact ⟨source.right, sourceRoute, modulusRoute, boundaryRoute⟩
  }
  exact
