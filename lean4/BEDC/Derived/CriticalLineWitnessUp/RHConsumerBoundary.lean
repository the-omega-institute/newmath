...
theorem CriticalLineWitnessCarrier_rh_consumer_boundary
  ...
  have consumerUnary : UnaryHistory consumerRead :=
    unary_cont_closed modulusUnary unaryC consumerRoute
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row consumerRead ∧ UnaryHistory row)
          (fun row : BHist => hsame row consumerRead ∧ hsame H (append Z S))
  ...
  exact
    ⟨cert, unaryZ, unaryS, unaryM, unaryR, unaryQ, stripUnary, modulusUnary,
      consumerUnary, routeQ, routeC, routeN⟩
