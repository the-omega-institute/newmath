...
theorem CriticalLineWitnessCarrier_root_refusal_ledger_scope
    ...
    CriticalLineWitnessCarrier Z S M R Q H C P N ->
      Cont N Q refusalRead ->
        SemanticNameCert
            ...
            hsame ∧
          UnaryHistory refusalRead ∧ hsame H (append Z S) ∧ Cont M R Q ∧ Cont Q H C ∧
            Cont C P N := by
  ...
  exact ⟨cert, refusalUnary, sameH, routeQ, routeC, routeN⟩
