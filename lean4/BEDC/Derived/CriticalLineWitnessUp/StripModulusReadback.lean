...
theorem CriticalLineWitnessCarrier_strip_modulus_readback
    {Z S M R Q H C P N stripRead modulusRead rhRead : BHist} :
        ...
        Cont stripRead Q modulusRead ->
          Cont modulusRead N rhRead ->
            SemanticNameCert
                ...
                (fun row : BHist =>
                  hsame row rhRead ∧ Cont Z S stripRead ∧ Cont stripRead Q modulusRead)
                (fun row : BHist =>
                  hsame row rhRead ∧ Cont modulusRead N rhRead)
                hsame ∧
              UnaryHistory stripRead ∧ UnaryHistory modulusRead ∧ UnaryHistory rhRead ∧
                hsame H (append Z S) := by
  -- BEDC touchpoint anchor: BHist Cont hsame SemanticNameCert UnaryHistory
  intro packet stripRoute modulusRoute rhRoute
  ...
  exact ⟨cert, stripUnary, modulusUnary, rhUnary, sameH⟩
