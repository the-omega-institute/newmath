...
theorem CriticalLineWitnessCarrier_source_modulus_zeta_readback
  ...
  exact
    ⟨unaryZ, unaryS, unaryM, unaryR, unaryQ, unaryH, zetaUnary, modulusUnary, sameH,
      zetaRoute, modulusRoute, routeQ, routeC, routeN⟩
