...
theorem CriticalLineWitnessCarrier_fixed_strip_refusal_budget_packet
  ...
  exact
    ⟨unaryZ, unaryS, unaryM, unaryR, unaryQ, unaryC, unaryN,
      unaryRefusal, sameH, routeQ, routeC, routeN, refusalRoute⟩
