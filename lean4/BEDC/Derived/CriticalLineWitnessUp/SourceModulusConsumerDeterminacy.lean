...
theorem CriticalLineWitnessCarrier_source_modulus_consumer_determinacy
        ...
        Cont M R modulusRead ->
          Cont sourceRead modulusRead consumerRead ->
            SemanticNameCert
                ...
                (fun row : BHist => hsame row consumerRead ∧ Cont Z S sourceRead)
                (fun row : BHist =>
                  hsame row consumerRead ∧ Cont sourceRead modulusRead consumerRead)
                hsame ∧
                ...
                UnaryHistory Q ∧ UnaryHistory sourceRead ∧ UnaryHistory modulusRead ∧
                  UnaryHistory consumerRead ∧ hsame H (append Z S) ∧
                    Cont Z S sourceRead ∧ Cont M R modulusRead ∧
                      Cont sourceRead modulusRead consumerRead ∧ Cont M R Q ∧
  ...
  exact
    ⟨cert, unaryZ, unaryS, unaryM, unaryR, unaryQ, sourceUnary, modulusUnary,
      consumerUnary, sameH, sourceRoute, modulusRoute, consumerRoute, routeQ, routeC, routeN⟩
