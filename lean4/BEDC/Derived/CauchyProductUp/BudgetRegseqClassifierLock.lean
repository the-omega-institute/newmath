...
theorem CauchyProductPacket_budget_regseq_classifier_lock [AskSetup] [PackageSetup]
                      ...
                      UnaryHistory windowB ∧ UnaryHistory radiusA ∧ UnaryHistory radiusB ∧
                        UnaryHistory observationA ∧ UnaryHistory observationB ∧
                          UnaryHistory product ∧ UnaryHistory classifier ∧
                            UnaryHistory budgetDyadic ∧ UnaryHistory budgetReplay ∧
                              hsame budgetRegseq classifier ∧
  ...
  -- BEDC touchpoint anchor: CauchyProductPacket BHist Cont hsame UnaryHistory ProbeBundle Pkg
  intro packet budgetRequestUnary budgetWindowUnary budgetRegseqUnary requestWindowDyadic
    dyadicRegseqReplay regseqClassifier budgetPkg
  ...
  exact
    ⟨sourceAUnary, sourceBUnary, windowAUnary, windowBUnary, radiusAUnary, radiusBUnary,
      ...
      budgetDyadicUnary, budgetReplayUnary, regseqClassifier, productRoute, classifierRoute,
      requestWindowDyadic, dyadicRegseqReplay, namePkg, budgetPkg⟩
