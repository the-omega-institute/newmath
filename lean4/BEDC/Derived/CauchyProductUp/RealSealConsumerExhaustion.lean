...
theorem CauchyProductPacket_real_seal_consumer_exhaustion [AskSetup] [PackageSetup]
  ...
  have sourceAtRealSeal :
      hsame realSeal product ∨ hsame realSeal classifier ∨ hsame realSeal budgetSeal ∨
        hsame realSeal realSeal :=
    Or.inr (Or.inr (Or.inr (hsame_refl realSeal)))
  have cert :
      SemanticNameCert
          (fun row : BHist =>
            hsame row product ∨ hsame row classifier ∨ hsame row budgetSeal ∨
  ...
  exact
    ⟨cert, productUnary, classifierUnary, budgetClassifierUnary, budgetSealUnary,
      realSealUnary, productRoute, classifierRoute, classifierBudget, budgetSealRoute,
