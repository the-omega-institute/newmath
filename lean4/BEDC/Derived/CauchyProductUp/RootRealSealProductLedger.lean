...
theorem CauchyProductPacket_root_real_seal_product_ledger_certificate
        ...
        PkgSig bundle realSeal pkg ->
          SemanticNameCert
            ...
            UnaryHistory product ∧ UnaryHistory classifier ∧ UnaryHistory realSeal ∧
              Cont product ledger classifier ∧ Cont classifier routes realSeal := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg Cont hsame SemanticNameCert
  intro packet classifierRealSeal realSealPkg
  ...
  exact
    ⟨cert, productUnary, classifierUnary, realSealUnary, classifierRoute,
      classifierRealSeal⟩
