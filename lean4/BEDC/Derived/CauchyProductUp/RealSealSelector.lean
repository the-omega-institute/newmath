...
theorem CauchyProductPacket_real_seal_selector_minimal_witness [AskSetup] [PackageSetup]
    {sourceA sourceB windowA windowB radiusA radiusB observationA observationB product
      classifier transport routes ledger name budgetClassifier budgetSeal realSeal selectorRead
      finalRead : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    CauchyProductPacket sourceA sourceB windowA windowB radiusA radiusB observationA
        observationB product classifier transport routes ledger name bundle pkg ->
      Cont classifier routes budgetClassifier ->
        Cont budgetClassifier ledger budgetSeal ->
          Cont budgetSeal routes realSeal ->
            Cont realSeal ledger selectorRead ->
              Cont selectorRead routes finalRead ->
                    ...
                    UnaryHistory windowB ∧ UnaryHistory product ∧ UnaryHistory classifier ∧
                      UnaryHistory budgetClassifier ∧ UnaryHistory budgetSeal ∧
                        UnaryHistory realSeal ∧ UnaryHistory selectorRead ∧
                          UnaryHistory finalRead ∧ Cont observationA observationB product ∧
                            Cont product ledger classifier ∧
                              Cont classifier routes budgetClassifier ∧
                                Cont budgetClassifier ledger budgetSeal ∧
                                  Cont budgetSeal routes realSeal ∧
  ...
  intro packet classifierBudget budgetSealRoute realSealRoute selectorReadRoute
    finalReadRoute finalReadPkg
  ...
  have selectorReadUnary : UnaryHistory selectorRead :=
    unary_cont_closed realSealUnary ledgerUnary selectorReadRoute
  have finalReadUnary : UnaryHistory finalRead :=
    unary_cont_closed selectorReadUnary routesUnary finalReadRoute
  exact
    ⟨sourceAUnary, sourceBUnary, windowAUnary, windowBUnary, productUnary,
      classifierUnary, budgetClassifierUnary, budgetSealUnary, realSealUnary,
      selectorReadUnary, finalReadUnary, productRoute, classifierRoute, classifierBudget,
      budgetSealRoute, realSealRoute, selectorReadRoute, finalReadRoute, namePkg,
      finalReadPkg⟩
