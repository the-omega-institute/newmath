...
theorem CauchyProductPacket_ledger_exhaustion [AskSetup] [PackageSetup]
              ...
              (fun row : BHist =>
                PkgSig bundle realSeal pkg ∧
                  (hsame row product ∨ hsame row classifier ∨ hsame row realSeal ∨
                    hsame row ledger))
              hsame ∧
            UnaryHistory product ∧ UnaryHistory classifier ∧ UnaryHistory ledger ∧
  ...
  intro packet classifierSeal realSealPkg
  ...
  exact
    ⟨cert, productUnary, classifierUnary, ledgerUnary, realSealUnary, productRoute,
      classifierRoute, classifierSeal, namePkg, realSealPkg⟩
