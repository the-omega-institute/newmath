...
theorem CauchyProductPacket_constant_left_factor [AskSetup] [PackageSetup]
    ...
    CauchyProductPacket sourceA sourceB windowA windowB radiusA radiusB observationA
      ...
      hsame constantWindow windowA ->
        Cont constantWindow radiusA constantObservation ->
  ...
  intro packet sameConstantWindow constantWindowObservation classifierRoutesRealSeal
    realSealPkg
  obtain ⟨_sourceAUnary, _sourceBUnary, windowAUnary, _windowBUnary, radiusAUnary,
    _radiusBUnary, observationAUnary, observationBUnary, routesUnary, ledgerUnary,
    _windowTransport, productRoute, classifierRoute, namePkg⟩ := packet
  have constantWindowUnary : UnaryHistory constantWindow :=
    unary_transport windowAUnary (hsame_symm sameConstantWindow)
  have constantObservationUnary : UnaryHistory constantObservation :=
    unary_cont_closed constantWindowUnary radiusAUnary constantWindowObservation
