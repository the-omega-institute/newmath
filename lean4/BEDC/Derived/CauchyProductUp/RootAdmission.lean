...
theorem CauchyProductPacket_budgeted_root_source_strict_obstruction [AskSetup] [PackageSetup]
    {sourceA sourceB windowA windowB radiusA radiusB observationA observationB product
      classifier transport routes ledger name budgetClassifier budgetSeal obstructionRead : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    CauchyProductPacket sourceA sourceB windowA windowB radiusA radiusB observationA
        observationB product classifier transport routes ledger name bundle pkg ->
      Cont classifier routes budgetClassifier ->
        Cont budgetClassifier ledger budgetSeal ->
          Cont budgetSeal routes obstructionRead ->
            PkgSig bundle obstructionRead pkg ->
              UnaryHistory sourceA ∧ UnaryHistory sourceB ∧ UnaryHistory windowA ∧
                UnaryHistory windowB ∧ UnaryHistory product ∧ UnaryHistory classifier ∧
                  UnaryHistory budgetClassifier ∧ UnaryHistory budgetSeal ∧
                    UnaryHistory obstructionRead ∧ Cont observationA observationB product ∧
  ...
  intro packet classifierBudget budgetSealRoute sealObstruction obstructionPkg
  obtain ⟨sourceAUnary, sourceBUnary, windowAUnary, windowBUnary, _radiusAUnary,
    _radiusBUnary, observationAUnary, observationBUnary, routesUnary, ledgerUnary,
  ...
  have obstructionUnary : UnaryHistory obstructionRead :=
    unary_cont_closed budgetSealUnary routesUnary sealObstruction
  exact
    ⟨sourceAUnary, sourceBUnary, windowAUnary, windowBUnary, productUnary,
      classifierUnary, budgetClassifierUnary, budgetSealUnary, obstructionUnary, productRoute,
      classifierRoute, classifierBudget, budgetSealRoute, sealObstruction, namePkg,
      obstructionPkg⟩
