...
theorem CauchyProductPacket_shared_radius_product_coverage [AskSetup] [PackageSetup]
  ...
  exact
    ⟨windowAUnary, windowBUnary, radiusAUnary, radiusBUnary, productUnary,
      classifierUnary, budgetClassifierUnary, budgetSealUnary, realSealUnary, productRoute,
