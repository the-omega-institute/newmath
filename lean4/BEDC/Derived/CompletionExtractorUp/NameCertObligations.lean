...
theorem CompletionExtractorNameCertObligations [AskSetup] [PackageSetup]
  ...
  exact ⟨Exists.intro (CompletionExtractorUp.mk G M S D Q E H C P N) rfl, cert⟩
