...
theorem FastCauchySubsequenceChoiceFreeCompletionWindow [AskSetup] [PackageSetup]
  ...
  -- BEDC touchpoint anchor: FastCauchySubsequenceCarrier BHist ProbeBundle Pkg Cont hsame SemanticNameCert UnaryHistory PkgSig
  intro carrier modulusRoute selectorRoute fastRoute regularRoute readbackRoute sealRoute
    sealPkg
            ...
            UnaryHistory row ∧ Cont S M modulusRead ∧
              Cont modulusRead Q selectorRead ∧ Cont selectorRead F fastRead ∧
                Cont fastRead R regularRead ∧ Cont regularRead W readbackRead ∧
                  Cont readbackRead E sealRead ∧ PkgSig bundle sealRead pkg)
          hsame := {
    core := {
