...
theorem FastCauchySubsequenceModulusSelectorCoherence [AskSetup] [PackageSetup]
    {S M Q F R W E H C P N modulusRead selectorRead : BHist}
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact ⟨source.right, modulusRoute, selectorRoute, selectorPkg⟩
  }
  exact ⟨cert, modulusUnary, selectorUnary, modulusRoute, selectorRoute⟩
