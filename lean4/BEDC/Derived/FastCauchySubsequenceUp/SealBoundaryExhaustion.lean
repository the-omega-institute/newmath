...
theorem FastCauchySubsequenceSealBoundaryExhaustion [AskSetup] [PackageSetup]
    {S M Q F R W E H C P N modulusRead selectorRead fastRead regularRead tailRead sealRead
      namedRead : BHist}
                      ...
                      SemanticNameCert
                          ...
                          (fun row : BHist =>
                            hsame row S ∨ hsame row M ∨ hsame row Q ∨ hsame row F ∨
                              hsame row R ∨ hsame row W ∨ hsame row E ∨ hsame row N ∨
                                hsame row namedRead)
                          (fun row : BHist =>
  ...
  intro carrier modulusRoute selectorRoute fastRoute regularRoute tailRoute sealRoute namedRoute
    namedPkg
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row S ∨ hsame row M ∨ hsame row Q ∨ hsame row F ∨ hsame row R ∨
              hsame row W ∨ hsame row E ∨ hsame row N ∨ hsame row namedRead)
          (fun row : BHist =>
