...
theorem FastCauchySubsequenceRegularReadbackObligation [AskSetup] [PackageSetup]
                      ...
                      (fun row : BHist =>
                        hsame row S ∨ hsame row M ∨ hsame row Q ∨ hsame row F ∨
                          hsame row R ∨ hsame row W ∨ hsame row H ∨ hsame row C ∨
                            hsame row P ∨ hsame row N ∨ hsame row readbackRead)
                      (fun row : BHist =>
  ...
  intro carrier modulusRoute selectorRoute fastRoute regularRoute readbackRoute readbackPkg
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row S ∨ hsame row M ∨ hsame row Q ∨ hsame row F ∨ hsame row R ∨
              hsame row W ∨ hsame row H ∨ hsame row C ∨ hsame row P ∨ hsame row N ∨
                hsame row readbackRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont S M modulusRead ∧
              Cont modulusRead Q selectorRead ∧ Cont selectorRead F fastRead ∧
                Cont fastRead R regularRead ∧ Cont regularRead W readbackRead ∧
                  PkgSig bundle readbackRead pkg)
          hsame := {
    core := {
      carrier_inhabited :=
  ...
  exact ⟨cert, modulusUnary, selectorUnary, fastUnary, regularUnary, readbackUnary⟩
