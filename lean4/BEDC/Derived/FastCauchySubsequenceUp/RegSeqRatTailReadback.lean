...
theorem FastCauchySubsequenceRegSeqRatTailReadback [AskSetup] [PackageSetup]
                    ...
                    SemanticNameCert
                        ...
                        (fun row : BHist =>
                          hsame row M ∨ hsame row Q ∨ hsame row F ∨ hsame row R ∨
                            hsame row W ∨ hsame row E ∨ hsame row tailRead ∨
                              hsame row sealRead)
                        (fun row : BHist =>
                      ...
                      UnaryHistory regularRead ∧ UnaryHistory tailRead ∧
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row M ∨ hsame row Q ∨ hsame row F ∨ hsame row R ∨ hsame row W ∨
              hsame row E ∨ hsame row tailRead ∨ hsame row sealRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont modulusRead Q selectorRead ∧
              Cont selectorRead F fastRead ∧ Cont fastRead R regularRead ∧
                Cont regularRead W tailRead ∧ Cont tailRead E sealRead ∧
  ...
  exact ⟨cert, selectorUnary, fastUnary, regularUnary, tailUnary, sealUnary⟩
