...
theorem FastCauchySubsequenceRegSeqRatRealRoute [AskSetup] [PackageSetup]
                              ...
                              Cont selectorRead F fastRead ∧
                                Cont fastRead R regularRead ∧
                                  Cont regularRead W regSeqRead ∧
                                    Cont regSeqRead E realRead ∧
                                      PkgSig bundle realRead pkg)
                        hsame ∧ UnaryHistory regSeqRead ∧ UnaryHistory realRead := by
  ...
  have realUnary : UnaryHistory realRead :=
    unary_cont_closed regSeqUnary unaryE realRoute
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row realRead ∧ UnaryHistory row)
          (fun row : BHist =>
            hsame row S ∨ hsame row M ∨ hsame row Q ∨ hsame row F ∨ hsame row R ∨
              hsame row W ∨ hsame row E ∨ hsame row regSeqRead ∨ hsame row realRead)
          (fun row : BHist =>
