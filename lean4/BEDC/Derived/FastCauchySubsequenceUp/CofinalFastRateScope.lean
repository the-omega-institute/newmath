...
theorem FastCauchySubsequenceCofinalFastRateScope [AskSetup] [PackageSetup]
    {S M Q F R W E H C P N modulusRead selectorRead fastRead : BHist}
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact ⟨source.right, modulusRoute, selectorRoute, fastRoute, fastPkg⟩
  }
  exact ⟨cert, modulusUnary, selectorUnary, fastUnary⟩
