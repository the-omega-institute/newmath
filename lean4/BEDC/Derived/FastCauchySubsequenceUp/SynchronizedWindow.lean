...
theorem FastCauchySubsequenceSynchronizedWindow [AskSetup] [PackageSetup]
  ...
  intro carrier modulusRoute selectorRoute fastRoute regularRoute windowRoute sealRoute sealPkg
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, modulusRoute, selectorRoute, fastRoute, regularRoute,
          windowRoute, sealRoute, sealPkg⟩
  }
  exact ⟨cert, selectorUnary, fastUnary, regularUnary, windowUnary, sealUnary⟩
