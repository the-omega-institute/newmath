...
theorem BornologyObligationClosureRoute [AskSetup] [PackageSetup]
  ...
  intro fieldRows sourceRoute heredityRoute unionRoute cauchyRoute nameRoute fUnary eUnary
    sUnary uUnary dUnary _hUnary _cUnary _pUnary nUnary provenancePkg namePkg
  cases fieldRows
  ...
  exact ⟨cert, sourceUnary, heredityUnary, unionUnary, cauchyUnary, namedUnary⟩
