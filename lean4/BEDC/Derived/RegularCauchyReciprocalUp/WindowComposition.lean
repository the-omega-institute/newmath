...
theorem RegularCauchyReciprocalWindowComposition [AskSetup] [PackageSetup]
  ...
  intro qUnary aUnary mUnary wUnary dUnary bUnary tUnary eUnary apartnessRoute
    modulusRoute finiteRoute dyadicRoute budgetRoute readbackRoute sealRoute provenancePkg
    namePkg
      ...
      ledger_sound := by
        ...
        exact
          ⟨source.right, apartnessRoute, modulusRoute, finiteRoute, dyadicRoute,
            budgetRoute, readbackRoute, sealRoute, provenancePkg, namePkg⟩
    }
  · exact
