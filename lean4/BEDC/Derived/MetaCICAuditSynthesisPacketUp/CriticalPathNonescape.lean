...
theorem MetaCICAuditSynthesisCriticalPathNonescape (x : MetaCICAuditSynthesisPacketUp) :
                        ...
                        List.Mem (metaCICAuditSynthesisPacketEncodeBHist R)
                          ...
                          List.Mem (metaCICAuditSynthesisPacketEncodeBHist P)
                            ...
                            List.Mem (metaCICAuditSynthesisPacketEncodeBHist L)
                              (BHistCarrier.toEventFlow x) ∧
                              metaCICAuditSynthesisPacketEncodeBHist BHist.Empty =
                                ([] : List BMark) := by
...
theorem MetaCICAuditSynthesisRouteUnionExactness
