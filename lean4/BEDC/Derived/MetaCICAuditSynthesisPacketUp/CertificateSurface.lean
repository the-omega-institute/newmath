...
theorem MetaCICAuditSynthesisCertificateSurface (x : MetaCICAuditSynthesisPacketUp) :
    ∃ S C N U D A B H R P L : BHist,
      x = MetaCICAuditSynthesisPacketUp.mk S C N U D A B H R P L ∧
        List.Mem (metaCICAuditSynthesisPacketEncodeBHist S) (BHistCarrier.toEventFlow x) ∧
          List.Mem (metaCICAuditSynthesisPacketEncodeBHist B) (BHistCarrier.toEventFlow x) ∧
        ...
        · constructor
          ...
          · constructor
            ...
            · constructor
              · exact List.Mem.head _
              · exact
                  ⟨hsame_refl S, hsame_refl B, hsame_refl L⟩
