...
theorem MetaCICAuditSynthesisDischargeProjection
    ...
    ∃ S C N U D A B H R P L : BHist,
      x = MetaCICAuditSynthesisPacketUp.mk S C N U D A B H R P L ∧
        List.Mem (metaCICAuditSynthesisPacketEncodeBHist N) (BHistCarrier.toEventFlow x) ∧
          List.Mem (metaCICAuditSynthesisPacketEncodeBHist A) (BHistCarrier.toEventFlow x) ∧
                    ...
                    List.Mem (metaCICAuditSynthesisPacketEncodeBHist P)
                      ...
                      List.Mem (metaCICAuditSynthesisPacketEncodeBHist L)
                        ...
                        List.Mem BMark.b0
                          ...
                          hsame N N ∧ hsame A A ∧ hsame S S ∧ hsame B B ∧
                            hsame L L := by
                  ...
                  · constructor
                    ...
                    · constructor
                      ...
                      · constructor
                        · exact List.Mem.head _
                        · exact
                            ⟨hsame_refl N, hsame_refl A, hsame_refl S, hsame_refl B,
                              hsame_refl L⟩
