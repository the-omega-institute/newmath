...
theorem MetaCICAuditSynthesisSubstitutionConfluenceJoin
              ...
              List.Mem (metaCICAuditSynthesisPacketEncodeBHist S)
                ...
                List.Mem (metaCICAuditSynthesisPacketEncodeBHist B)
                  ...
                  List.Mem BMark.b0
                    ...
                    hsame C C ∧ hsame U U ∧ hsame A A ∧ hsame S S ∧
                      hsame B B ∧ hsame H H ∧ hsame R R ∧ hsame P P ∧
                        hsame L L := by
            ...
            · constructor
              ...
              · constructor
                ...
                · constructor
                  · exact List.Mem.head _
                  · exact
                      ⟨hsame_refl C, hsame_refl U, hsame_refl A, hsame_refl S,
                        hsame_refl B, hsame_refl H, hsame_refl R, hsame_refl P,
                        hsame_refl L⟩
