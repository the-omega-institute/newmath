...
theorem DiniUniformConvergenceUniformModulusExtraction [AskSetup] [PackageSetup]
              ...
              PkgSig bundle P pkg →
                PkgSig bundle N pkg →
                  SemanticNameCert
                    ...
                    (fun row : BHist =>
                      hsame row T ∨ hsame row M ∨ hsame row W ∨ hsame row R ∨
                        hsame row E ∨ hsame row modulusRead ∨ hsame row windowRead ∨
  ...
  have cert :
      SemanticNameCert
        (fun row : BHist => hsame row sealRead ∧ UnaryHistory row)
        (fun row : BHist =>
          hsame row T ∨ hsame row M ∨ hsame row W ∨ hsame row R ∨ hsame row E ∨
            hsame row modulusRead ∨ hsame row windowRead ∨ hsame row readbackRead ∨
              hsame row sealRead)
        (fun row : BHist =>
