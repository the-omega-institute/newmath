...
theorem CoveringDimensionRootCoverScopePrimitiveRoute [AskSetup] [PackageSetup]
          ...
          SemanticNameCert
              (fun row : BHist =>
                hsame row epsilonNet ∨ hsame row cover ∨ hsame row refinement ∨
                  hsame row orderBound ∨ hsame row lebesgue ∨ hsame row sample)
                                  ...
                                  (Or.inr
                                    (Or.inr
                                      (Or.inr
                                        (Or.inl
                                          (hsame_trans
                                            (hsame_symm sameRows) lebesgueSource)))))
                          | inr sampleSource =>
                              exact
                                Or.inr
                                  (Or.inr
                                    (Or.inr
                                      (Or.inr
                                        (Or.inr
                                          (hsame_trans
                                            (hsame_symm sameRows) sampleSource)))))
      }
      pattern_sound := by
        intro _row source
        cases source with
