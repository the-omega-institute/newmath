...
theorem MetaCICCriticalPathResidualSocketConsumerSurface [AskSetup] [PackageSetup]
    {strongNorm normalForm obstruction unblock discharge handoff continuation provenance
      localName dyadic stream regseq realSeal schedule residual frontier confluence subst socket
      l10 endpoint : BHist}
      ...
      Cont continuation localName schedule →
        Cont schedule discharge residual →
          Cont residual obstruction frontier →
            Cont frontier handoff confluence →
              Cont confluence localName subst →
                Cont subst discharge socket →
                  Cont socket realSeal l10 →
                            ...
                            (fun row : BHist =>
                              hsame row schedule ∨ hsame row residual ∨
                                hsame row frontier ∨ hsame row confluence ∨
                                  hsame row subst ∨ hsame row socket ∨ hsame row l10 ∨
                                    hsame row endpoint)
                            (fun row : BHist =>
  ...
  intro ledger continuationLocalSchedule scheduleDischargeResidual
    residualObstructionFrontier frontierHandoffConfluence confluenceLocalSubst
    substDischargeSocket socketRealSealL10 l10ProvenanceEndpoint endpointPkg
  ...
  have substUnary : UnaryHistory subst :=
    unary_cont_closed confluenceUnary localNameUnary confluenceLocalSubst
  have socketUnary : UnaryHistory socket :=
    unary_cont_closed substUnary dischargeUnary substDischargeSocket
  have l10Unary : UnaryHistory l10 :=
    unary_cont_closed socketUnary realSealUnary socketRealSealL10
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row schedule ∨ hsame row residual ∨ hsame row frontier ∨
              hsame row confluence ∨ hsame row subst ∨ hsame row socket ∨
