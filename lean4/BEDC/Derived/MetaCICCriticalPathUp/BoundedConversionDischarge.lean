...
theorem MetaCICCriticalPathBoundedConversionDischarge [AskSetup] [PackageSetup]
    {strongNorm normalForm obstruction unblock discharge handoff continuation provenance
      localName dyadic stream regseq realSeal conversionRead : BHist}
    {bundle : ProbeBundle ProbeName} {pkg : Pkg} :
    MetaCICCriticalPathOpenPhaseSourceLedger strongNorm normalForm obstruction unblock
        discharge handoff continuation provenance localName dyadic stream regseq realSeal
        bundle pkg →
      Cont continuation discharge conversionRead →
              ...
              (fun row : BHist =>
                hsame row strongNorm ∨ hsame row normalForm ∨ hsame row discharge ∨
                  hsame row handoff ∨ hsame row dyadic ∨ hsame row stream ∨
                    hsame row regseq ∨ hsame row realSeal ∨ hsame row conversionRead)
              (fun row : BHist =>
                UnaryHistory row ∧ PkgSig bundle conversionRead pkg ∧
                  PkgSig bundle realSeal pkg)
              hsame ∧
            UnaryHistory conversionRead ∧ PkgSig bundle realSeal pkg := by
  -- BEDC touchpoint anchor: BHist Cont ProbeBundle PkgSig SemanticNameCert hsame UnaryHistory
  intro ledger continuationDischargeRead conversionReadPkg
  ...
  have conversionReadUnary : UnaryHistory conversionRead :=
    unary_cont_closed continuationUnary dischargeUnary continuationDischargeRead
  ...
  exact ⟨cert, conversionReadUnary, realSealPkg⟩
