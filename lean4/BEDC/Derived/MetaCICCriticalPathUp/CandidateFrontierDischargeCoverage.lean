...
theorem MetaCICCriticalPathCandidateFrontierDischargeCoverage_semantic_name_certificate
    ...
    MetaCICCriticalPathOpenPhaseSourceLedger strongNorm normalForm obstruction unblock
      ...
      Cont continuation localName candidateRead ->
        Cont candidateRead discharge frontierRead ->
          Cont frontierRead obstruction socketRead ->
            Cont socketRead realSeal consumerRead ->
              PkgSig bundle consumerRead pkg ->
                SemanticNameCert
                    (fun row : BHist => hsame row consumerRead ∧ UnaryHistory row)
                    (fun row : BHist =>
                      hsame row candidateRead ∨ hsame row frontierRead ∨
                        hsame row socketRead ∨ hsame row consumerRead ∨ hsame row dyadic ∨
                    ...
                    hsame ∧
                  UnaryHistory candidateRead ∧ UnaryHistory frontierRead ∧
                    UnaryHistory socketRead ∧ UnaryHistory consumerRead := by
  -- BEDC touchpoint anchor: BHist Cont ProbeBundle PkgSig SemanticNameCert hsame UnaryHistory
  intro ledger continuationLocalCandidate candidateDischargeFrontier
    frontierObstructionSocket socketRealSealConsumer consumerPkg
  ...
  have consumerUnary : UnaryHistory consumerRead :=
    unary_cont_closed socketUnary realSealUnary socketRealSealConsumer
  have sourceConsumer :
  ...
  exact ⟨cert, candidateUnary, frontierUnary, socketUnary, consumerUnary⟩
