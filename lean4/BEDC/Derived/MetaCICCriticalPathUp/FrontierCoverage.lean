...
theorem MetaCICCriticalPathFrontierCoverage [AskSetup] [PackageSetup]
  ...
  have sourceRoute :
      (fun row : BHist =>
        (hsame row route ∨ hsame row dischargeSocket ∨ hsame row query ∨
          hsame row consumerRead) ∧ UnaryHistory row) route := by
  ...
  have cert :
    ...
    core := {
      ...
      carrier_respects_equiv := by
        ...
        · cases source.left with
          | inl sameRoute =>
              exact Or.inl (hsame_trans (hsame_symm sameRows) sameRoute)
          | inr rest =>
              cases rest with
              | inl sameSocket =>
              ...
              | inr rest =>
                  ...
                  | inl sameQuery =>
                      exact Or.inr (Or.inr (Or.inl
                        (hsame_trans (hsame_symm sameRows) sameQuery)))
                  | inr sameConsumer =>
    ...
    pattern_sound := by
      ...
      cases source.left with
      | inl sameRoute =>
          exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl sameRoute))))))
      | inr rest =>
          cases rest with
          | inl sameSocket =>
          ...
          | inr rest =>
              ...
              | inl sameQuery =>
                  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr
                    (Or.inr (Or.inr (Or.inl sameQuery)))))))))
              | inr sameConsumer =>
                  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr
