...
theorem MetaCICCriticalPathSubjectReductionSocketReadiness [AskSetup] [PackageSetup]
  ...
  intro packet normalFormDischargeRead socketReadPkg
  ...
  have socketReadUnary : UnaryHistory socketRead :=
    unary_cont_closed normalFormUnary dischargeSocketUnary normalFormDischargeRead
  have sourceSocket :
  ...
  have cert :
    ...
    ledger_sound := by
      intro _row source
      exact ⟨source.right, socketReadPkg, normalFormDischargeRead⟩
  }
