...
theorem MetaCICNormalizationBudgetCarrier_falsifiable_boundary [AskSetup] [PackageSetup]
    {C E R Q refusalRead : BHist}
  ...
  exact ⟨cert, refusalUnary, refusalRoute, refusalPkg⟩
