...
theorem PicardContractionPacket_namecert_obligation_surface [AskSetup] [PackageSetup]
  ...
  intro packet iteratesModulusEndpoint endpointTransportSealRead sealReadPkg
  obtain ⟨banachUnary, contractionUnary, lipschitzUnary, iteratesUnary, modulusUnary,
    ...
    banachContractionLipschitz, _packetIteratesModulusEndpoint, _endpointTransportRoutes,
