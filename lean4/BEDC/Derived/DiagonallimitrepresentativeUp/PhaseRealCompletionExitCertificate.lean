...
theorem DiagonalLimitRepresentativePhaseRealCompletionExitCertificate [AskSetup] [PackageSetup]
            ...
            Cont routeRead continuation consumer ->
              PkgSig bundle consumer pkg ->
                SemanticNameCert
                    ...
                    (fun row : BHist =>
                      hsame row modulus ∨ hsame row window ∨ hsame row readback ∨
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row modulus ∨ hsame row window ∨ hsame row readback ∨
              hsame row realSeal ∨ hsame row routeRead ∨ hsame row consumer)
          (fun row : BHist =>
            hsame row consumer ∧ PkgSig bundle localName pkg ∧ PkgSig bundle consumer pkg)
          hsame := {
    core := {
