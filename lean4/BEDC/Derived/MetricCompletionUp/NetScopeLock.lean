...
namespace BEDC.Derived.MetricCompletionUp.NetScopeLock
...
theorem MetricCompletion_net_scope_lock [AskSetup] [PackageSetup]
    ...
    MetricCompletionCarrier source filterBranch netBranch readback separated transport replay
      ...
      Cont source netBranch branchRead → Cont branchRead readback readbackRead →
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row netBranch ∨ hsame row branchRead ∨ hsame row readbackRead ∨
  ...
  intro carrier sourceNet netReadback readbackSeparated separatedReplay replayProvenance
  ...
  have branchReadUnary : UnaryHistory branchRead :=
    unary_cont_closed sourceUnary netUnary sourceNet
  have readbackReadUnary : UnaryHistory readbackRead :=
    unary_cont_closed branchReadUnary readbackUnary netReadback
...
end BEDC.Derived.MetricCompletionUp.NetScopeLock
