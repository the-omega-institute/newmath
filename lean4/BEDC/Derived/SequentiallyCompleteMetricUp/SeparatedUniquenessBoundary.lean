...
theorem SequentiallyCompleteMetricSeparatedUniquenessBoundary [AskSetup] [PackageSetup]
                          ...
                          SemanticNameCert
                              ...
                              (fun row : BHist =>
                                hsame row X ∨ hsame row S ∨ hsame row M ∨ hsame row L ∨
                                  hsame row D ∨ hsame row C ∨ hsame row N ∨
                                    hsame row namedRead)
                              (fun row : BHist =>
  ...
  intro fieldRows xUnary sUnary mUnary lUnary dUnary cUnary nUnary sequenceRoute modulusRoute
    limitRoute distanceRoute replayRoute namedRoute provenancePkg namePkg
  cases fieldRows
