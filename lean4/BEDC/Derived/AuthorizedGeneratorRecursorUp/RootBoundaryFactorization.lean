...
theorem AuthorizedGeneratorRecursor_branch_descent_audit_totality [AskSetup] [PackageSetup]
    {signature eliminator motive branch descent output audit transport continuation provenance
      boundary localCert branchRead descentRead outputRead auditRead boundaryRead : BHist}
      ...
      Cont branch descent branchRead ->
        Cont motive descent descentRead ->
          Cont output audit outputRead ->
            Cont outputRead localCert auditRead ->
              Cont boundary localCert boundaryRead ->
                UnaryHistory branchRead ∧ UnaryHistory descentRead ∧
                  UnaryHistory outputRead ∧ UnaryHistory auditRead ∧
                    UnaryHistory boundaryRead ∧ Cont branch descent branchRead ∧
                      Cont motive descent descentRead ∧ Cont output audit outputRead ∧
                        Cont outputRead localCert auditRead ∧
                          Cont boundary localCert boundaryRead ∧
  ...
  exact
    ⟨branchReadUnary, descentReadUnary, outputReadUnary, auditReadUnary,
      boundaryReadUnary, branchRoute, descentRoute, outputRoute, auditRoute,
