...
theorem AuthorizedGeneratorRecursor_root_branch_output_closed_boundary
    [AskSetup] [PackageSetup]
    {I E M B D O A H C P G N branchRead descentRead outputRead auditRead : BHist}
            ...
            UnaryHistory D →
              UnaryHistory O →
                UnaryHistory A →
                  UnaryHistory N →
                    Cont I E branchRead →
                      Cont branchRead B descentRead →
                        Cont descentRead D outputRead →
  ...
  intro _unaryI _unaryE _unaryM _unaryB _unaryD _unaryO _unaryA unaryN
    branchRoute descentRoute outputRoute auditRoute pkgSig
