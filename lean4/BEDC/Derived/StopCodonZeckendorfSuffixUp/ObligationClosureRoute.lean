...
theorem StopCodonZeckendorfSuffixObligationClosureRoute [AskSetup] [PackageSetup]
    {atlas window suffix legality bridge separation boundary transport route provenance name
      atlasRead suffixRead legalityRead bridgeRead boundaryRead namedRead : BHist}
                      ...
                      Cont suffixRead legality legalityRead →
                        Cont legalityRead bridge bridgeRead →
                          Cont bridgeRead boundary boundaryRead →
                            Cont boundaryRead name namedRead →
  ...
  intro atlasUnary windowUnary suffixUnary legalityUnary bridgeUnary boundaryUnary nameUnary
    atlasRoute suffixRoute legalityRoute bridgeRoute boundaryRoute namedRoute provenancePkg
    namedPkg
            ...
            UnaryHistory row ∧ Cont atlas window atlasRead ∧
              Cont atlasRead suffix suffixRead ∧ Cont suffixRead legality legalityRead ∧
                Cont legalityRead bridge bridgeRead ∧ Cont bridgeRead boundary boundaryRead ∧
                  Cont boundaryRead name namedRead ∧ PkgSig bundle provenance pkg ∧
                    PkgSig bundle namedRead pkg)
          hsame := {
    core := {
