...
theorem RealCompletionExactBoundaryTerminalConsumerExactness [AskSetup] [PackageSetup]
  ...
  intro unaryL unaryK unaryJ unaryS unaryW unaryR _unaryD unaryE sealCont classifierCont
    witnessCont budgetCont terminalCont terminalPkg
  ...
  exact
    ⟨rfl, sealUnary, classifierUnary, witnessUnary, budgetUnary, terminalUnary, sealCont,
      classifierCont, witnessCont, budgetCont, terminalCont, terminalPkg⟩
