...
theorem QuotientSoundnessBoundary_refusal_ledger_consumer_frontier [AskSetup] [PackageSetup]
  ...
  exact
    ⟨eUnary, aUnary, tUnary, vUnary, hUnary, cUnary, refusalUnary, transportUnary,
      consumerUnary, eAV, eTH, vTRefusal, tHTransport, hCConsumer, pPkg, nPkg,
