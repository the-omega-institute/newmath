...
theorem ClosedIntervalNestedBolzanoHandoff [AskSetup] [PackageSetup]
    {I S C D W Q E H T P N selectorRead cellRead endpointRead windowRead tailRead sealRead
      publicRead bolzanoRead : BHist}
                                ...
                                hsame row I ∨ hsame row S ∨ hsame row C ∨
                                  hsame row D ∨ hsame row W ∨ hsame row Q ∨
                                    hsame row E ∨ hsame row H ∨ hsame row T ∨
                                      hsame row P ∨ hsame row N ∨ hsame row bolzanoRead)
                              (fun row : BHist =>
                                UnaryHistory row ∧ Cont publicRead P bolzanoRead ∧
                                  PkgSig bundle bolzanoRead pkg)
                              hsame := by
  ...
  intro carrier selectorRoute cellRoute endpointRoute windowRoute tailRoute sealRoute
    publicRoute bolzanoRoute bolzanoPkg
  ...
  have cert :
          ...
          (fun row : BHist =>
            hsame row I ∨ hsame row S ∨ hsame row C ∨ hsame row D ∨ hsame row W ∨
              hsame row Q ∨ hsame row E ∨ hsame row H ∨ hsame row T ∨ hsame row P ∨
                hsame row N ∨ hsame row bolzanoRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont publicRead P bolzanoRead ∧
              PkgSig bundle bolzanoRead pkg)
          hsame := {
    ...
    ledger_sound := by
      intro _row sourceRow
      exact ⟨sourceRow.right, bolzanoRoute, bolzanoPkg⟩
  }
  exact ⟨bolzanoUnary, cert⟩
