...
theorem CauchyRateBudgetCarrier_regular_tail_estimate_handoff
                          ...
                          SemanticNameCert
                              ...
                              (fun row : BHist =>
                                hsame row R ∨ hsame row W ∨ hsame row Q ∨ hsame row D ∨
                                  hsame row E ∨ hsame row C ∨ hsame row tailRead)
                              (fun row : BHist =>
  ...
  have cert :
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row R ∨ hsame row W ∨ hsame row Q ∨ hsame row D ∨ hsame row E ∨
              hsame row C ∨ hsame row tailRead)
          (fun row : BHist =>
    ...
    ledger_sound := by
      intro _row source
      exact
        ⟨source.right, rateRoute, readbackRoute, toleranceRoute, sealRoute, tailRoute⟩
  }
