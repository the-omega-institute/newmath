...
theorem CompactUniformContinuityPacket_carrier_bhist_rows [AskSetup] [PackageSetup]
    ...
    CompactUniformContinuityPacket source target graph tolerance precision net coverage
      ...
      UnaryHistory source ∧ UnaryHistory target ∧ UnaryHistory graph ∧
        UnaryHistory tolerance ∧ UnaryHistory net ∧ UnaryHistory coverage ∧
          UnaryHistory radiusRows ∧ UnaryHistory transport ∧ UnaryHistory nameRow ∧
            UnaryHistory modulusRows ∧ UnaryHistory fold ∧ UnaryHistory route ∧
  ...
  exact
    ⟨sourceUnary, targetUnary, graphUnary, toleranceUnary, netUnary, coverageUnary,
      radiusRowsUnary, transportUnary, nameRowUnary, modulusRowsUnary, foldUnary, routeUnary,
