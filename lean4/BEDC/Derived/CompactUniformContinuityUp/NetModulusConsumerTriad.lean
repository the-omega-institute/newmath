...
theorem CompactUniformContinuityPacket_net_modulus_consumer_triad [AskSetup] [PackageSetup]
  ...
  intro packet sourceNetRead precisionTargetRead precisionNameMetric radiusFoldRead
  ...
  exact
    ⟨netUnary, coverageUnary, modulusRowsUnary, radiusRowsUnary, foldUnary,
      ...
      netCoverageModulusRows, modulusRowsRadiusRowsFold, sourceNetRead, precisionTargetRead,
      precisionNameMetric, radiusFoldRead, precisionPkg, sourceReadPkg, targetReadPkg,
      radiusReadPkg⟩
