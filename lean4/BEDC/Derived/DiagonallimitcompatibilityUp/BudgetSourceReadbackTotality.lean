...
theorem DiagonalLimitCompatibilityBudgetSourceReadbackTotality [AskSetup] [PackageSetup]
  ...
  exact
    ⟨diagonalUnary, dyadicUnary, windowsUnary, sourceUnary, meshUnary, lockedUnary,
      budgetPrefixUnary, sealBudgetUnary, completionUnary, diagonalDyadicSource,
      sourceWindowsMesh, meshTriangleLocked, dyadicWindowsBudgetPrefix, budgetPrefixSealRow,
      readbackRealSealCompletion, provenancePkg, lockedPkg, sealBudgetPkg, completionPkg⟩
