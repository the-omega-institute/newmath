...
theorem ClosedSubstitutionSealAudit_surface [AskSetup] [PackageSetup]
  ...
  intro qUnary lUnary mUnary aUnary kUnary qToL subToM shiftToA auditToK _handoffPkg
  ...
  have _handoffUnary : UnaryHistory handoffRead :=
  ...
  exact ⟨cert, substitutionUnary, shiftUnary, auditUnary⟩
