...
theorem CauchyFilterCompletionPacket_carrier_ledger_package [AskSetup] [PackageSetup]
      ...
      SemanticNameCert
        ...
        UnaryHistory filter ∧ UnaryHistory windows ∧ UnaryHistory tolerance ∧
          UnaryHistory readback ∧ UnaryHistory sealRow ∧ UnaryHistory transport ∧
            UnaryHistory replay ∧ UnaryHistory provenance ∧ UnaryHistory name := by
          ...
          | inr rest =>
              ...
              | inr rest =>
                  ...
                  | inl sameTolerance =>
                      exact
                        Or.inr
                          (Or.inr (Or.inl (hsame_trans (hsame_symm sameRows) sameTolerance)))
                  | inr rest =>
                      cases rest with
                      | inl sameReadback =>
                          exact
  ...
  exact
    ⟨cert, filterUnary, windowsUnary, toleranceUnary, readbackUnary, sealUnary,
