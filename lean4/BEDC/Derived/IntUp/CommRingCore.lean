...
abbrev IntAdd_respects {a a' b b' : IntegerUp} :
    IntEq a a' -> IntEq b b' ->
...
abbrev IntMul_respects {a a' b b' : IntegerUp} :
    IntEq a a' -> IntEq b b' ->
...
abbrev IntNeg_respects {a b : IntegerUp} :
...
abbrev IntAdd_comm (a b : IntegerUp) :
    IntEq (IntAdd a b) (IntAdd b a) :=
  intAdd_comm a b

abbrev IntAdd_assoc (a b c : IntegerUp) :
    IntEq (IntAdd (IntAdd a b) c) (IntAdd a (IntAdd b c)) :=
  intAdd_assoc a b c

abbrev IntAdd_zero (a : IntegerUp) :
    IntEq (IntAdd a intZero) a :=
  intAdd_zero_right a

abbrev IntAdd_zero_left (a : IntegerUp) :
    IntEq (IntAdd intZero a) a :=
  intAdd_zero_left a

abbrev IntAdd_neg (a : IntegerUp) :
    IntEq (IntAdd a (IntNeg a)) intZero := by
  exact intAdd_neg_right a

abbrev IntAdd_neg_left (a : IntegerUp) :
    IntEq (IntAdd (IntNeg a) a) intZero := by
  exact intAdd_neg_left a

abbrev IntMul_assoc (a b c : IntegerUp) :
    IntEq (IntMul (IntMul a b) c) (IntMul a (IntMul b c)) :=
  intMul_assoc a b c

abbrev IntMul_one (a : IntegerUp) :
    IntEq (IntMul a intOne) a :=
  intMul_one_right a

abbrev IntMul_one_left (a : IntegerUp) :
    IntEq (IntMul intOne a) a :=
  intMul_one_left a

abbrev IntMul_zero (a : IntegerUp) :
    IntEq (IntMul a intZero) intZero :=
  intMul_zero_right a

abbrev IntMul_zero_left (a : IntegerUp) :
    IntEq (IntMul intZero a) intZero :=
  intMul_zero_left a

abbrev IntMul_add_distrib (a b c : IntegerUp) :
    IntEq (IntMul a (IntAdd b c))
      (IntAdd (IntMul a b) (IntMul a c)) :=
  intMul_add_distrib a b c

abbrev IntMul_add_distrib_right (a b c : IntegerUp) :
