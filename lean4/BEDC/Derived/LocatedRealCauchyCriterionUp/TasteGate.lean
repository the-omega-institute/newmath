...
private theorem LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode :
    ∀ h : BHist,
      locatedRealCauchyCriterionDecodeBHist
        (locatedRealCauchyCriterionEncodeBHist h) = h := by
  -- BEDC touchpoint anchor: BHist BMark
  intro h
  induction h with
  | Empty => rfl
...
def locatedRealCauchyCriterionFields : LocatedRealCauchyCriterionUp → List BHist
  -- BEDC touchpoint anchor: BHist BMark
  | LocatedRealCauchyCriterionUp.mk L S R D Q E H C P N => [L, S, R, D, Q, E, H, C, P, N]

def locatedRealCauchyCriterionToEventFlow : LocatedRealCauchyCriterionUp → EventFlow :=
  -- BEDC touchpoint anchor: BHist BMark
  fun x => (locatedRealCauchyCriterionFields x).map locatedRealCauchyCriterionEncodeBHist
...
private def locatedRealCauchyCriterionRawAt : Nat → EventFlow → RawEvent
  ...
  | 0, event :: _rest => event
  | Nat.succ _index, [] => []
  | Nat.succ index, _event :: rest => locatedRealCauchyCriterionRawAt index rest

def locatedRealCauchyCriterionFromEventFlow
    (flow : EventFlow) : Option LocatedRealCauchyCriterionUp :=
  -- BEDC touchpoint anchor: BHist BMark
  some
...
private theorem LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_round_trip :
    ∀ x : LocatedRealCauchyCriterionUp,
      locatedRealCauchyCriterionFromEventFlow
        (locatedRealCauchyCriterionToEventFlow x) = some x := by
  -- BEDC touchpoint anchor: BHist BMark
  intro token
  cases token with
  | mk L S R D Q E H C P N =>
      ...
      rw [LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode L,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode S,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode R,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode D,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode Q,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode E,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode H,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode C,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode P,
        LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode N]

private theorem locatedRealCauchyCriterionToEventFlow_injective
    {x y : LocatedRealCauchyCriterionUp} :
    locatedRealCauchyCriterionToEventFlow x =
      locatedRealCauchyCriterionToEventFlow y → x = y := by
  -- BEDC touchpoint anchor: BHist BMark
  intro heq
  have hread :
      locatedRealCauchyCriterionFromEventFlow (locatedRealCauchyCriterionToEventFlow x) =
        locatedRealCauchyCriterionFromEventFlow (locatedRealCauchyCriterionToEventFlow y) :=
...
private theorem LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_fields :
    ∀ x y : LocatedRealCauchyCriterionUp,
      locatedRealCauchyCriterionFields x = locatedRealCauchyCriterionFields y → x = y := by
  -- BEDC touchpoint anchor: BHist BMark
  intro x y hfields
  cases x with
...
instance locatedRealCauchyCriterionChapterTasteGate :
  ...
  round_trip := by
    ...
    change
      locatedRealCauchyCriterionFromEventFlow
        (locatedRealCauchyCriterionToEventFlow x) = some x
    exact LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_round_trip x
  layer_separation := by
    intro x y hxy heq
    exact hxy (locatedRealCauchyCriterionToEventFlow_injective heq)
...
instance locatedRealCauchyCriterionNontrivial :
    BEDC.Meta.TasteGate.Nontrivial LocatedRealCauchyCriterionUp where
  -- BEDC touchpoint anchor: BHist BMark
  witness_pair :=
    ⟨LocatedRealCauchyCriterionUp.mk BHist.Empty BHist.Empty BHist.Empty BHist.Empty
...
theorem LocatedRealCauchyCriterionTasteGate_single_carrier_alignment :
    Nonempty (ChapterTasteGate LocatedRealCauchyCriterionUp) ∧
      Nonempty (FieldFaithful LocatedRealCauchyCriterionUp) ∧
        Nonempty (BEDC.Meta.TasteGate.Nontrivial LocatedRealCauchyCriterionUp) ∧
          (∀ h : BHist,
            locatedRealCauchyCriterionDecodeBHist
              (locatedRealCauchyCriterionEncodeBHist h) = h) ∧
            locatedRealCauchyCriterionEncodeBHist BHist.Empty = ([] : RawEvent) ∧
              locatedRealCauchyCriterionEncodeBHist (BHist.e0 BHist.Empty) =
                [BMark.b0] := by
  ...
  exact
    ⟨⟨locatedRealCauchyCriterionChapterTasteGate⟩,
      ...
      LocatedRealCauchyCriterionTasteGate_single_carrier_alignment_decode,
      rfl,
      rfl⟩
