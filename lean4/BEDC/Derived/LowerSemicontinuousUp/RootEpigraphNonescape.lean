...
theorem LowerSemicontinuousRootEpigraphNonescape [AskSetup] [PackageSetup]
  ...
  -- BEDC touchpoint anchor: LowerSemicontinuousUp BHist ProbeBundle Pkg Cont PkgSig hsame SemanticNameCert UnaryHistory
  intro epigraphFields windowUnary regularUnary epigraphUnary locatedUnary transportUnary
    replayUnary windowRoute epigraphRoute locatedRoute transportRoute replayRoute
