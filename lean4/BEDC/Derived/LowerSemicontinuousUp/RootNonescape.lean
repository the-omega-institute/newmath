...
theorem LowerSemicontinuousRootNonescape [AskSetup] [PackageSetup]
  ...
  intro fields windowSource readbackSource epigraphSource locatedSource transportSource
    replaySource windowRoute epigraphRoute locatedRoute transportRoute replayRoute
  ...
  have transportUnary : UnaryHistory transportRead :=
    unary_cont_closed locatedUnary transportSource transportRoute
  have replayUnary : UnaryHistory replayRead :=
    unary_cont_closed transportUnary replaySource replayRoute
  have sourceAtReplay :
  ...
  exact ⟨cert, windowUnary, epigraphUnary, locatedUnary, transportUnary, replayUnary⟩
