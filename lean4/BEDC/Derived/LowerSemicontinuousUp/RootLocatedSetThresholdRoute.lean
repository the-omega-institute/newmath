...
theorem LowerSemicontinuousRootLocatedSetThresholdRoute [AskSetup] [PackageSetup]
                                              ...
                                              Cont locatedRead H transportRead ∧
                                                Cont transportRead C replayRead ∧
                                                  Cont replayRead N thresholdRead ∧
                                                    PkgSig bundle P pkg ∧
                                                      PkgSig bundle N pkg)
                                      hsame ∧ UnaryHistory thresholdRead := by
      ...
      SemanticNameCert
          ...
          (fun row : BHist =>
            hsame row W ∨ hsame row R ∨ hsame row E ∨ hsame row O ∨ hsame row H ∨
              hsame row C ∨ hsame row N ∨ hsame row thresholdRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont W R windowRead ∧
