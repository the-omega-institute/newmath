...
theorem LowerSemicontinuousEpigraphLocatedStability [AskSetup] [PackageSetup]
    {X F E W R O H C P N windowRead epigraphRead locatedRead transportRead : BHist}
    ...
    lowerSemicontinuousRootFields (LowerSemicontinuousUp.mk X F E W R O H C P N) =
      ...
      UnaryHistory W -> UnaryHistory R -> UnaryHistory E -> UnaryHistory O ->
        UnaryHistory H -> Cont W R windowRead -> Cont windowRead E epigraphRead ->
              ...
              SemanticNameCert
                  ...
                  (fun row : BHist =>
                    hsame row W ∨ hsame row R ∨ hsame row E ∨ hsame row O ∨
                      hsame row H ∨ hsame row transportRead)
                  (fun row : BHist =>
                    UnaryHistory row ∧ Cont W R windowRead ∧
                      Cont windowRead E epigraphRead ∧ Cont epigraphRead O locatedRead ∧
                        Cont locatedRead H transportRead ∧ PkgSig bundle P pkg ∧
                          PkgSig bundle N pkg)
                  hsame ∧
                UnaryHistory transportRead := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Pkg Cont PkgSig SemanticNameCert hsame
  intro fields wUnary rUnary eUnary oUnary hUnary windowRoute epigraphRoute locatedRoute
    transportRoute provenancePkg namePkg
