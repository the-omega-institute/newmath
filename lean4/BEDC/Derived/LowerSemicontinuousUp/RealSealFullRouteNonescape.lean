...
theorem LowerSemicontinuousRealSealFullRouteNonescape [AskSetup] [PackageSetup]
    {X F E W R O H C P N windowRead epigraphRead locatedRead transportRead replayRead
      provenanceRead realSeal : BHist}
          ...
          Cont W R windowRead -> Cont windowRead E epigraphRead ->
            Cont epigraphRead O locatedRead -> Cont locatedRead H transportRead ->
              Cont transportRead C replayRead -> Cont replayRead P provenanceRead ->
                Cont provenanceRead N realSeal -> PkgSig bundle P pkg ->
                  PkgSig bundle N pkg ->
                    SemanticNameCert
                      ...
                      (fun row : BHist =>
                        hsame row W ∨ hsame row R ∨ hsame row E ∨ hsame row O ∨
                          hsame row H ∨ hsame row C ∨ hsame row P ∨ hsame row N ∨
                            Cont provenanceRead N realSeal)
                      (fun row : BHist =>
  ...
  intro fields wUnary rUnary eUnary oUnary hUnary cUnary pUnary nUnary windowRoute
    epigraphRoute locatedRoute transportRoute replayRoute provenanceRoute realSealRoute
  ...
  have realSealUnary : UnaryHistory realSeal :=
    unary_cont_closed provenanceUnary nUnary realSealRoute
  have cert :
      SemanticNameCert
        (fun row : BHist => hsame row realSeal ∧ UnaryHistory row)
        (fun row : BHist =>
          hsame row W ∨ hsame row R ∨ hsame row E ∨ hsame row O ∨ hsame row H ∨
            hsame row C ∨ hsame row P ∨ hsame row N ∨ Cont provenanceRead N realSeal)
        (fun row : BHist =>
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, windowRoute, epigraphRoute, locatedRoute, transportRoute, replayRoute,
          provenanceRoute, realSealRoute, provenancePkg, namePkg⟩
  }
