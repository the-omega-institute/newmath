...
theorem LowerSemicontinuousRootRealSealRefusal [AskSetup] [PackageSetup]
    {X F E W R O H C P N windowRead epigraphRead locatedRead transportRead replayRead
      realSeal refusedRead : BHist}
          ...
          Cont W R windowRead -> Cont windowRead E epigraphRead ->
            Cont epigraphRead O locatedRead -> Cont locatedRead H transportRead ->
              Cont transportRead C replayRead -> Cont replayRead N realSeal ->
                hsame refusedRead realSeal -> PkgSig bundle P pkg ->
                  PkgSig bundle N pkg ->
                    SemanticNameCert
                        ...
                        (fun row : BHist =>
                          hsame row W ∨ hsame row R ∨ hsame row E ∨ hsame row O ∨
                            hsame row H ∨ hsame row C ∨ hsame row N ∨
                              hsame row realSeal ∨ hsame row refusedRead)
                        (fun row : BHist =>
                              ...
                              Cont epigraphRead O locatedRead ∧
                                Cont locatedRead H transportRead ∧
                                  Cont transportRead C replayRead ∧
                                    Cont replayRead N realSeal ∧ hsame row refusedRead ∧
                                      PkgSig bundle P pkg ∧ PkgSig bundle N pkg)
                        hsame ∧
                      UnaryHistory refusedRead := by
  -- BEDC touchpoint anchor: BHist ProbeBundle Cont PkgSig SemanticNameCert UnaryHistory hsame
  intro fields wUnary rUnary eUnary oUnary hUnary cUnary nUnary windowRoute epigraphRoute
    locatedRoute transportRoute replayRoute sealRoute refusedSameSeal provenancePkg namePkg
  ...
  have refusedUnary : UnaryHistory refusedRead :=
    unary_transport realSealUnary (hsame_symm refusedSameSeal)
  have cert :
      SemanticNameCert
          (fun row : BHist => hsame row refusedRead ∧ UnaryHistory row)
          (fun row : BHist =>
            hsame row W ∨ hsame row R ∨ hsame row E ∨ hsame row O ∨ hsame row H ∨
              hsame row C ∨ hsame row N ∨ hsame row realSeal ∨ hsame row refusedRead)
          (fun row : BHist =>
            UnaryHistory row ∧ Cont W R windowRead ∧ Cont windowRead E epigraphRead ∧
              Cont epigraphRead O locatedRead ∧ Cont locatedRead H transportRead ∧
                Cont transportRead C replayRead ∧ Cont replayRead N realSeal ∧
                  hsame row refusedRead ∧ PkgSig bundle P pkg ∧ PkgSig bundle N pkg)
          hsame := {
    core := {
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, windowRoute, epigraphRoute, locatedRoute, transportRoute, replayRoute,
          sealRoute, source.left, provenancePkg, namePkg⟩
  }
  exact ⟨cert, refusedUnary⟩
