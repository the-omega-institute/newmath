...
theorem LowerSemicontinuousEpigraphSourceScope [AskSetup] [PackageSetup]
    {X F E W R O H C P N windowRead _readbackRead epigraphRead locatedRead transportRead
  ...
  intro fields windowSource readbackSource epigraphSource locatedSource transportSource
    replaySource _provenanceSource nameSource windowRoute epigraphRoute locatedRoute
  ...
  have namedUnary : UnaryHistory namedRead :=
    unary_cont_closed replayUnary nameSource namedRoute
  have cert :
      SemanticNameCert
  ...
  exact
    ⟨cert, windowUnary, epigraphUnary, locatedUnary, transportUnary, replayUnary, namedUnary⟩
