...
theorem LowerSemicontinuousRealSealTransportNonescape [AskSetup] [PackageSetup]
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, windowRoute, epigraphRoute, locatedRoute, transportRoute,
          replayRoute, realSealRoute, provenancePkg, namePkg⟩
  }
  exact ⟨cert, transportUnary, replayUnary, realSealUnary⟩
