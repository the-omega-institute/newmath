...
theorem BoundedMonotoneCauchyWitnessCarrier_l10_terminal_route_exhaustion [AskSetup]
    [PackageSetup]
                  ...
                  PkgSig bundle consumerRead pkg ->
                    UnaryHistory sourceRead /\ UnaryHistory trapRead /\
                      UnaryHistory sealRead /\ UnaryHistory terminalRead /\
                        UnaryHistory consumerRead /\ Cont source schedule sourceRead /\
                          Cont sourceRead witness trapRead /\ Cont trapRead sealRow sealRead /\
                            Cont sealRead route terminalRead /\
                              Cont terminalRead provenance consumerRead /\
  ...
  exact
    ⟨sourceReadUnary, trapReadUnary, sealReadUnary, terminalReadUnary, consumerReadUnary,
      sourceScheduleSourceRead, sourceReadWitnessTrapRead, trapReadSealRowSealRead,
      sealReadRouteTerminalRead, terminalReadProvenanceConsumerRead, provenancePkg,
