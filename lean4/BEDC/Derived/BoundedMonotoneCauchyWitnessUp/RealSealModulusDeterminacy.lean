...
theorem BoundedMonotoneCauchyWitnessCarrier_real_seal_modulus_determinacy
    [AskSetup] [PackageSetup]
    {source regular schedule witness ledger trap sealRow transport route provenance localCert
      windowA windowB modulusA modulusB realA realB : BHist}
        ...
        Cont source schedule windowB →
          Cont windowA witness modulusA →
            Cont windowB witness modulusB →
              Cont modulusA sealRow realA →
                Cont modulusB sealRow realB →
                  PkgSig bundle realA pkg →
                    PkgSig bundle realB pkg →
                      UnaryHistory windowA ∧ UnaryHistory windowB ∧ UnaryHistory modulusA ∧
                        UnaryHistory modulusB ∧ UnaryHistory realA ∧ UnaryHistory realB ∧
                          hsame windowA windowB ∧ hsame modulusA modulusB ∧
  ...
  intro carrier sourceScheduleWindowA sourceScheduleWindowB windowWitnessModulusA
    windowWitnessModulusB modulusSealRealA modulusSealRealB realPkgA realPkgB
  ...
  have realUnaryA : UnaryHistory realA :=
    unary_cont_closed modulusUnaryA sealUnary modulusSealRealA
  have realUnaryB : UnaryHistory realB :=
    unary_cont_closed modulusUnaryB sealUnary modulusSealRealB
  ...
  have sameReal : hsame realA realB :=
    cont_respects_hsame sameModulus (hsame_refl sealRow) modulusSealRealA modulusSealRealB
  exact
    ⟨windowUnaryA, windowUnaryB, modulusUnaryA, modulusUnaryB, realUnaryA, realUnaryB,
      sameWindow, sameModulus, sameReal, realPkgA, realPkgB⟩
