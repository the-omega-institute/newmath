...
theorem BoundedMonotoneCauchyWitnessCarrier_finite_seal_route_determinacy
                      ...
                      UnaryHistory windowRead /\ UnaryHistory modulusRead /\
                        UnaryHistory budgetRead /\ UnaryHistory trapRead /\
                          UnaryHistory sealRead /\ UnaryHistory completionRead /\
                            UnaryHistory finalRead /\ Cont source schedule windowRead /\
                              Cont windowRead witness modulusRead /\
                                Cont modulusRead ledger budgetRead /\
                                  Cont budgetRead trap trapRead /\
                                    Cont trapRead sealRow sealRead /\
  ...
  exact
    ⟨windowUnary, modulusUnary, budgetUnary, trapReadUnary, sealReadUnary, completionUnary,
      finalUnary, sourceScheduleWindow, windowWitnessModulus, modulusLedgerBudget,
      budgetTrapRead, trapSealRead, sealProvenanceCompletion, completionLocalFinal,
