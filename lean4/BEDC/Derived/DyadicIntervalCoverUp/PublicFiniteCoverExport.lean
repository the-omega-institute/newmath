...
theorem DyadicIntervalCoverPublicFiniteCoverExport [AskSetup] [PackageSetup]
    {L U M R V W Q A H C P N endpointRead windowRead readbackRead coverRead sealRead
      subcoverRead namedRead publicRead : BHist}
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, endpointRoute, windowRoute, readbackRoute, coverRoute,
          sealRoute, subcoverRoute, namedRoute, publicRoute, publicPkg⟩
  }
