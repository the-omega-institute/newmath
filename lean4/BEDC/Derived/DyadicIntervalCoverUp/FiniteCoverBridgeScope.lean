...
theorem DyadicIntervalCoverFiniteCoverBridgeScope [AskSetup] [PackageSetup]
    {L U M R V W Q A H C P N endpointRead windowRead readbackRead coverRead sealRead
      subcoverRead namedRead publicRead budgetRead bridgeRead : BHist}
  ...
  intro surface endpointRoute windowRoute readbackRoute coverRoute sealRoute subcoverRoute
    namedRoute publicRoute budgetRoute bridgeRoute bridgePkg
    ...
    ledger_sound := by
      ...
      exact
        ⟨source.right, endpointRoute, windowRoute, readbackRoute, coverRoute, sealRoute,
          subcoverRoute, namedRoute, publicRoute, budgetRoute, bridgeRoute, bridgePkg⟩
  }
