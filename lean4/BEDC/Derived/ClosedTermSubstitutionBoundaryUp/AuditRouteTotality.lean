...
theorem ClosedTermSubstitutionBoundaryAuditRouteTotality [AskSetup] [PackageSetup]
  ...
  have auditReadUnary : UnaryHistory auditRead :=
    unary_cont_closed consumerUnary ledgerUnary consumerLedgerAuditRead
  exact
    ⟨ledgerUnary, auditUnary, routeUnary, consumerUnary, auditReadUnary,
      shiftSubstitutionLedger, substitutionDepthAudit, ledgerAuditRoute, routeAuditConsumer,
      consumerLedgerAuditRead, auditReadPkg⟩
