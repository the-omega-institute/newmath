...
theorem ClosedTermSubstitutionBoundaryRootTransportAccountability [AskSetup] [PackageSetup]
                ...
                PkgSig bundle transportRead pkg ->
                  SemanticNameCert
                    ...
                    UnaryHistory ledger ∧ UnaryHistory audit ∧ UnaryHistory route ∧
                      UnaryHistory rootRead ∧ UnaryHistory transportRead := by
  ...
  exact ⟨cert, ledgerUnary, auditUnary, routeUnary, rootUnary, transportUnary⟩
