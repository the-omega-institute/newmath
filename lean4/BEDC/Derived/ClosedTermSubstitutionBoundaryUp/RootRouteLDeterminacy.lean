...
theorem ClosedTermSubstitutionBoundaryRootRouteLDeterminacy [AskSetup] [PackageSetup]
    {source value depth shift substitution ledger audit route consumer rootRoute rootRoute'
      bridgeRead bridgeRead' : BHist}
                        ...
                        PkgSig bundle bridgeRead' pkg ->
                          hsame rootRoute rootRoute' ∧ UnaryHistory consumer ∧
                            UnaryHistory rootRoute ∧ UnaryHistory rootRoute' ∧
                              UnaryHistory bridgeRead ∧ UnaryHistory bridgeRead' ∧
                                Cont rootRoute ledger bridgeRead ∧
                                  Cont rootRoute' ledger bridgeRead' ∧
                                    PkgSig bundle bridgeRead pkg ∧
  ...
  intro classifier shiftSubstitutionLedger substitutionDepthAudit ledgerAuditRoute
    routeAuditConsumer consumerRouteRoot consumerRouteRoot' rootLedgerBridge
    rootLedgerBridge' bridgePkg bridgePkg'
  ...
  exact
    ⟨sameRoot, consumerUnary, rootUnary, rootUnary', bridgeUnary, bridgeUnary',
      rootLedgerBridge, rootLedgerBridge', bridgePkg, bridgePkg'⟩
